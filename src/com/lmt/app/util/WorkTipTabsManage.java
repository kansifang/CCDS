...
import com.lmt.frameapp.sql.SqlObject;
 ...
 * @throws Exception 
 ...
 public boolean addUserTab(String userID,String tabID,String tabName,String script,String cache,String close,Transaction Sqlca) throws Exception{
	 ...
	 SqlObject so;
	 String serialno = DBFunction.getSerialNo("USER_WORKTIPS","SerialNo",Sqlca);
	 ...
	 try{
		 ...
		 ps.setString(8,CurUser.OrgID);
		 ps.setString(9,CurUser.UserID);
		 ps.setString(10,curTime);
		 ps.setString(11,CurUser.OrgID);
		 ps.setString(12,CurUser.UserID);
