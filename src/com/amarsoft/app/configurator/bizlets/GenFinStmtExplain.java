...
public class GenFinStmtExplain extends Bizlet {
	...
	public Object run(Transaction Sqlca) throws Exception {
		...
		//将模型放入2维数组
		String sSql = "select MODELNO,ROWNO,COL1DEF,COL2DEF,FormulaExp1,FormulaExp2 from REPORT_MODEL where ModelNo='"+sModelNo+"'"; 
		String[][] sModelTmlt = Sqlca.getStringMatrix(sSql);
