...
public class GetCreditLine2Balance_Sub extends Bizlet {
	...
	public Object run(Transaction Sqlca) throws Exception {
        ...
        sSql = "select sum((BusinessSum*DeCode(Flag4,'0',1,0)+Balance*DeCode(Flag4,'1',1,0)-(case when BailSum is null then 0 else BailSum end))*getERate(BusinessCurrency,'01',ERateDate)) from BUSINESS_CONTRACT " +
