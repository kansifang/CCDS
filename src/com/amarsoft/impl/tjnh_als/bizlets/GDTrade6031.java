 ...
 *
 */
public class GDTrade6031 implements GDTradeInterface {
	public String runGDTrade(SocketManager sm,String sObjectNo,String sObjectType,Transaction Sqlca,String sFilePath,String sTradeDate){
		...
		String sPhaseNo = "", sCommercialNo ="", sBusinessType ="", sAccumulationNo ="", sResult = "0",sChangType = "";
		try{
			
			sSql = " select fo.PhaseNo as PhaseNo,ba.BusinessType as BusinessType,ba.CommercialNo as CommercialNo,ba.AccumulationNo as AccumulationNo,ba.ChangType as ChangType " +
