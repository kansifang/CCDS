 ...
 *
 */
public class GDTrade6003 implements GDTradeInterface {
	public String runGDTrade(SocketManager sm,String sObjectNo,String sObjectType,Transaction Sqlca,String sFilePath,String sTradeDate){
		...
		try{	
			...
			try {
				...
				//以上为报文头部分，以下为报文体部分
				sm.write(mb.setValue("ContractSerialNo",sObjectNo));//协议合同号
				...
				if(mb.getValue("TradeType").equals("3")){
					...
					sReturn="0000000@"+mb.getValue("PayBackSum");
