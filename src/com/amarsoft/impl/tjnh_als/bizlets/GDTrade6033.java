 ...
 *
 */
public class GDTrade6033 implements GDTradeInterface {
	public String runGDTrade(SocketManager sm,String sObjectNo,String sObjectType,Transaction Sqlca,String sFilePath,String sTradeDate){
		...
		sSql="select BP.ContractSerialNo as ContractSerialNo,BP.ChangType as ChangType,BP.ContractSum as ContractSum,GetMFUserID(BP.InputUserID) as InputUserID,GetMFOrgID(BP.InputOrgID) as InputOrgID," +
