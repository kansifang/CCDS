...
<%
	...
	sTemp.append("	<form method='post' action='0102002.jsp' name='reportInfo'>");	
	...
	while(rs.next())
	{
	    ...
	    sTemp.append("   <td width=22% align=center class=td1 >余额(元)</td>");
	    sTemp.append("   <td align=right class=td1 >"+sBalance+"&nbsp;</td>");
	    sTemp.append("   </tr>");
		sTemp.append("   <tr>");
		sTemp.append("   <td align=center class=td1 >保证金(元)</td>");
		sTemp.append("   <td align=right class=td1 >"+sBailSum+"&nbsp;</td>");
		sTemp.append("   <td align=center class=td1 >逾期/垫款金额(元)</td>");
		sTemp.append("   <td align=right class=td1 >"+sOverdueBalance+"&nbsp;</td>");
		sTemp.append("   </tr>");
		sTemp.append("   <tr>");
		sTemp.append("   <td align=center class=td1 >欠息金额(元)</td>");
