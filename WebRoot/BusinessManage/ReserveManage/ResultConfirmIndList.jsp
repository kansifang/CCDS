...
<%	
    ...
    sSql = " select  RR.SerialNo,RR.AccountMonth,RR.LoanAccount,RR.ObjectNo,RR.CustomerName,RR.Balance,RR.PutoutDate,RR.MaturityDate,RR.AuditRate,getItemName('VouchType',RR.VouchType) as VouchTypeName, " +
    	   " getItemName('MFiveClassify',RR.MClassifyResult) as MClassifyResultName,getItemName('MFiveClassify',RR.AClassifyResult) as AClassifyResultName,RR.Result1,RR.Result2,RR.Result3,RR.Result4,RR.AResult " +
	       " from Reserve_Record RR,Reserve_Total RT " + 
	       " where RR.LoanAccount = RT.LoanAccount and RR.AccountMonth = RT. AccountMonth and RR.BusinessFlag = '2' and RT.AuditStatFlag = '1'";
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
			{"false","","Button","审计损失识别","审计损失识别","lossManage()",sResourcesPath},
