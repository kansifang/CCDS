...
<%	
    ...
    sSql = " select AccountMonth,LoanAccount,CustomerID,CustomerName,PutoutDate,"+
    	   " Maturity,RMBBalance,BusinessRate,MFiveClassify,getItemName('MFiveClassify',MFiveClassify) as MFiveClassifyName "+
    	   " from Reserve_Total  " +
    ...
    doTemp.setVisible("MFiveClassify",false);
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function update_Reserve(){
		...
		if(confirm("确认要进行减值准备数据更新吗？")){
			...
			sGrade = PopComp("GradeSelect","/BusinessManage/ReserveManage/GradeSelect.jsp","rand="+randomNumber()," ","dialogWidth=35;dialogHeight=10;center:yes;status:no;statusbar:no");
