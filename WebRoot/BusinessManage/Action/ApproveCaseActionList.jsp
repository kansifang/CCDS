...
<script language=javascript>
	...
	function doSubmitIn()
	{
		...
		else if (sPhaseInfo == "Success")
		{
			...
			//刷新件数及页面
			OpenComp("ApproveMain","/Common/BusinessFlow/Approve/ApproveMain.jsp","ComponentName=授信业务审批&ComponentType=MainWindow&ApproveType=<%=sApproveType%>","_top","");
	...
	function viewDetail()
	{
		...
		if (typeof(sSerialNo)=="undefined" || sSerialNo.length==0){
    		...
    		popComp("ActionInfo","/BusinessManage/Action/ActionInfo.jsp","SerialNo="+sSerialNo,"");
    		reloadSelf();
		}
	}
	...
	function takeBack()
	{
		...
		//如果成功，则刷新页面
		if (sRetValue == "Commit"){
		    OpenComp("ApproveMain","/Common/BusinessFlow/Approve/ApproveMain.jsp","ComponentName=审查审批管理&ComponentType=MainWindow&ApproveType=<%=sApproveType%>","_top","");
		}		
	}
