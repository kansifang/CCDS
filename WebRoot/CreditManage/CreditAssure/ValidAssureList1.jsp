...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	...
	CurComp.setAttribute("RightType","ReadOnly");//当前页面以及子页面为只读 add by zrli
	%>
<%/*~END~*/%>
...
<%
	...
	doTemp.setFilter(Sqlca,"2","GuarantorName","Operators=BeginsWith,EndWith,Contains,EqualsString;");
	doTemp.parseFilterData(request,iPostChange);
	CurPage.setAttribute("FilterHTML",doTemp.getFilterHtml(Sqlca));
	//设置格式
	doTemp.setAlign("GuarantyValue","3");
	doTemp.setAlign("GuarantyTypeName,GuarantyCurrency,ContractStatusName","2");
