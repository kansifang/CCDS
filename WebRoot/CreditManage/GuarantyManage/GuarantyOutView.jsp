...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View03;Describe=定义树图;]~*/%>
	...
	sSql="select ObjectNo from "+sTable+" where SerialNo='"+sObjectNo+"'";
	...
	String sSqlTreeView = "from CODE_LIBRARY where CodeNo= 'GuarantyOutView' ";
	sSqlTreeView += " and IsInUse = '1' " ;
...
<%/*~BEGIN~可编辑区[Editable=true;CodeAreaID=View05;]~*/%>
	...
	function TreeViewOnClick(){
		...
		if(sCurItemDescribe0 != "null"){
			openChildComp(sCurItemDescribe1,sCurItemDescribe0,"ComponentName="+sCurItemName+"&AccountType=ALL&"+sCurItemDescribe2+"&CustomerID=<%=sCustomerID%>&SignalType=<%=sSignalType%>");
