...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		...
		{(sGuarantyStatus.equals("01")?"true":"false"),"","Button","入库","质物入库","loadGuaranty()",sResourcesPath},
		{(sGuarantyStatus.equals("02")?"false":"false"),"","Button","价值变更","质物价值变更","valueChange()",sResourcesPath},
		{(sGuarantyStatus.equals("02")?"false":"false"),"","Button","信息变更","质物其他信息变更","otherChange()",sResourcesPath},
//		{(sGuarantyStatus.equals("02")?"true":"false"),"","Button","临时出库","质物临时出库","unloadGuaranty1()",sResourcesPath},
		...
		{(sGuarantyStatus.equals("03")?"false":"false"),"","Button","再回库","质物再回库","reloadGuaranty()",sResourcesPath},
