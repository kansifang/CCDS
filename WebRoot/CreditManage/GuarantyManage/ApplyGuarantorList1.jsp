...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List00;Describe=注释区;]~*/%>
	...
	/*
		...
		Tester:
		Describe: 业务申请新增的担保信息所对应的保证人信息列表;
		Input Param:
			ObjectType：对象类型
			ObjectNo: 对象编号
			ContractNo：担保信息编号
...
<%
	...
	sTempletNo = "GuarantorList1";
	ASDataObject doTemp = new ASDataObject(sTempletNo,Sqlca);
	
	//担保信息项下的保证人
	PG_TITLE = "担保信息["+sContractNo+"]项下的保证人信息列表@PageTitle";
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"true","","Button","新增","新增保证人信息","newRecord()",sResourcesPath},		
		{"true","","Button","详情","查看保证人信息详情","viewAndEdit()",sResourcesPath},
		{"true","","Button","删除","删除保证人信息","deleteRecord()",sResourcesPath}
	};
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{		
		OpenPage("/CreditManage/GuarantyManage/ApplyGuarantorInfo1.jsp?ObjectType=<%=sObjectType%>&ObjectNo=<%=sObjectNo%>&ContractNo=<%=sContractNo%>","_self");
	}
	...
	function viewAndEdit()
	{
		...
		{
			OpenPage("/CreditManage/GuarantyManage/ApplyGuarantorInfo1.jsp?ObjectType=<%=sObjectType%>&ObjectNo=<%=sObjectNo%>&ContractNo=<%=sContractNo%>&GuarantyID="+sGuarantyID,"_self");
		}
	}
