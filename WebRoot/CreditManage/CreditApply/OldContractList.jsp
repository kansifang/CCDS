...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "原合同信息"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%
	...
	sSql =  " select B.SerialNo,B.CustomerID,B.CustomerName, "+
			...
			" getBusinessName(B.BusinessType) as BusinessTypeName,"+
			" B.BusinessSum,B.BALANCE,getUserName(B.ManageUserID) as ManageUserName,"+
			" getOrgName(B.ManageOrgID) as ManageOrgName,R.ObjectNo,R.ObjectType,B.RELATIVESERIALNO "+
			" from BUSINESS_CONTRACT_HISTORY as B ,"+sRTableName+" R "+
			" where "+
			" R.ObjectType='ContractChange'"+
			" and B.order=R.ObjectNo "+
	...
	doTemp.setVisible("ObjectNo,ObjectType,RELATIVESERIALNO",false);
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	{	
		...
		var sObjectNo=getItemValue(0,getRow(),"RELATIVESERIALNO");
		if (typeof(sObjectNo)=="undefined" || sObjectNo.length==0)
		{
			alert(getHtmlMessage('1'));//请选择一条信息！
			return;
