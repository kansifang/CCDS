...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	String sSql = "select SerialNo,HandleNo,Treatment,EndTime,Remark from ALERT_HANDLE AH where AH.SerialNo='"+sAlertID+"' and AH.HandleNo='"+sHandleNo+"'";
	String[][] sHeaders = {
		{"Treatment","处理结果"},
		{"EndTime","处理完成日期"},
		{"Remark","备注"},
	...
	doTemp.setEditStyle("Treatment,Remark","3");
