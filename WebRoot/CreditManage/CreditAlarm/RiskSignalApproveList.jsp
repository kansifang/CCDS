...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "预警信号发起认定信息"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function viewReport()
	{
		...
		PopComp("RiskSignalReports","/CreditManage/CreditAlarm/RiskSignalInspectList.jsp","CustomeID="+sObjectNo+"&viewOnly=1","");
	}
	...
	function writeReport()
	{
		...
		PopComp("RiskSignalReport","/CreditManage/CreditAlarm/RiskSignalInspectInfo.jsp","ObjectType=RiskSignal&EditRight=01&ObjectNo="+sSerialNo,"");
	}
	...
	{	
		...
		//检查是否签署意见
		var sReturn = PopPage("/Common/WorkFlow/RiskCheckOpinionAction.jsp?SerialNo="+sSerialNo,"","dialogWidth=0;dialogHeight=0;minimize:yes");
