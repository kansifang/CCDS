...
<%	
	...
	String sSql =  " select SerialNo,"+
					...
					" And days(replace('"+StringFunction.getToday()+"','/','-')) - days(replace(DunDate,'/','-')) > "+sDays+
					" And FeedbackValitity is Null "+
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function viewAndEdit()
	{
		...
		{
			OpenPage("/CreditManage/CreditAlarm/AlertDunInfo.jsp?SerialNo="+sSerialNo,"_self","");
		}
	}
	...
	function newRecord()
	{
		OpenPage("/CreditManage/CreditAlarm/AlertDunInfo.jsp","_self","");
	}	
