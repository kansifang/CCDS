...
<%	
	...
	doTemp.setReadOnly("ActionFlagName,ActionTypeName,FreeFlag,Remark,InputOrgName,InputDate,UpdateDate",true);			
	//设置格式	
	...
	doTemp.setHTMLStyle("MessageContent,Remark"," style={height:100px;width:400px;overflow:scroll} ");
