...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View03;Describe=定义树图;]~*/%>
	...
	//获取合同所对应的业务品种
	sBusinessType = Sqlca.getString("select BusinessType from BUSINESS_CONTRACT where SerialNo='"+sSerialNo+"'");
	//获取业务品种所对应的是否联机处理标志
	sTypesortNo = Sqlca.getString("select TypesortNo from BUSINESS_TYPE where TypeNo='"+sBusinessType+"'");
