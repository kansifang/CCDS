...
//	String sTempletNo = "CreditLineApplyCreationInfo";
	...
	sSql = 	" select SerialNo,RelativeNo,OccurType,CustomerID,CustomerName, "+
			...
			" from CONTRACT_MODIFY where 1 = 2 ";
	//根据模板编号设置数据对象	
	...
	//设置必输背景色
	doTemp.UpdateTable = "CONTRACT_MODIFY";
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info04;Describe=定义按钮;]~*/%>
	...
	//依次为：
		...
		//6.资源图片路径
	String sButtons[][] = {
			{"true","","Button","确认","确认新增合同变更申请","doCreation()",sResourcesPath},
			{"true","","Button","取消","取消新增合同变更申请","doCancel()",sResourcesPath}	
	};
	%> 
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	/*~[Describe=新增一笔合同变更申请申请记录;InputParam=无;OutPutParam=无;]~*/
	function doCreation()
	{
		saveRecord("doReturn()");
	}
	
	/*~[Describe=确认新增合同变更申请;InputParam=无;OutPutParam=申请流水号;]~*/
	function doReturn(){
	...
	{			
		setObjectValue("SelectApplyContract","UserID,"+"<%=CurUser.UserID%>","@RelativeNo@0@CustomerID@1@CustomerName@2",0,0,"");
	}
	...
	{
		var sTableName = "CONTRACT_MODIFY";//表名
