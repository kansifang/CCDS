...
<%
	...
	//获得组件参数	
	String sCreditAggreement = DataConvert.toRealString(iPostChange,CurComp.getParameter("CreditAggreement"));
...
<%	
	...
	sSql = "select SerialNo,CustomerID,CustomerName,BusinessType,getBusinessName(BusinessType) as BusinessTypeName,"+
		 ...
		 " Where CreditAggreement = '"+sCreditAggreement+"' "+
		 " and BusinessType = '"+sBusinessType+"' ";	
