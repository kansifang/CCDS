...
DataArr2 = GetLine("D:\\Tmp\\PressTest\\data\\applytype.txt","|")
wlHttp.FormData["ApplyType"] = DataArr2[1]
wlHttp.FormData["PhaseType"] = DataArr2[2]
wlHttp.Post("http://localhost:8080/ALS6/Frame/PressTest/c7_CreditApplyList.jsp")
