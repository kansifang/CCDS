...
%>
	<%
		...
		doTemp.setDDDWCode("ObjectNo","AccountType");
...
%>
	...
	function goBack()
	{
		OpenPage("/SystemManage/AuthorizeManage/AuthorizeBalanceList.jsp?SerialNo=<%=sSerialNo%>","_self","");
	}
	</script>
<%
	/*~END~*/
...
%>
	...
	{	
		if (getRowCount(0) == 0) //如果没有找到对应记录，则新增一条，并设置字段默认值
		{
			...
			setItemValue(0,0,"ObjectType","AccountType");
