...
%>
	<%
		//依次为：
			...
			//6.资源图片路径
		String sButtons[][] = {
			{"true","","Button","新增业务品种","新增业务品种","newRecord()",sResourcesPath},
			{"true","","Button","修改/查看业务品种","修改/查看业务品种","editRecord()",sResourcesPath},
			{"true","","Button","删除业务品种","删除业务品种","delRecord()",sResourcesPath}
			};
	%>
<%
	/*~END~*/
