...
<script language=javascript>
	function batchRecord()
	{
		...
		//--by wwhe 2007-09-02	self.returnValue = sAuthorizeType+"@"+sAuthorizeOrgLevel+"@"+sOrgID+"@"+sRoleID;
		self.returnValue = sAuthorizeType+"@"+sOrgID+"@"+sRoleID;
		self.close();
	}
</script>
...
<br>
	...
	<tr>
		<td nowarp align="right" class="black9pt" bgcolor="#DCDCDC" >选择机构：</td>
		<td nowarp bgcolor="#DCDCDC" > 
		<select name="OrgID">
			<%
    ...
    <tr>
        ...
        <input type="button" name="next" value="确认" onClick="javascript:batchRecord()" style="font-size:9pt;padding-top:3;padding-left:5;padding-right:5;background-image:url(../../Resources/functionbg.gif); border: #DEDFCE;  border-style: outset; border-top-width: 1px; border-right-width: 1px;  border-bottom-width: 1px; border-left-width: 1px" border='1'>
