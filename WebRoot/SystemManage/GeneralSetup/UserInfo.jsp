...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	//依次为：
		...
		//6.资源图片路径
	String sButtons[][] = {
		{((CurUser.hasRole("098") || CurUser.hasRole("299") || CurUser.hasRole("0M2") || CurUser.hasRole("0J2"))?"true":"false"),"","Button","保存","保存修改","saveRecord()",sResourcesPath},
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function pageReload()
	{
		sUserID   = getItemValue(0,getRow(),"UserID");//--关联客户代码
