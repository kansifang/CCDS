...
<%	
	...
	String sTempletNo = "OrgAuthIndInfo";
	String sTempletFilter = "1=1";
	String sRoleIDRange = "";
	ASDataObject doTemp = new ASDataObject(sTempletNo,sTempletFilter,Sqlca);
	sRoleIDRange = "'410','210','2C1','2B1','208','0B8','0B1','0C1','012','010','2A1','2D5'";
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info04;Describe=定义按钮;]~*/%>
	...
	//依次为：
		...
		//6.资源图片路径
	String sButtons[][] = {
		{((CurUser.hasRole("097"))?"false":"true"),"","Button","保存","保存修改","saveRecord()",sResourcesPath},
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=自定义函数;]~*/%>
	...
	{		
		setObjectValue("SelectIndBusinessType1","","@BusinessType@0@BusinessTypeName@1",0,0,"");	
		sBusinessType = getItemValue(0,0,"BusinessType");
		if("1150010,1150050,1150060,1140130,1150020".indexOf(sBusinessType)>-1){
			setItemDisabled(0,0,"Attribute1",false);
			setItemRequired(0,0,"Attribute1",true);
			getASObject(0,0,"Attribute1").style.background ="WHITE";
		}else{
			setItemDisabled(0,0,"Attribute1",true);
			setItemRequired(0,0,"Attribute1",false);
			getASObject(0,0,"Attribute1").style.background ="#efefef";
			setItemValue(0,0,"Attribute1","");	
		}
		if("1150050,1150060,1140130,3060".indexOf(sBusinessType)>-1){
			setItemDisabled(0,0,"Attribute2",false);
			setItemRequired(0,0,"Attribute2",true);
			getASObject(0,0,"Attribute2").style.background ="WHITE";
		}else{
		...
		if("1140080".indexOf(sBusinessType)>-1){
			setItemDisabled(0,0,"Attribute3",false);
			setItemRequired(0,0,"Attribute3",true);
			getASObject(0,0,"Attribute3").style.background ="WHITE";
		}else{
			setItemDisabled(0,0,"Attribute3",true);
			setItemRequired(0,0,"Attribute3",false);
			getASObject(0,0,"Attribute3").style.background ="#efefef";
