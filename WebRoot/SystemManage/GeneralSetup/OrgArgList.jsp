...
%>
	<%
		String PG_TITLE = "机构参数管理列表"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%
	/*~END~*/
%>
...
%>
	...
	function newRecord()
	{
        OpenPage("/SystemManage/GeneralSetup/OrgArgInfo.jsp","_self","");            
	}
	...
	function viewAndEdit()
	{
		...
		OpenPage("/SystemManage/GeneralSetup/OrgArgInfo.jsp?CurOrgID="+sOrgID,"_self","");        
	}
