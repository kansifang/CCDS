...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View02;Describe=定义变量，获取参数;]~*/%>
	...
	//定义变量
	String sSql = "";	
	String sSynthesisTemplet = "";
	String sSynthesisInfoTemplet = "";
	ASResultSet rs = null;
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View03;Describe=定义树图;]~*/%>
	...
	{
		sSqlTreeView += " AND OrgID in(select OrgID from ORG_INFO where OrgLevel='3' and OrgFlag='030') ";
	}
	//如果是总行业务中心管理员
	if(CurUser.hasRole("0J2"))
	{
		sSqlTreeView += " AND OrgID in('9900') ";
	}
	//参数从左至右依次为：
...
<%/*~BEGIN~可编辑区[Editable=true;CodeAreaID=View05;]~*/%>
	...
	function TreeViewOnClick()
	{
		...
		{
			OpenComp("UserList","/SystemManage/GeneralSetup/UserList.jsp","ComponentName=用户管理&OrgID="+sOrgID,"right");
