...
<%
	...
	String sSql = 	" select CustomerID, "+
	                ...
	                " getItemName('YesNo',BelongAttribute) as BelongAttribute,UpdateDate,ApplyReason "+                
	                " from CUSTOMER_BELONG readpast" +
	...
	if(sRightType.equals("03"))
        sSql += " and ApplyRight = '"+CurOrg.OrgID+"' and ApplyStatus = '2' ";
