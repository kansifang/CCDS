...
%>
	<%
		String PG_TITLE = "机构管理视图"; // 浏览器窗口标题 <title> PG_TITLE </title>
		String PG_CONTENT_TITLE = "&nbsp;&nbsp;机构管理&nbsp;&nbsp;"; //默认的内容区标题
...
%>
   ...
   function openChildComp(sCompID,sURL,sParameterString)
	...
	function TreeViewOnClick()
	{
		...
		{
			OpenPage("/Common/Configurator/OrgManage/OrgList.jsp?ComponentName=机构管理&OrgID="+sOrgID,"right","");
