...
<%	
	...
	sSql = " select getItemName('Currency',Currency) as Currency,UpdateDate,RateID,RateName,Rate "+
	              " from ACCUMULATIONFUNDRATE_CHANGELOG where RateID = '"+sRateID+"' order by UpdateDate";
...
//---------------------定义按钮事件------------------------------------
	...
	function goBack()
	{
		OpenPage("/SystemManage/SynthesisManage/AccumulationFundRateList.jsp","_self","");
	}
	</script>
<%/*~END~*/%>
