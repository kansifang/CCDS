...
<%	
	...
	sSql = " select SerialNo,RelativeName,Attribute3,Sum2,Sum1,InputOrgID,getOrgName(InputOrgID) as "+
		   " OrgName,InputUserID,getUserName(InputUserID) as UserName,InputDate from RELATIVE_SPECIAL "+	            
	...
	//设置可更新目标表
	doTemp.UpdateTable = "RELATIVE_SPECIAL";
	//设置主键
	...
	//设置html格式
	doTemp.setHTMLStyle("RelativeName"," style={width:250px} ondblclick=\"javascript:parent.viewAndEdit()\"");
	doTemp.setHTMLStyle("UserName,OrgName,UpdateDate"," style={width:100px} ondblclick=\"javascript:parent.viewAndEdit()\"");
	
	//生成查询条件
	doTemp.generateFilters(Sqlca);
	doTemp.setFilter(Sqlca,"1","RelativeName","");
	...
	dwTemp.setEvent("Beforedelete","!CustomerManage.InsertHistoryInfoLog(#SerialNo,"+CurUser.UserID+",ChangeRelativeList)");
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function my_add()
	{ 	 
	    OpenPage("/SystemManage/SynthesisManage/RelativeInfo.jsp","_self","");
	}	                                                                                                                                                                                                                                                                                                                                                 
	...
	function viewAndEdit()
	{
		...
		{
			OpenPage("/SystemManage/SynthesisManage/RelativeInfo.jsp?SerialNo="+sSerialNo, "_self","");
		}
	}
	/*OpenPage("/SystemManage/SynthesisManage/RelativeHistoryList.jsp?SerialNo="+sSerialNo, "_self",""); */	
	function viewHistory()
	{
		sSerialNo   = getItemValue(0,getRow(),"SerialNo");//--流水号
		
		popComp("RelativeHistoryList","/SystemManage/SynthesisManage/RelativeHistoryList.jsp","SerialNo="+sSerialNo,"dialogWidth=50;dialogHeight=25;resizable=no;scrollbars=no;status:yes;maximize:no;help:no;");
	}
