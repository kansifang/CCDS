...
%>
	<%
		...
		String sSqlTreeView = " from CODE_LIBRARY where CodeNo= 'SynthesisManage' and IsInUse = '1' and itemno in ('020','040','050','060','070','080') ";
		if(CurUser.hasRole("099")){
			sSqlTreeView = " from CODE_LIBRARY where CodeNo= 'SynthesisManage' and IsInUse = '1' ";
		}
		
		tviTemp.initWithSql("ItemNo","ItemName","ItemDescribe","","",sSqlTreeView,"Order By SortNo",Sqlca);
		//参数从左至右依次为：
...
<script language=javascript> 
	...
	function TreeViewOnClick()
	{
		...
		if(sCurItemDescribe1 != "null" && sCurItemDescribe1 != "" && sCurItemDescribe1 != "root"){
			OpenComp(sCurItemDescribe2,sCurItemDescribe1,"CurItemID="+sCurItemID+"&CurItemDescribe3="+sCurItemDescribe3+"&ComponentName="+sCurItemName,"right");
