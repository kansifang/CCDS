...
<script language="javascript">
    ...
    {    	
    	...
    	{				
			//获取合并后的客户			
			sCustomerInfo = setObjectValue("SelectOwner","","",0,0);				
