...
<%
	...
	sSql = " select SerialNo,CapitalDate,CapitalSum,InputOrgID,getOrgName(InputOrgID) as "+
	...
	//设置number列
	doTemp.setCheckFormat("CapitalSum","2");
	...
	doTemp.setFilter(Sqlca,"1","CapitalDate","");
...
%>
	...
	function my_add()
	{ 	 
	    OpenPage("/SystemManage/SynthesisManage/CapitalSumInfo.jsp","_self","");
	}	                                                                                                                                                                                                                                                                                                                                                 
