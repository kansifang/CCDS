...
%>
	<%
		...
		//设置只读列
		doTemp.setReadOnly("CertID,CertType,CustomerName,OrgName,UserName,InputDate,UpdateDate",true); 
		//设置日期的格式
...
%>
	...
	function saveRecord(sPostEvents)
	{
		...
		if(bIsInsert)
		{
			...
			sType = '40';
			sReturn = RunMethod("AlarmDeal","BlackManage",sCertID+","+sType);
			if(sCertID == sReturn)
			{
				alert("该客户已被列入黑名单,请重新输入或选择！");
				return;
			}
			beforeInsert();
