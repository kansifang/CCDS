...
<%
	...
	//业务办理权、是否成功标志
	ASResultSet rs = null ;
	String sSql = "",sBelongAttribute3 = "",sFlag = "";
	//-------begin--- add by xqli 2010/02/08 补登阶段，不检测客户的业务办理权
	...
	// ------end------add by xqli 2010/02/08 补登阶段，不检测客户的业务办理权
    	...
    	try{
			...
			bzUpdateCustomerRelaInfo.run(Sqlca);
	        	}else
	        	{
	        		...
	        		if(ChangeObject[j].equals("PutOut") && iCountPutPut > 0) //出账
	        		{	        	
