...
<% 	
	...
	try
	{
		...
		ASUser CurUser = new ASUser(sUserID,Sqlca); 	//建立当前用户
...
%>
	<script language=javascript>
		window.open("<%=sWebRootPath%>/Redirector.jsp?ComponentURL=/adminWelcome.jsp&ComponentID=adminWelcome&ToDestroyClientID=<%=CurComp.ClientID%>&ParentClientID=<%=CurComp.ClientID%>&rand="+randomNumber(),"_top");
	</script>
<%	    
	}
	catch (Exception e)
