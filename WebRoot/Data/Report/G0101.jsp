...
<%
	...
	sTemp.append("	<form method='post' action='0102001.jsp' name='reportInfo'>");	
	sTemp.append("<div id=reporttable>");	
	sTemp.append("<table class=table1 width='640' align=center border=1 cellspacing=0 cellpadding=2 bgcolor=white bordercolor=black bordercolordark=black >	");
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=center colspan=42 bgcolor=#aaaaaa ><font style=' font-size: 14pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >附录一：风险分类意见</font></td>"); 	
	sTemp.append("   </tr>");
	while(rs.next())
	{
		...
		*/
	    sTemp.append("   </tr>");
		sTemp.append("   <tr>");
		sTemp.append("   <td align=center class=td1 >合同金额(元)：</td>");
		sTemp.append("   <td colspan=2 align=right class=td1 >"+sBusinessSum+"&nbsp;</td>");
		/*
		sTemp.append("   <td align=center class=td1 >借据金额(元)：</td>");
		sTemp.append("   <td colspan=2 align=right class=td1 >"+sBusinessSum+"&nbsp;</td>");
		*/
		sTemp.append("   <td align=center class=td1 >余额(元)：</td>");
