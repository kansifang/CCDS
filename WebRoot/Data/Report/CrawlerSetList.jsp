...
<%
	...
	sSql =  " select  CodeNo,ItemNo,ItemName,SortNo,RelativeCode,ItemDescribe,ItemAttribute,"+
...
%>
	<%
		...
		String sButtons[][] = {
				...
				{"false","","Button","爬取","查看","crawl()",sResourcesPath},
...
%>
	...
	function newRecord()
	{
		...
		popComp("CrawlerSetInfo","/Data/Report/CrawlerSetInfo.jsp","CodeNo=<%=sCodeNo%>","dialogWidth=100;dialogHeight=70;status:no;center:yes;help:no;minimize:no;maximize:no;border:thin;statusbar:no");
		reloadSelf();
	}
	...
	function viewAndEdit()
	{
		...
		popComp("CrawlerSetInfo","/Data/Report/CrawlerSetInfo.jsp","CodeNo="+sCodeNo+"&ItemNo="+sItemNo,"dialogWidth=100;dialogHeight=70;status:no;center:yes;help:no;minimize:no;maximize:no;border:thin;statusbar:no");
		reloadSelf();
	}
	...
	{
		var CodeNo="<%=sCodeNo%>";
		var seeds = getItemValue(0,getRow(),"RelativeCode");
		var nregex = getItemValue(0,getRow(),"ItemDescribe");
		var pregex = getItemValue(0,getRow(),"ItemAttribute");
		var sParaString = "";
