...
<%
	...
	ASResultSet rs1 = Sqlca.getResultSet("select ContentLength,Remark,FileName,Attribute2,Attribute3,FullPath from Doc_Attachment"+
	...
	if(!"01".equals(sDisplayType)&&jf!=null){
