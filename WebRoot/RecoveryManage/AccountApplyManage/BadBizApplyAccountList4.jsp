...
<%
	...
	sSql = " select getItemName('RefromBAFlag',RefromBAFlag) as RefromBAFlag ,SerialNo,RelativeContractNo,BelongOrgID,getOrgName(BelongOrgID) as BelongOrgName,FirstPutOutDate,LastMaturity,LoanAccountNo,"+
		...
		" where AccountType='040' and ObjectNo = '"+sObjectNo+"'";
	...
	*/
	...
	//设置金额为三位一逗数字
	doTemp.setType("InitializeBalance,DisposeTotalSum,MoneyReturnSum,ReformUpSum,NotReformUpSum,PayDebtSum,CVSum,MetathesisSum,CleanInterest1,CleanInterest2,FinalBalance,FinalInterest,ReturnLawSum,ReturnLawInterest,ReformSBSum","Number");

	//设置数字型，对应设置模版"值类型 2为小数，5为整型"
	doTemp.setCheckFormat("InitializeBalance,DisposeTotalSum,MoneyReturnSum,ReformUpSum,NotReformUpSum,PayDebtSum,CVSum,MetathesisSum,CleanInterest1,CleanInterest2,FinalBalance,FinalInterest,ReturnLawSum,ReturnLawInterest,ReformSBSum","2");
	
	//设置字段对齐格式，对齐方式 1 左、2 中、3 右
	doTemp.setAlign("InitializeBalance,DisposeTotalSum,MoneyReturnSum,ReformUpSum,NotReformUpSum,PayDebtSum,CVSum,MetathesisSum,CleanInterest1,CleanInterest2,FinalBalance,FinalInterest,ReturnLawSum,ReturnLawInterest,ReformSBSum","3");
...
<script language=javascript>
	...
	function importAccount(){
		sOrgID = "<%=CurOrg.OrgID%>";
		sAccountType = "040"
		var sObjectNo = PopComp("SelectBadBizAccount4","/RecoveryManage/AccountApplyManage/SelectBadBizAccount4.jsp","OrgID="+sOrgID+"&AccountType="+sAccountType,"","");
	...
	function new_Account()
	{
		...
		sObjectNo = "<%=sObjectNo%>";
		popComp("BadBizApplyAccountInfo","/RecoveryManage/AccountApplyManage/BadBizApplyAccountInfo.jsp","ComponentName=不良贷款台帐申请详情&SerialNo="+sSerialNo+"&AccountType=040&RefromBAFlag="+sRefromBAFlag+"&ObjectNo="+sObjectNo,"","");
		reloadSelf();
	}
	...
	function viewTab()
	{
		...
		if (typeof(sSerialNo)=="undefined" || sSerialNo.length==0)
		{
			...
			popComp("BadBizApplyAccountInfo","/RecoveryManage/AccountApplyManage/BadBizApplyAccountInfo.jsp","ComponentName=不良贷款台帐详情&SerialNo="+sSerialNo+"&AccountType=040&AccountEditFlag=01","","");
			reloadSelf();
		}
	}
