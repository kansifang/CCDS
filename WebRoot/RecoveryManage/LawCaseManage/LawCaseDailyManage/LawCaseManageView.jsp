...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View02;Describe=定义变量，获取参数;]~*/%>
	...
	//获取案件类型
	sSql =  " select LawCaseType from LAWCASE_INFO where SerialNo = '"+sSerialNo+"' ";   
   	sLawCaseType = Sqlca.getString(sSql); 
	...
	function TreeViewOnClick()
	{
		...
		if(sCurItemID!="root")
		{
			...
			{  	
				...
				{
					openChildComp(sCurItemDescribe2,sCurItemDescribe1,"ComponentName="+sCurItemName+"&ObjectType=LawcaseInfo&ObjectNo="+sSerialNo,OpenStyle);
				}else
				//the above added by Gongfs 2005-03-10
				openChildComp(sCurItemDescribe2,sCurItemDescribe1,"ComponentName="+sCurItemName+"&BookType="+sBookType+"&SerialNo="+sSerialNo+"&LawCaseType="+sLawCaseType,OpenStyle);
