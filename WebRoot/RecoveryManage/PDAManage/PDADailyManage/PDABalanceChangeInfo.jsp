...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=定义按钮事件;]~*/%>
	...
	function saveRecord()
	{
		...
		var sReturn = PopPage("/RecoveryManage/PDAManage/PDADailyManage/PDABalanceChangeAction.jsp?SerialNo="+sObjectNo+"&Interval_Value="+TempValue+"&ChangeType="+NewChangeType,"","");
