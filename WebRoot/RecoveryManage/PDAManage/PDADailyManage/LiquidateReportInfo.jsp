...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "抵债资产日常监控管理盘点清查详情"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	String sTempletNo = "LiquidateReportInfo";
...
<script language=javascript>
	...
	function goBack()
	{
		...
		{
			OpenPage("/RecoveryManage/PDAManage/PDADailyManage/LiquidateReportList.jsp","_self","");
		}
	}
...
<script language=javascript>
	...
	function initRow()
	{
		if (getRowCount(0)==0) //如果没有找到对应记录，则新增一条，并设置字段默认值
		{
			...
			setItemValue(0,0,"ReportType","020");//报告类型
