...
<%
	...
	sSql = " select '' as Status,SerialNo,RelativeContractNo,BelongOrgID,getOrgName(BelongOrgID) as BelongOrgName,FirstPutOutDate,LastMaturity,LoanAccountNo,"+
	    ...
	    " from BADBIZ_ACCOUNT "+
		" where AccountType='040' and StateFlag='"+sStateFlag+"' "+
	...
	*/
	...
	//汇总			
	String[][] sListSumHeaders = {	{"Sum1","资金置换不良贷款本金期初余额"},
									{"Sum2","报告期清收处置本金合计"},
									{"Sum3","报告期货币资金收回"},
									{"Sum4","报告期重组转回"},
									{"Sum5","报告期其他方式收回"},
...
<script language=javascript>
	...
	function account_Maintenance()
	{
		...
		if (typeof(sSerialNo)=="undefined" || sSerialNo.length==0)
		{
			...
			popComp("BadBizAccountInfo","/RecoveryManage/AccountManage/BadBizAccountInfo.jsp","ComponentName=不良贷款台帐详情&SerialNo="+sSerialNo+"&StateFlag=<%=sStateFlag%>&AccountType=040&AccountEditFlag=01","","");
			reloadSelf();
		}
	}
	...
	function account_Info()
	{
		...
		if (typeof(sSerialNo)=="undefined" || sSerialNo.length==0)
		{
			...
			popComp("BadBizAccountInfo","/RecoveryManage/AccountManage/BadBizAccountInfo.jsp","ComponentName=不良贷款台帐详情&SerialNo="+sSerialNo+"&StateFlag=<%=sStateFlag%>&AccountType=040&AccountEditFlag=03","","");
		}
	}
