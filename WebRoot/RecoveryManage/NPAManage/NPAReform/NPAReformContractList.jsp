...
<%
	...
	else
	{
 		sSql = " select SerialNo,ArtificialNo," + 	
			   ...
			   " Where  SerialNo in (select ObjectNo from Reform_RELATIVE where SerialNo='"+sSerialNo+"' and ObjectType='BusinessContract') "+
...
<script language=javascript>
	...
	function viewApply()
	{
		...
		var sReturn = PopPage("/RecoveryManage/NPAManage/NPAReform/NPAReformAction.jsp?ContractNo="+sContractNo+"&Flag=ReformApply","","resizable=yes;dialogWidth=25;dialogHeight=15;center:yes;status:no;statusbar:no");
