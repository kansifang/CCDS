...
<%
	...
	*/
	...
	//设置共用格式
	doTemp.setVisible("RelativeContractNo,CertType,RecoverOrgID,RecoverUserID,IsFinish,AccountNeedManage,BasicNeedManage",false);
...
<script language=javascript>
	...
	function bAccount_Maintenance()
	{
		...
		if (typeof(sSerialNo)=="undefined" || sSerialNo.length==0)
		{
			...
			popComp("BadBizAccountInfo","/RecoveryManage/AccountManage/BadBizAccountInfo.jsp","ComponentName=不良贷款台帐详情&SerialNo="+sSerialNo+"&StateFlag=<%=sStateFlag%>&AccountType=030&AccountEditFlag=02","","");
			reloadSelf();
		}
	}
