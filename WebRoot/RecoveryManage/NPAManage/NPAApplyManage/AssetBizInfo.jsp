...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "关联不良贷款信息详情"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	String sTempletNo = "AssetBizInfo";
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=定义按钮事件;]~*/%>
	...
	function goBack()
	{
		OpenPage("/RecoveryManage/NPAManage/NPAApplyManage/AssetBizList.jsp","_self","");
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	function selectBadContract()
	{	
		sParaString = "RecoveryOrgID,"+"<%=CurOrg.OrgID%>"+",RecoveryUserID,"+"<%=CurUser.UserID%>";
		setObjectValue("SelectBadContract",sParaString,"@ContractSerialNo@0@CustomerID@1@CustomerName@2@Balance@3@Interest@4",0,0,"");
	}
