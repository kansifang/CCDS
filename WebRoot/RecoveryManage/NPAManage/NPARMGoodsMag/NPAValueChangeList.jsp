...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
		OpenPage("/RecoveryManage/NPAManage/NPARMGoodsMag/NPAValueChangeInfo.jsp?ChangeType=<%=sChangeType%>","_self");
	}
	...
	function viewAndEdit()
	{
		...
		{
			OpenPage("/RecoveryManage/NPAManage/NPARMGoodsMag/NPAValueChangeInfo.jsp?SerialNo="+sSerialNo,"_self");
		}
	}
