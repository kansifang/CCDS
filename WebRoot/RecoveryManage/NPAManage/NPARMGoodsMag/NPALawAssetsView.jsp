...
<script language=javascript> 
	...
	function TreeViewOnClick()
	{
		...
		{	
			...
			{
				openChildComp(sCurItemDescribe2,sCurItemDescribe1,"ComponentName="+sCurItemName+"&SerialNo="+sSerialNo+"&ObjectNo="+sSerialNo+"&ObjectType="+sObjectType+"&ItemID="+sCurItemID+"",OpenStyle);
