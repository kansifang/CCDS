...
//	sSql = 	"select AccountMonth,geterate(getreportcurrency(AccountMonth,CustomerID,Scope),'01',AccountMonth)*Item2Value as a2 "+
	...
	//4、Sale_fee：（营业费用(损益表中5cc)+其他主营业务成本(50209)）/主营业务收入
	...
	//10、D&A：本年折旧和摊销总额5dd(report3)/年初年末平均(固定资产净值+无形资产)
...
//   如果没有该期报表，显示为空值。如果有该期报表，但没有该数值，显示为"0"。--->1.default=0,2.insert,3.if no month,then update set null
	...
	try
    {
		...
		Sqlca.executeSQL("insert into CashFlow_Parameter(customerid,baseyear,reportscope,parameterno,parametercode,parametername,"+
						...
						" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',0,'Sales','主营业务收入(万元)'," +
		...
		*/
		...
		Sqlca.executeSQL("insert into CashFlow_Parameter(customerid,baseyear,reportscope,parameterno,parametercode,parametername,"+
								" value1,value2,value3,value4,value5,valuea) "+
						" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',1,'G','主营业务收入增长率(%)'," +
								p1_1*100 + "," + p1_2*100 + ","+ p1_3*100 + "," + p1_4*100 + ","  + p1_5*100 + "," + p1_a*100 + ")");
		Sqlca.executeSQL("insert into CashFlow_Parameter(customerid,baseyear,reportscope,parameterno,parametercode,parametername,"+
								" value1,value2,value3,value4,value5,valuea) "+
						" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',2,'Cost','主营业务成本/主营业务收入(%)'," +
								p2_1*100 + "," + p2_2*100 + ","+ p2_3*100 + "," + p2_4*100 + ","  + p2_5*100 + "," + p2_a*100 + ")");
		Sqlca.executeSQL("insert into CashFlow_Parameter(customerid,baseyear,reportscope,parameterno,parametercode,parametername,"+
								" value1,value2,value3,value4,value5,valuea) "+
						" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',3,'Oper_tax','主营业务税金及附加/主营业务收入(%)'," +
								p3_1*100 + "," + p3_2*100 + ","+ p3_3*100 + "," + p3_4*100 + ","  + p3_5*100 + "," + p3_a*100 + ")");
		Sqlca.executeSQL("insert into CashFlow_Parameter(customerid,baseyear,reportscope,parameterno,parametercode,parametername,"+
								" value1,value2,value3,value4,value5,valuea) "+
						" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',4,'Sale_fee','（营业费用+其他主营业务成本）/主营业务收入(%)'," +
								p4_1*100 + "," + p4_2*100 + ","+ p4_3*100 + "," + p4_4*100 + ","  + p4_5*100 + "," + p4_a*100 + ")");
		Sqlca.executeSQL("insert into CashFlow_Parameter(customerid,baseyear,reportscope,parameterno,parametercode,parametername,"+
								" value1,value2,value3,value4,value5,valuea) "+
						" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',5,'General_fee','管理费用/主营业务收入(%)'," +
								p5_1*100 + "," + p5_2*100 + ","+ p5_3*100 + "," + p5_4*100 + ","  + p5_5*100 + "," + p5_a*100 + ")");
		Sqlca.executeSQL("insert into CashFlow_Parameter(customerid,baseyear,reportscope,parameterno,parametercode,parametername,"+
								" value1,value2,value3,value4,value5,valuea) "+
						" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',6,'Other_income','其他业务利润/主营业务收入(%)'," +
								p6_1*100 + "," + p6_2*100 + ","+ p6_3*100 + "," + p6_4*100 + ","  + p6_5*100 + "," + p6_a*100 + ")");
		Sqlca.executeSQL("insert into CashFlow_Parameter(customerid,baseyear,reportscope,parameterno,parametercode,parametername,"+
								" value1,value2,value3,value4,value5,valuea) "+
						" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',7,'CurrA','（流动资产－货币资金和短期投资）/主营业务收入(%)'," +
								p7_1*100 + "," + p7_2*100 + ","+ p7_3*100 + "," + p7_4*100 + ","  + p7_5*100 + "," + p7_a*100 + ")");
		Sqlca.executeSQL("insert into CashFlow_Parameter(customerid,baseyear,reportscope,parameterno,parametercode,parametername,"+
								" value1,value2,value3,value4,value5,valuea) "+
						" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',8,'Curr_L','（流动负债－短期借款和一年内到期的长期负债）/主营业务收入(%)'," +
								p8_1*100 + "," + p8_2*100 + ","+ p8_3*100 + "," + p8_4*100 + ","  + p8_5*100 + "," + p8_a*100 + ")");
		Sqlca.executeSQL("insert into CashFlow_Parameter(customerid,baseyear,reportscope,parameterno,parametercode,parametername,"+
								" value1,value2,value3,value4,value5,valuea) "+
						" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',9,'Long_asset','固定资产净值和无形资产/主营业务收入(%)'," +
								p9_1*100 + "," + p9_2*100 + ","+ p9_3*100 + "," + p9_4*100 + ","  + p9_5*100 + "," + p9_a*100 + ")");
		Sqlca.executeSQL("insert into CashFlow_Parameter(customerid,baseyear,reportscope,parameterno,parametercode,parametername,"+
								" value1,value2,value3,value4,value5,valuea) "+
						" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',10,'D&A','本年折旧和摊销总额/年初年末平均(固定资产净值+无形资产)(%)'," +
								p10_1*100 + "," + p10_2*100 + ","+ p10_3*100 + "," + p10_4*100 + ","  + p10_5*100 + "," + p10_a*100 + ")");
		Sqlca.executeSQL("insert into CashFlow_Parameter(customerid,baseyear,reportscope,parameterno,parametercode,parametername,"+
								" value1,value2,value3,value4,value5,valuea) "+
						" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',11,'Tax','所得税率(%)'," +
								p11_1*100 + "," + p11_2*100 + ","+ p11_3*100 + "," + p11_4*100 + ","  + p11_5*100 + "," + p11_a*100 + ")");
		Sqlca.executeSQL("insert into CashFlow_Parameter(customerid,baseyear,reportscope,parameterno,parametercode,parametername,"+
								" value1,value2,valuea) "+
						" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',12,'debt','有息债务总额(万元)'," +
								p12_1 + "," + p12_2 +"," + p12_a + ")");
		Sqlca.executeSQL("insert into CashFlow_Parameter(customerid,baseyear,reportscope,parameterno,parametercode,parametername,"+
								" value1,valuea) "+
						" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',13,'interest','平均利率(%)'," +
								p13_1*100 + "," + p13_a*100 + ")");
		...
		Sqlca.executeSQL("insert into CashFlow_Data(customerid,baseyear,reportscope,fcn,itemno,itemname,itemvalue) "+
			" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',"+sYearCount+",1,'销售收入',null)");
		Sqlca.executeSQL("insert into CashFlow_Data(customerid,baseyear,reportscope,fcn,itemno,itemname,itemvalue) "+
			" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',"+sYearCount+",2,'主营业务成本',null)");
		Sqlca.executeSQL("insert into CashFlow_Data(customerid,baseyear,reportscope,fcn,itemno,itemname,itemvalue) "+
			" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',"+sYearCount+",3,'主营业务税金和附加',null)");
		Sqlca.executeSQL("insert into CashFlow_Data(customerid,baseyear,reportscope,fcn,itemno,itemname,itemvalue) "+
			" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',"+sYearCount+",4,'营业费用和其他主营业务成本',null)");
		Sqlca.executeSQL("insert into CashFlow_Data(customerid,baseyear,reportscope,fcn,itemno,itemname,itemvalue) "+
			" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',"+sYearCount+",5,'管理费用',null)");
		Sqlca.executeSQL("insert into CashFlow_Data(customerid,baseyear,reportscope,fcn,itemno,itemname,itemvalue) "+
			" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',"+sYearCount+",6,'其他业务利润',null)");
		Sqlca.executeSQL("insert into CashFlow_Data(customerid,baseyear,reportscope,fcn,itemno,itemname,itemvalue) "+
			" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',"+sYearCount+",7,'EBIT',null)");
		Sqlca.executeSQL("insert into CashFlow_Data(customerid,baseyear,reportscope,fcn,itemno,itemname,itemvalue) "+
			" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',"+sYearCount+",8,'息前净利润',null)");
		Sqlca.executeSQL("insert into CashFlow_Data(customerid,baseyear,reportscope,fcn,itemno,itemname,itemvalue) "+
			" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',"+sYearCount+",9,'折旧和摊销',null)");
		Sqlca.executeSQL("insert into CashFlow_Data(customerid,baseyear,reportscope,fcn,itemno,itemname,itemvalue) "+
			" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',"+sYearCount+",10,'营运资金变化',null)");
		Sqlca.executeSQL("insert into CashFlow_Data(customerid,baseyear,reportscope,fcn,itemno,itemname,itemvalue) "+
			" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',"+sYearCount+",11,'经营活动产生的现金流',null)");
		Sqlca.executeSQL("insert into CashFlow_Data(customerid,baseyear,reportscope,fcn,itemno,itemname,itemvalue) "+
			" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',"+sYearCount+",12,'资本支出增加',null)");
		Sqlca.executeSQL("insert into CashFlow_Data(customerid,baseyear,reportscope,fcn,itemno,itemname,itemvalue) "+
			" values('" + sCustomerID + "'," + sBaseYear + ",'"+sReportScope+"',"+sYearCount+",13,'自由现金流',null)");
