...
function graphShow()
{
	...
	PopPage("/CustomerManage/FinanceAnalyse/ShowGraph.jsp?GraphType="+document.all("GraphType").value+"&AccountMonths=<%=sAccountMonths%>&ItemNames="+sItemNames+"&ItemValues="+sItemValues+"","_blank",sDefaultDialogStyle);
