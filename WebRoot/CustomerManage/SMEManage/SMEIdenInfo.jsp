...
<%
	...
	sSql = " select CustomerID,SMEIndustryType,SellSum,TOTALASSETS,Scope,Remark " +
			" from ENT_INFO "+
	...
	doTemp.setHTMLStyle("Remark"," style={height:100px;width:400px;overflow:scroll} ");
 	...
 	doTemp.setDDDWCode("SMEIndustryType","SMEIndustryType");
 	doTemp.setDDDWSql("Scope","select ItemNo,ItemName from CODE_LIBRARY where CodeNo='Scope' and ItemNo in('3','4','9')");
	doTemp.setCheckFormat("SellSum,TOTALASSETS,","2");
	doTemp.setRequired("SMEIndustryType,SellSum,TOTALASSETS,",true);
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	{
		var sTableName = "SMEIDEN_INFO";//表名
