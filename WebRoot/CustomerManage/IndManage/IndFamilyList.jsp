...
<%	
	...
	String sSql =	" select CustomerID,RelativeID,RelationShip,CertID,CustomerName,getItemName('RelationShip',RelationShip) as RelationName, " +
					" getItemName('YesNo',EffStatus) as EffStatusName,InputOrgId,getOrgName(InputOrgId) as OrgName," +
					" InputUserId,getUserName(InputUserId) as UserName, " +
					" InputDate,UpdateDate" +
					" from CUSTOMER_RELATIVE " +
					" where CustomerID='"+sCustomerID+"' and RelationShip like '03%' and length(RelationShip)>2";	
	...
	doTemp.setHTMLStyle("EffStatusName,UserName,CustomerName,InputDate,UpdateDate"," style={width:80px} ");
	doTemp.setHTMLStyle("OrgName" ,"style={width:200px} ");
	doTemp.setAlign("RelationName,CertID,CustomerName,UserName,InputDate,UpdateDate","2");
