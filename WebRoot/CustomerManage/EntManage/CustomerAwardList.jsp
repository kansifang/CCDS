...
<%	
	...
	String sSql =   " select SerialNo,"+
					...
					" where CustomerID='"+sCustomerID+"' and BusinessType like '3%' and length(BusinessType)>1 ";

    //用sSql生成数据窗体对象
	ASDataObject doTemp = new ASDataObject(sSql);
	doTemp.setHeader(sHeaders);
	//设置不可见项
	doTemp.setVisible("BusinessType,Balance,VouchType,OperateOrgID,",false);
	doTemp.setAlign("BusinessSum,Balance","3");
	doTemp.setAlign("BusinessTypeName,BusinessCurrencyName,VouchTypeName","2");
	doTemp.setCheckFormat("BusinessSum,Balance","2");
	//设置格式
	doTemp.setHTMLStyle("CreditTypeName,VouchTypeName,PutOutDate,Maturity,BusinessTypeName,VouchTypeName"," style={width:80px} ");
