...
<%
	String sHeaders[][] = {	{"Customername","投资客户名称"},
	       ...
	       sSql = " select CustomerID,RelativeID,CustomerName,RelationShip,getItemName('RelationShip',RelationShip) as RelationShipName,"+
				  " getItemName('Currency',CurrencyType) as CurrencyType,InvestmentSum,OughtSum,InvestmentProp,InputOrgId, " +
   ...
   //用sSql生成数据窗体对象
	...
	//设置不可见项
	doTemp.setVisible("CurrencyType,CustomerID,RelativeID,InputUserId,RelationShip,InputDate,UpdataDate,InputOrgId",false);
	//设置排列方式
	doTemp.setAlign("InvestmentSum,InvestmentProp","3");
	//格式设置
	doTemp.setCheckFormat("InvestmentSum,OughtSum","2");
	doTemp.setType("InvestmentSum,OughtSum,InvestmentProp","number");
	//设置html格式
	doTemp.setHTMLStyle("Customername"," style={width:200px} ");
    doTemp.setHTMLStyle("OrgName"," style={width:200px} ");    		
	doTemp.setAlign("RelationShipName,CurrencyType,UserName","2");
