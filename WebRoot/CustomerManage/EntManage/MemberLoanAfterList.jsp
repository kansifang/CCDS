...
<%	
	...
	doTemp.setHTMLStyle("VouchTypeName,Currency","style={width:100px}");
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function infoGather()
	{
		OpenPage("/CustomerManage/EntManage/MemberLoanAfterGather.jsp?CustomerID=<%=sCustomerID%>&NoteType=<%=sNoteType%>","","");	
	}
	</script>
<%/*~END~*/%>
