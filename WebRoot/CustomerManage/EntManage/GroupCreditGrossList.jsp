...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "集团授信总量列表"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	String sSql =	" select ObjectType,ObjectNo,SerialNo,AccountMonth, "+
					" EvaluateScore,CognScore,OrgID,getOrgName(OrgID) as OrgName, "+
					" UserID,getUserName(UserID) as UserName "+
					" from EVALUATE_RECORD " + 
				    " where ObjectType='GroupGross' and ObjectNo='"+ sCustomerID + "' ";	
	...
	doTemp.setAlign("RelationName,CognScore","2");
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"true","","Button","新增","新增集团授信总量","newRecord()",sResourcesPath},
		{"true","","Button","详情","查看集团授信总量详情","viewAndEdit()",sResourcesPath},
		{"true","","Button","删除","删除集团授信总量","deleteRecord()",sResourcesPath},
		};
	%> 
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
		OpenPage("/CustomerManage/EntManage/GroupCreditGrossInfo.jsp?EditRight=02","_self","");
	}
	...
	function viewAndEdit()
	{
		...
		{       
			OpenPage("/CustomerManage/EntManage/GroupCreditGrossInfo.jsp?SerialNo="+sSerialNo+"&ObjectNo="+sObjectNo+"&ObjectType="+sObjectType+"&EditRight="+sEditRight, "_self","");
		}
	}
