...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	//设置下拉框
	doTemp.setDDDWSql("CertType","select ItemNo,ItemName from CODE_LIBRARY where CodeNo = 'CertType'");
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	function selectCustomer()
	{
		...
		setObjectValue("SelectAssureGroup",sParaString,"@RelativeID@0@CustomerName@1@CertType@2@CertID@3",0,0,"");
	}
