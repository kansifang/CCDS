	...
	ASResultSet rs;
	   ...
	   if (sUseType.equals("1"))
	   {
	    ...
	    sSql =  "  select DISTINCT C.CustomerID,C.CertID,C.MFCustomerID,C.CustomerName from CUSTOMER_INFO C,CUSTOMER_BELONG L"+
	                ...
	                " AND C.CustomerID=L.CustomerID and L.OrgID like  '"+CurOrg.OrgID+"%' and L.BelongAttribute2 ='02'";    
	    }
...
<script language="JavaScript">
    ...
    {      
           ...
           lastRow=iRow;
           sCustomerInfo = sInfo;
           document.all("TDName1"+iRow).style.background="#DCDFF6";
//           document.all("TDName2"+iRow).style.background="#DCDFF6";
           document.all("TDName3"+iRow).style.background="#DCDFF6";
    
           if(iRow!=lastRow)
           {
              document.all("TDName1"+lastRow).style.background="#FEFEFE";
 //             document.all("TDName2"+lastRow).style.background="#FEFEFE";
              document.all("TDName3"+lastRow).style.background="#FEFEFE";
...
<table name=dataTable id=dataTable  /**hmGDTable*/ align=center border=1 cellspacing=0 cellpadding=0 bgcolor=#E4E4E4 bordercolor=#999999 bordercolordark=#FFFFFF >
    <tr>
    		<TD  /**hmGDTdHeader*/ style='font-family:宋体,arial,sans-serif;font-size: 9pt;font-weight: normal; padding-left: 2;color: #55554B;background-color: #FEFEFE;  background-image:url(/ploansub/Resources/1/Support/back.gif);cursor: hand;	text-decoration: none;	text-align:center;'  >&nbsp;组织机构代码 </TD>
<!--    		<TD  /**hmGDTdHeader*/ style='font-family:宋体,arial,sans-serif;font-size: 9pt;font-weight: normal; padding-left: 2;color: #55554B;background-color: #FEFEFE;  background-image:url(/ploansub/Resources/1/Support/back.gif);cursor: hand;	text-decoration: none;	text-align:center;'  >&nbsp;核心系统客户编号 </td>-->
    		<TD  /**hmGDTdHeader*/ style='font-family:宋体,arial,sans-serif;font-size: 9pt;font-weight: normal; padding-left: 2;color: #55554B;background-color: #FEFEFE;  background-image:url(/ploansub/Resources/1/Support/back.gif);cursor: hand;	text-decoration: none;	text-align:center;'  >&nbsp;客户名称 </td>
