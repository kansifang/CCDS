...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=center colspan=5 ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;' >4、担保人在我行未结清授信</font></td> ");	
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
  	sTemp.append(" <td width=20% align=center class=td1 >授信品种&nbsp;</td>");
    sTemp.append(" <td width=20%  align=center class=td1 >合同金额（万元）&nbsp;</td>");
    sTemp.append(" <td width=20% align=center class=td1 >合同余额（万元）&nbsp;</td>");
    sTemp.append(" <td width=20% align=center class=td1 >最近到期日&nbsp;</td>");
	...
	sTemp.append(" <td  align=center class=td1 >授信敞口(万元)&nbsp;</td>");
