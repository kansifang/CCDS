...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=center colspan=6 ><font style=' font-size: 15pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;' >3、借款人在我行的对外担保情况</font></td> ");	
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
  	sTemp.append(" <td width=25% align=center class=td1 >被担保企业&nbsp;</td>");
    sTemp.append(" <td width=15% align=center class=td1 >币种&nbsp;</td>");
  	sTemp.append(" <td width=15% align=center class=td1 >合同金额(万元)&nbsp;</td>");
    sTemp.append(" <td width=15% align=center class=td1 >合同余额(万元)&nbsp;</td>");
