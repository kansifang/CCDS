...
<%
	//获得调查报告数据
	String 	sThirdParty1 = "";				//是否贴息
	double	dFZANBALANCE = 0.0;				//贴息比例
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >2.1、经营单位情况</font></td>"); 	
	sTemp.append("   </tr>");	
	
	sTemp.append("   <tr>");
  	sTemp.append("   <td width=15% height='34' colspan=2 align=left class=td1 >（1）单位名称</td>");
	...
	sTemp.append("   <tr>");
  	sTemp.append("   <td width=15% height='34' colspan=2 align=left class=td1 >（2）成立时间</td>");
  	sTemp.append("   <td width=15% height='34' align=center class=td1 >");
	...
	sTemp.append("   <tr>");
  	sTemp.append("   <td width=15% height='34' colspan=20 align=left class=td1 >2.2、本次贷款是否有贴息");
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >2.3、贷款用途</font></td>"); 	
	sTemp.append("   </tr>");	
