...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >3、业务基本信息</font></td>"); 	
	sTemp.append("   </tr>");
	...
	//保证金
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=center colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >保证金</font></td>"); 	
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
  	sTemp.append("   <td width=18%  align=center class=td1 > 账号 </td>");
	...
	//我行存单
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=center colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >我行存单</font></td>"); 	
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
