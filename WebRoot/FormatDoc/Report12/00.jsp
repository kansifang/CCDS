...
<%
	...
	sTemp.append("   <td class=td1 colspan=8 bgcolor=#aaaaaa ><font style=' font-size: 16pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >天津农商银行审查报告</font></td>"); 	
	sTemp.append("   </tr>");
