...
<%
	...
	sTemp.append("<tr>");	
	sTemp.append("<td class=td1 align=left colspan=16 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >"+sNo1[j]+".3、保证人账户信息</font></td>"); 	
	sTemp.append("</tr>");	
	sTemp.append("<tr>");
    ...
    sTemp.append("<td width=20% rowspan='3' align=center class=td1 > 账号 </td>");
