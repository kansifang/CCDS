...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=center colspan=19 bgcolor=#aaaaaa ><font style=' font-size: 16pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' ><p>贷款用途检查报告</p>附录一、贷款明细</font></td>"); 	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
	...
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
  	sTemp.append("   <td width=15% align=left class=td1 >合同金额(元):</td>");
	sTemp.append("   <td width=85% align=left class=td1 >"+sBusinessSum+"&nbsp;</td>");
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
  	sTemp.append("   <td width=15% align=left class=td1 >余额(元)：</td>");
