...
<%
	...
	sTemp.append("	<form method='post' action='030302.jsp' name='reportInfo'>");	
	sTemp.append("<div id=reporttable>");	
	sTemp.append("<table class=table1 width='640' align=center border=1 cellspacing=0 cellpadding=2 bgcolor=white bordercolor=black bordercolordark=black >	");
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >3.3.3、企业财务分析（附件：财务分析简表）</font></td>"); 	
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 >企业财务数据简表（以现场调查为主，无需出具书面证明，财务报表仅供参考）</font></td>"); 	
	sTemp.append("   </tr>");
	sTemp.append("<tr>");
	sTemp.append("<td width=20% align=left class=td1 nowrap> 科目 </td>");
	sTemp.append("<td width=20% align=left class=td1 nowrap> 上年度 </td>");
	sTemp.append("<td width=25% align=left class=td1 nowrap> 期末/年末 </td>");
	...
	sTemp.append(myOutPut("2",sMethod,"name='describe2' style='width:50%; height:25'",getUnitData("describe2",sData)));
	sTemp.append("      &nbsp;</td>");
	...
	sTemp.append("      &nbsp;</td>");
  	sTemp.append("   	<td   align=right class=td1 >(期末数)");
	sTemp.append(myOutPut("2",sMethod,"name='describe5' style='width:50%; height:25'",getUnitData("describe5",sData)));
	sTemp.append("      &nbsp;</td>");
	...
	sTemp.append("      &nbsp;</td>");
  	sTemp.append("   	<td   align=right class=td1 >(期末数)");
  	sTemp.append(myOutPut("2",sMethod,"name='describe8' style='width:50%; height:25'",getUnitData("describe8",sData)));
	sTemp.append("      &nbsp;</td>");
	sTemp.append("</tr>");
	...
	sTemp.append("      &nbsp;</td>");
  	sTemp.append("   	<td   align=right class=td1 >(期末数)");
	sTemp.append(myOutPut("2",sMethod,"name='describe10' style='width:50%; height:25'",getUnitData("describe10",sData)));
	sTemp.append("      &nbsp;</td>");
	sTemp.append("<td  rowspan=2  align=left class=td1 nowrap>应收账款净额=应收账款余额<br>-预收账款余额=。。。</td>");
	sTemp.append("<td  rowspan=2  align=left class=td1 nowrap>&nbsp;");
	...
	sTemp.append("      &nbsp;</td>");
  	sTemp.append("   	<td   align=right class=td1 >(期末数)");
  	sTemp.append(myOutPut("2",sMethod,"name='describe13' style='width:50%; height:25'",getUnitData("describe13",sData)));
	sTemp.append("      &nbsp;</td>");
	sTemp.append("</tr>");
	...
	sTemp.append("      &nbsp;</td>");
  	sTemp.append("   	<td   align=right class=td1 >(期末数)");
	sTemp.append(myOutPut("2",sMethod,"name='describe15' style='width:50%; height:25'",getUnitData("describe15",sData)));
	sTemp.append("      &nbsp;</td>");
	...
	sTemp.append("      &nbsp;</td>");
  	sTemp.append("   	<td   align=right class=td1 >(期末数)");
  	sTemp.append(myOutPut("2",sMethod,"name='describe18' style='width:50%; height:25'",getUnitData("describe18",sData)));
	sTemp.append("      &nbsp;</td>");
	sTemp.append("</tr>");
	...
	sTemp.append(myOutPut("2",sMethod,"name='describe19' style='width:40%; height:25'",getUnitData("describe19",sData)));
	sTemp.append("      &nbsp;</td>");
	sTemp.append("<td  align=left class=td1 nowrap>预计销售收入年增长率=（预计当年销售收入<br>-上年度销售收入）/上年度销售收入=。。。</td>");
	sTemp.append("<td  rowspan=1  align=left class=td1 nowrap>&nbsp;");
	...
	sTemp.append("<td align=left class=td1 nowrap> --- </td>"); 
	sTemp.append("   	<td   align=right class=td1 >(期末数)");
	sTemp.append(myOutPut("2",sMethod,"name='describe21' style='width:50%; height:25'",getUnitData("describe21",sData)));
	sTemp.append("      &nbsp;</td>");
	sTemp.append("<td  align=left class=td1 nowrap>企业全部</td>");
	sTemp.append("<td  rowspan=1  align=left class=td1 nowrap>&nbsp;");
	...
	sTemp.append("<td align=left class=td1 nowrap> --- </td>");  
	sTemp.append("   	<td   align=right class=td1 >(期末数)");
	sTemp.append(myOutPut("2",sMethod,"name='describe23' style='width:50%; height:25'",getUnitData("describe23",sData)));
	sTemp.append("      &nbsp;</td>");
	sTemp.append("<td  align=left class=td1 nowrap>企业全部</td>");
	sTemp.append("<td  rowspan=1  align=left class=td1 nowrap>&nbsp;");
	...
	sTemp.append("   <tr>");
  	sTemp.append("   <td height='34'colspan=20  align=left class=td1 > 企业其他说明：");
	sTemp.append("   </tr>");  	
	sTemp.append("   <tr>");
  	sTemp.append("   <td colspan='20' align=left class=td1 >");
	sTemp.append(myOutPut("2",sMethod,"name='describe25' style='width:100%; height:150'",getUnitData("describe25",sData)));
	sTemp.append("   <br>");
	sTemp.append("&nbsp;</td>");
    sTemp.append("   </tr>");
