...
<%
	...
	//客户信息
	ASResultSet rs2 = Sqlca.getResultSet("select II.Birthday,getItemName('Sex',Sex) as Sex,II.NativePlace,"
...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=center colspan=12 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >个人贷款调查报告（经营类）</font></td> ");	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
    ...
    sTemp.append(" <td colspan='5' align=left class=td1 >"+sNativePlace+"&nbsp;</td>");
  	sTemp.append(" <td width=15% align=left class=td1 >现工作单位：</td>");
    sTemp.append(" <td colspan='5' align=left class=td1 >"+sWorkcorp+"&nbsp;</td>");
    sTemp.append(" </tr>");
	sTemp.append("  <tr>");
  	sTemp.append(" <td width=15% align=left class=td1 >职务：</td>");
    sTemp.append(" <td colspan='5' align=left class=td1 >"+sHeadship+"&nbsp;</td>");
