...
<%
	...
	sTemp.append("   <tr>");
	sTemp.append("   <td colspan=2 align=left class=td1 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' ><p><strong>四、有无其他风险因素</strong></p></font></td>");
    sTemp.append("   </tr>");
	sTemp.append("   <tr>");
