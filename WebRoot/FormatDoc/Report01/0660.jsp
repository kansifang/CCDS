...
<%
	...
	String sGuarantyDescript = "";	//质押物详细描述
...
<%
	...
	sTemp.append("   <tr align=left>");
  	sTemp.append("   <td colspan=4 class=td1 > 质押物详细描述 <br>"+sGuarantyDescript+"</td>");
	sTemp.append("   </tr>");
	//sTemp.append("   <tr>");
  	//sTemp.append("   <td width=28% align=center class=td1 >质押物共有人</td>");
	...
	sTemp.append("   <td width=28% align=center class=td1 > 质押物价值 </td>");
	...
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
  	sTemp.append("   <td colspan=4 align=left class=td1 "+myShowTips(sMethod)+" ><p>质押物变现能力分析</p>");
