...
<%
	...
	sTemp.append("  <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=30 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >4.4、资产分析</font></td>"); 	
	sTemp.append("  </tr>");	
	//*********************************应收账款分析**********************************
	...
	sTemp.append("  <tr>");
	sTemp.append("   <td colspan='15' align='left' class=td1 "+myShowTips(sMethod)+" >应收账款分析");
	sTemp.append("	 </td>");
	sTemp.append("  </tr>");
	sTemp.append("  <tr>");
    ...
    sTemp.append("   <td colspan='4' align=center class=td1 > 入账价值 </td>");
    sTemp.append("   <td colspan='2' align=center class=td1 >%</td>");
