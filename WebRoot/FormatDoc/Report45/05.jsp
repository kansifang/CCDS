...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=center bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >六、授信结论</font></td>"); 	
