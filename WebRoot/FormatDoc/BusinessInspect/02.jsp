...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=center colspan=19 bgcolor=#aaaaaa ><font style=' font-size: 16pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' ><p>天津农商银行</p>贷款用途检查报告审核表</font></td>"); 	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
...
sTemp.append("   <td colspan=3 align=left class=td1 ><strong>三、分行意见</strong><br>");
	...
	String sPreviewContent = "pvw"+java.lang.Math.random();System.out.println("aaaaa+++"+sMethod);
%>
<%/*~END~*/%>
