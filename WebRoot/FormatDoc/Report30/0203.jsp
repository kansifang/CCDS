...
<%
	...
	sTemp.append("   <tr>	");
	sTemp.append("   <td class=td1 align=left colspan=13 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >2.3、借款人本次授信申请</font></td> ");	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
