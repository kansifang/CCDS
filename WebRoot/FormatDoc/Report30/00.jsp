...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=center colspan=10 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >房地产开发企业贷款调查报告</font></td> ");	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
    ...
    sTemp.append(" <td colspan='5' align=left class=td1 >房地产开发企业贷款</td>");
    sTemp.append(" </tr>");
	sTemp.append("  <tr>");
