...
<%
	...
	sTemp.append("  <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=30 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >5.5、主要资产质量</font></td>"); 	
	sTemp.append("  </tr>");	
	//*********************************应收账款分析**********************************
	sTemp.append("  <tr align='left'>");
  	sTemp.append("   <td colspan='15' class=td1 ><br><strong> (1)应收账款分析 </strong><br>&nbsp;</td>");
	sTemp.append("  </tr>");
	sTemp.append("  <tr>");
	sTemp.append("   <td width='6%' colspan='3' rowspan='2' align=center class=td1 > 账龄分析</td>");
    ...
    sTemp.append("  </tr>");
	sTemp.append("  <tr>");
	sTemp.append("   <td colspan='3' align=center class=td1 > 应收账款</td>");
	...
	sTemp.append("  <tr>");
	sTemp.append("   <td width=6% rowspan='4' align=center class=td1 > 应收账款 </td>");
    ...
    int j=0;
    String sRelatedCorpName = ""; //应收账款大户名单名称
    String sFOASum = "";		  //应收账款金额(万元)
    String sRemark = "";		  //应收账款资金占用/变动原因
    String sDigest = "";		  //应收账款与本企业关系
    double dFOASum = 0;
    if(d010>0)
    {
    	while(true)
	...
	sTemp.append("  <tr>");
	sTemp.append("   <td align='left' colspan='15' class=td1 "+myShowTips(sMethod)+" >应收账款分析");
	sTemp.append("	 </td>");
    sTemp.append("  </tr>");
    sTemp.append("  <tr>");
    ...
    //存货合计
    String sSql91 = "select  sum(ValueSum) from ENT_INVENTORY where InventoryType in('01','02','03','06') and CustomerID = '"+sCustomerID+"'";
    ...
    //产成品
    String sSql9 = "select  ValueSum,getitemname('YesNo',QualityStatus) from ENT_INVENTORY where InventoryType = '02' and CustomerID = '"+sCustomerID+"'";
    ...
    //在产品
    String sSql10 = "select  ValueSum,getitemname('YesNo',QualityStatus) from ENT_INVENTORY where InventoryType = '03' and CustomerID = '"+sCustomerID+"'";
	...
	//其他
	String sSql123 = "select  ValueSum,getitemname('YesNo',QualityStatus) from ENT_INVENTORY where InventoryType = '06' and CustomerID = '"+sCustomerID+"'";
	...
	String sSql12 = "select EvalValue,getItemName('DepreciationWay',Depreciation) as Depreciation,Rate from ENT_FIXEDASSETS where FixedAssetsType = '01' and CustomerID = '"+sCustomerID+"'";
	...
	//机器设备
	String sSql13 = "select EvalValue,getItemName('DepreciationWay',Depreciation) as Depreciation,Rate from ENT_FIXEDASSETS where FixedAssetsType = '02' and CustomerID = '"+sCustomerID+"'";
	...
	//运输工具
	String sSql14 = "select EvalValue,getItemName('DepreciationWay',Depreciation) as Depreciation,Rate from ENT_FIXEDASSETS where FixedAssetsType = '03' and CustomerID = '"+sCustomerID+"'";
	...
	//其他
	String sSql15 = "select EvalValue,getItemName('DepreciationWay',Depreciation) as Depreciation,Rate from ENT_FIXEDASSETS where FixedAssetsType = '04' and CustomerID = '"+sCustomerID+"'";
    ...
    sTemp.append("   <td colspan='4' align=center class=td1 > 入账价值(万元) </td>");
    sTemp.append("   <td colspan='2' align=center class=td1 >%</td>");
    ...
    String sSql16 = "select AssetName,AccountValue,getItemName('EvaluateMethod',EvaluateMethod) as EvaluateMethod from CUSTOMER_IMASSET"+
				    " where CustomerID='"+sCustomerID+"'";
	rs2 = Sqlca.getResultSet(sSql16);
	String sAssetName = "";				//主要内容
	String sAccountValue = "";			//入账价值
	...
	sTemp.append(myOutPut("0",sMethod,"name='describe17' style='width:100%; height:40'",getUnitData("describe17",sData)));
	sTemp.append("	 &nbsp;</td>");    
    sTemp.append("  </tr>");
	sTemp.append("  <tr>");
	...
	sTemp.append("  <tr>");
	sTemp.append("   <td colspan='15' class=td1 "+myShowTips(sMethod)+" > 对外担保和其他或有负债分析 <br>");
	sTemp.append("	 </td>");
    sTemp.append("  </tr>");
    sTemp.append("  <tr>");
	sTemp.append("   <td align='left' colspan='15' class=td1 >");
	...
	sTemp.append("   资产抵押、质押情况应调查企业以往贷款时将哪些资产做了抵押或质押，这些资产的账面价值和评估价值是多少，包括货币资金、存货、固定资产、无形资产。");
	sTemp.append("	 </td>");
    sTemp.append("  </tr>");
    sTemp.append("  <tr>");
	sTemp.append("   <td align='left' colspan='15' class=td1 >");
