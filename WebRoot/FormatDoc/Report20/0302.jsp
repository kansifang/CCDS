...
<%
	...
	ASResultSet rs2 = Sqlca.getResultSet("select BUSINESSTYPE,getBusinessName(BUSINESSTYPE) as BusinessTypeName,getItemName('Currency',BUSINESSCURRENCY),"
								...
								+" Maturity,getItemName('VouchType',VouchType) as VouchType,getItemName('BusinessApplyType',ApplyType) as ApplyType "
	...
	while(rs2.next()){
		...
		sBalance = DataConvert.toMoney(rs2.getDouble(6)/10000);
	...
	{	sSumBusinessSum = DataConvert.toMoney(rs2.getDouble(1)/10000);
		...
		sSumBalance = DataConvert.toMoney(rs2.getDouble(2)/10000);
