...
<%
	...
	ASResultSet rs2 = Sqlca.getASResultSet("select BusinessType,getBusinessName(BusinessType) as BusinessTypeName,BusinessSum,"
										...
										+"getItemName('YesNo',CYCLEFLAG) as CycleFlagName,  "
...
<%
	...
	sTemp.append("<form method='post' action='0803.jsp' name='reportInfo'>");	
	sTemp.append("<div id=reporttable>	");
	sTemp.append("<table class=table1 width='640' align=center border=1 cellspacing=0 cellpadding=2 bgcolor=white bordercolor=black bordercolordark=black >");	
	sTemp.append("   <tr>	");
	sTemp.append("   <td class=td1 align=left colspan=13 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >9.3、综合以上分析，同意按照以下方式给予授信</font></td> ");	
	sTemp.append("   </tr>");
    ...
    sTemp.append(" 		<td colspan='3' align=left class=td1 >"+sApplyType+"&nbsp;</td>");
    sTemp.append(" 	</tr>");
    ...
    sTemp.append(" 		<td colspan='3' align=left class=td1 >"+sTermMonth+"&nbsp;</td>");
    sTemp.append(" 	</tr>"); 
    ...
    sTemp.append(" 		<td  align=left class=td1 >利/费率‰</td>");
    ...
    sTemp.append(" 		<td  align=left class=td1 >"+sSpace+"&nbsp;</td>");
    sTemp.append(" 		<td  align=left class=td1 > 授信总敞口（万元） </td>");
    sTemp.append(" 		<td  align=left class=td1 >"+""+"&nbsp;</td>");
    sTemp.append(" 	</tr>");
    
    sTemp.append("   <tr>");
  	sTemp.append(" 		<td  align=left class=td1 > 担保方式及内容 </td>");
