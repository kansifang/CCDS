...
<%
	...
	sTemp.append(" <tr>");	
	sTemp.append(" <td class=td1 align=left colspan=10 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >2.3.2、在我行的授信业务信息</font></td>"); 	
	sTemp.append(" </tr>");
	sTemp.append(" <tr>");
