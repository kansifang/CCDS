...
<%	
	if(sMethod.equals("4"))  //4:export
	{
		...
		{	
	        ...
	        String st8="<input type=button value='打印设置' onclick=\"WebBrowser1.ExecWB(8,1)\"> <input type=button value='打印预览' onclick=\"WebBrowser1.ExecWB(7,1)\"> <input type=button value='打印' onclick=\"WebBrowser1.ExecWB(6,1)\"> <input type=button value='关闭' onclick=\"WebBrowser1.ExecWB(45,1)\"><p></div></body>  ";
		...
		fileOut.close();
		if(sFirstSection.equals("1")&&!sSql2.equals("")) Sqlca.executeSQL(sSql2);
%>
