...
<%
	...
	sFictitiousPerson = Sqlca.getString("select CustomerName from CUSTOMER_RELATIVE where CustomerID = '"+sGuarangtorID+"' and RelationShip = '0100'");
	...
	sSql = " select count(RS1.SerialNo) from RISK_SIGNAL RS1  "+
						  ...
						  " and RS1.ObjectNo = '"+sGuarangtorID+"' "+
						  " and SignalType = '01' "+
	...
	rs2 = Sqlca.getResultSet("select getItemName('IPOName',BourseName) as BourseName,IPODate,StockName,StockCode from ENT_IPO where CustomerID='"+sGuarangtorID+"' Order by IPODate DESC");
	if(rs2.next())
	{
	...
	String[] sNo1 = null; 
	int iNo=1,j=0;
	sSql = "select TreeNo from FORMATDOC_DATA where ObjectNo = '"+sObjectNo+"' and TreeNo like '120_' and ObjectType = '"+sObjectType+"'";
	rs2 = Sqlca.getResultSet(sSql);
	while(rs2.next())
	{
...
<%
	...
	sTemp.append("<form method='post' action='120201.jsp' name='reportInfo'>");	
	sTemp.append("<div id=reporttable>	");
	sTemp.append("<table class=table1 width='640' align=center border=1 cellspacing=0 cellpadding=2 bgcolor=white bordercolor=black bordercolordark=black >");	
	sTemp.append("   <tr>	");
	sTemp.append("   <td class=td1 align=left colspan=13 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >"+sNo1[j]+"、担保</font></td> ");	
	sTemp.append("   </tr>");
	sTemp.append("   <tr>	");
	sTemp.append("   <td class=td1 align=left colspan=13 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >"+sNo1[j]+".1、担保人基本信息</font></td> ");	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
