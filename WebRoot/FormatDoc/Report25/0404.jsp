...
<%
	...
	sTemp.append("<tr>");	
	sTemp.append("<td class=td1 align=left colspan=16 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >4.4、银企合作关系</font></td>"); 	
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	sTemp.append("<tr>");
    sTemp.append("<td colspan='4' align=left class=td1 nowrap > 币种：（折）人民币 单位：万元 </td>");
	sTemp.append("</tr>");	
  	sTemp.append("<td width=20% align=left class=td1 > 基本账户行  </td>");
