...
<%
	...
	sTemp.append("  <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=30 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >9.3、主要资产质量</font></td>"); 	
	sTemp.append("  </tr>");	
	//*********************************应收账款分析**********************************
