...
//*****************************************损益表结构和对比*****************************
	...
	" where ObjectNo ='"+sGuarangtorID+"' And ModelNo like '%2' And ReportDate = (select max(Reportdate) from REPORT_RECORD Where ObjectNo ='"+sGuarangtorID+"' And ModelNo like '%2') and ReportScope = GETEVALUATESCOPE('"+sGuarangtorID+"',ReportDate)");
...
<%
	...
	sTemp.append("	<form method='post' action='12021102.jsp' name='reportInfo'>");	
