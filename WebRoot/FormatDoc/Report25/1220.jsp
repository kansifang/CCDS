...
<%
	...
	int j=0; 
	sSql = "select TreeNo from FORMATDOC_DATA where ObjectNo = '"+sObjectNo+"' and TreeNo like '1220__' and ObjectType = '"+sObjectType+"'";
	rs2 = Sqlca.getResultSet(sSql);
	while(rs2.next())
	{
...
<%
	...
	sTemp.append("<form method='post' action='1220.jsp' name='reportInfo'>");	
