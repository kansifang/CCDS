...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >9.1、资产负债表结构与对比</font></td>"); 	
	sTemp.append("   </tr>");
	sTemp.append("<tr>");
