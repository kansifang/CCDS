...
<%
	...
	sTemp.append(" </tr>");
	sTemp.append(" <tr>");	
	sTemp.append(" <td class=td1 align=left colspan=10 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >2.2、在我行的授信业务信息</font></td>"); 	
	sTemp.append(" </tr>");
	sTemp.append(" <tr>");
  	sTemp.append(" <td width=22% align=center class=td1 > 授信业务品种</td>");
    sTemp.append(" <td width=18% align=center class=td1 > 余额（万元） </td>");
	...
	sTemp.append("   <td colspan='5' align=left class=td1 >人民币"+sSum+"&nbsp;</td>");
	sTemp.append("</tr>");
	/*
	sTemp.append(" <tr>");
