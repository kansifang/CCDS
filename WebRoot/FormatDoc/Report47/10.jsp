...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=13 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >6、授信业务前提条件和贷后监控要求</font></td>"); 	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
