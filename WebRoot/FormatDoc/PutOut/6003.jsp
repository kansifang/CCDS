...
<%
	//获得调查报告数据
	String sSql = "select ContractSerialNo,DuebillSerialNo,BP.CustomerID,BP.CustomerName,getBusinessName(BusinessType),BusinessSum,"+ 
...
<%
	...
	if(rs2.next())
	{
		...
		*/
		...
		sTemp.append("   <td align=left class=td1 >手续费金额（元）</td>");
		...
		sTemp.append("   </tr>");
		sTemp.append("   <tr>");
		sTemp.append("   <td align=left class=td1 >委托单位账号</td>");
