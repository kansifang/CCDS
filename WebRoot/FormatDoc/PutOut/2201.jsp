...
<%
	...
	if(rs2.next())
	{
		...
		/*
		sTemp.append("   <tr>");
		sTemp.append("   <td align=left class=td1 >按揭项目编号</td>");
		...
		sTemp.append("   </tr>");
		sTemp.append("   <tr>");
		sTemp.append("   <td align=left class=td1 >发展商账号</td>");
		sTemp.append("   <td align=left class=td1 >"+sFZAccountNo+"&nbsp;</td>");
		sTemp.append("   <td align=left class=td1 >还款方式</td>");
		...
		*/
		...
		sTemp.append("   </tr>");
		/*
		sTemp.append("   <td align=left class=td1 >发展商保证金额(元)</td>");
		...
		*/
		...
		sTemp.append("   </tr>");
		sTemp.append("   <tr>");
		sTemp.append("   <td align=left class=td1 >期限</td>");
		sTemp.append("   <td align=left class=td1 >"+sLoanTerm+"&nbsp;</td>");
		sTemp.append("   <td align=left class=td1 >客户账号</td>");
		...
		sTemp.append("   <td align=left class=td1 >发展商入账净额(元)</td>");
