...
<%
	...
	String sSql = "select ContractSerialNo,BP.CustomerID,BP.CustomerName,getBusinessName(BusinessType) as BusinessTypeName,"+
				  ...
				  " getitemname('Currency',BailCurrency) as BailCurrency,BailRatio,BailAccount,GuarantyNo,getOrgName(OperateOrgID) as OperateOrgName, "+
...
<%
	...
	if(rs2.next())
	{
		...
		if(sGuarantyNo ==null) sGuarantyNo= "";
		//System.out.println("-------------------------------"+sOperateOrgName);
