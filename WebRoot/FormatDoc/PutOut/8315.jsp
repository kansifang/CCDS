...
<%
	...
	if(rs2.next())
	{
		...
		*/
		...
		sTemp.append("   </tr>");
	  sSql = "select InterSerialNo,GatheringName,AccountNo,AboutBankName,BillSum,"+
		...
		while(rs3.next())
		{
			sInterSerialNo = rs3.getString(1);
			if(sInterSerialNo == null) sInterSerialNo = "";
			...
			sTemp.append("   <tr>");
			sTemp.append("   <td align=left class=td1 >承兑汇票组内序号</td>");
			sTemp.append("   <td align=left class=td1 >"+sInterSerialNo+"&nbsp;</td>");
			sTemp.append("   <td align=left class=td1 >&nbsp;</td>");
			sTemp.append("   <td align=left class=td1 >&nbsp;</td>");
			sTemp.append("   </tr>");
			sTemp.append("   <tr>");
			...
			sTemp.append("   <td align=left class=td1 >收款人账号</td>");
