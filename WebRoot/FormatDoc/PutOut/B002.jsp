...
<%
	...
	String sSql = "select ContractSerialNo,DuebillSerialNo,BP.CustomerID,BP.CustomerName,getBusinessName(BusinessType),"+
				  ...
				  " CI.MFCustomerID,getItemName('CertType',CI.CertType) as CertTypeName,CI.CertID,BP.BaseRate "+
...
<%
	...
	if(rs2.next())
	{
		...
		sBaseRate = rs2.getString("BaseRate");
		...
		sTemp.append("   <td align=left class=td1 >授信金额(元)</td>");
		...
		sTemp.append("   <td align=left class=td1 >&nbsp;</td>");
		sTemp.append("   <td align=left class=td1 >基准年利率(%)</td>");
		sTemp.append("   <td align=left class=td1 >"+sBaseRate+"&nbsp;</td>");
		sTemp.append("   </tr>");
		sTemp.append("   <tr>");
		...
		sTemp.append("   </tr>");
		sTemp.append("   <tr>");
		sTemp.append("   <td align=left class=td1 >交易方名称</td>");
		sTemp.append("   <td colspan=3 align=left class=td1 >&nbsp;</td>");
		sTemp.append("   </tr>");
		sTemp.append("   <tr>");
		sTemp.append("   <td align=left class=td1 >交易方结算帐号</td>");
		sTemp.append("   <td colspan=3 align=left class=td1 >&nbsp;</td>");
		sTemp.append("   </tr>");
		sTemp.append("   <tr>");
		...
		sTemp.append("   </tr>");
		sTemp.append("   <tr>");
		sTemp.append("   <td align=left class=td1 >担保方式及详情</td>");
