...
<%
	...
	sSql =  "select FO.ObjectType,FO.ObjectNo,FT.SerialNo as FSerialNo,BP.SerialNo,BP.ArtificialNo,BP.CustomerName,BP.BusinessType,getBusinessName(BP.BusinessType) as BusinessTypeName, "+
            ...
            " and FT.PhaseNo = '3000' and  FT.UserID='"+CurUser.UserID+"' and FO.UserID != '"+CurUser.UserID+"'"+
...
%>
    ...
    function Finished()
    {
        sFSerialNo = getItemValue(0,getRow(),"FSerialNo");
        ...
        {
            OpenComp("FinishPutOutAction","/DeskTop/FinishPutOutAction.jsp","SerialNo="+sFSerialNo,"_blank","");
            reloadSelf();
        }
    }
