...
<head >
<title></title>
<script language=javascript src="Resources/1/htmlcontrol.js"></script>
...
function selectOrg()
{
	sReturn = selectObjectInfo("Org","OrgID=<%=CurOrg.OrgID%>","dialogWidth=20;dialogHeight=30;center:yes;status:no;statusbar:no");
...
<table border="0" width="99%" cellspacing="0" cellpadding="0">
  <tr>
   ...
   <tr>
   <td align='left' valign='top'  id="chart01" status="1" style="cursor:hand;display:yes" onclick="javascript:ChangeSize('chart01');" >
    ...
    <td align='middle' valign='top'  id="chart02" status="1" style="cursor:hand;display:yes" onclick="javascript:ChangeSize('chart02');" >
    ...
    <td align='right' valign='top'  id="chart03" status="1" style="cursor:hand;display:yes" onclick="javascript:ChangeSize('chart03');" >
   ...
   <tr>
    <td align='left'  valign='top'  id="chart04" status="1" style="cursor:hand;display:yes" onclick="javascript:ChangeSize('chart04');" >
    ...
    <td align='middle'  valign='top'  id="chart05" status="1" style="cursor:hand;display:yes" onclick="javascript:ChangeSize('chart05');" >
    ...
    <td align='right'   valign='top'  id="chart06" status="1" style="cursor:hand;display:yes" onclick="javascript:ChangeSize('chart06');" >
