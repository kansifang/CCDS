...
%>
   <script language="JavaScript">
	...
	if(sCodeNo.startsWith("/")){
		out.println("parent.newTab('"+sComponentName+"','"+sCodeNo+"');");
	}
%>
	parent.document.getElementById("left_id").src="<%=sWebRootPath%>/DeskTop/Components/Marquee.jsp?TextToShow=正在打开页面，请稍候&CompClientID=<%=CurComp.ClientID%>";
	parent.document.getElementById("myleft").style.display="none";
//setTitle("案件查询");
	</script>
<%
	/*~END~*/
