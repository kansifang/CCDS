...
function hc_drawButton(buttonID, buttonText, onclickScript, displayType){
		var result="";
		result = result+"<span id='"+buttonID+"' onclick=\""+onclickScript+"\">"+"\r";
		result = result+"<table id='"+buttonID+"_button_frame' cellspacing=0 cellpadding=0 border=0><tr>"+"\r";
		result = result+"<td id='"+buttonID+"_button_left' class='"+displayType+"buttonleft' width='8'><img src='"+sHCResourcesPath+"/button"+displayType+"_left.gif' width='8' height='16'  border='0'></td>"+"\r";
 		result = result+"<td id='"+buttonID+"_button_middle' class='"+displayType+"button' valign='bottom' align='center'><span id='"+buttonID+"_button_text' class='"+displayType+"buttontext' style='cursor:hand;'>"+buttonText+"</span></td>"+"\r";
 		result = result+"<td id='"+buttonID+"_button_right' class='"+displayType+"buttonright' width='8'><img src='"+sHCResourcesPath+"/button"+displayType+"_right.gif' width='8' height='16'  border='0'></td>"+"\r";
 		result = result+"</tr></table></span>"+"\r";
		
		document.write(result);
		
}

/*added by huboyu* 2003/02/13 */
function hc_drawButtonWithTip(sText,sTips,sScript,ssHCResourcesPath){
		var result="";
		result = result+"<span id='button"+iCurButtonID+"' title='"+sTips+"' onclick=\""+sScript+"\" ";
 		result = result+" onMouseOver=\"overButton("+iCurButtonID+");\" ";
 		result = result+" onMouseOut=\"outButton("+iCurButtonID+");\" ";
 		result = result+" onMouseDown=\"downButton("+iCurButtonID+");\" ";
 		result = result+" onMouseUp=\"upButton("+iCurButtonID+");\" ";
		result = result+">"+"\r";
		result = result+"<table id='buttontable"+iCurButtonID+"' cellspacing=0 cellpadding=0 border=0><tr>"+"\r";
		result = result+"<td id='buttonlefttd"+iCurButtonID+"' class='buttonleft'><img  class='buttonleftimg'  id='buttonimageleft"+iCurButtonID+"' src='"+ssHCResourcesPath+"/1x1.gif' width='1' height='1' boder='0'></td>"+"\r";
 		result = result+"<td id='buttonmiddletd"+iCurButtonID+"' class='button' nowrap ";
 		result = result+" >";
 		result = result+ sText + "</td>"+"\r";
 		result = result+"<td id='buttonrighttd"+iCurButtonID+"' class='buttonright'><img  class='buttonrightimg' id='buttonimageright"+iCurButtonID+"' src='"+ssHCResourcesPath+"/1x1.gif' width='1' height='1' boder='0'></td>"+"\r";
 		result = result+"</tr></table></span>"+"\r";
...
function drawImgButton(sClassName,sTips,sScript,ssHCResourcesPath){
		var result="";
		result = result+" <img src=\""+ssHCResourcesPath+"/1x1.gif\" class=\""+sClassName+"\" id='button"+iCurButtonID+"' title='"+sTips+"' alt='"+sTips+"' onclick=\""+sScript+"\" ";
 		result = result+" onMouseOver=\"overImgButton(this,'"+sClassName+"');\" ";
 		result = result+" onMouseOut=\"outImgButton(this,'"+sClassName+"');\" ";
 		result = result+" onMouseDown=\"javascript:this.className='"+sClassName+"_down'\" ";
 		result = result+" onMouseUp=\"javascript:this.className='"+sClassName+"_hover'\" ";
		result = result+"/> ";
		document.write(result);
		iCurButtonID++;
}
...
function overButton(iButtonID){
    ...
    setTimeout(function overButtonIn(){
		document.all('buttonmiddletd'+iButtonID).className='buttonHover';
		document.all('buttonimageleft'+iButtonID).className='buttonleftimgHover';
		document.all('buttonimageright'+iButtonID).className='buttonrightimgHover';
	}, 1); 
}
...
function outButton(iButtonID){
    ...
    setTimeout(function outButtonIn(){
		document.all('buttonmiddletd'+iButtonID).className='button';
		document.all('buttonimageleft'+iButtonID).className='buttonleftimg';
		document.all('buttonimageright'+iButtonID).className='buttonrightimg';
	}, 1); 
}
...
function downButton(iButtonID){
	document.all('buttonmiddletd'+iButtonID).className='buttonDown';
	document.all('buttonimageleft'+iButtonID).className='buttonleftimgDown';
	document.all('buttonimageright'+iButtonID).className='buttonrightimgDown';
...
//		/*
		sObject.document.write("<style>\r");
				...
				sObject.document.write(".tabtext{cursor:hand;}\r");
