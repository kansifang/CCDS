...
var sHighlightColor="background-color:#b4cbff;color:#000000;)"; 	//加亮颜色
...
var hmRPHeaderTd       = " nowrap align=middle style='background-color:#B4B4B4;cursor:pointer;font-family:宋体;font-size: 10pt; text-decoration: none' ";
var hmRPHeaderTdSerial = " nowrap align=middle style='background-color:#B4B4B4;cursor:pointer;font-family:宋体;font-size: 10pt; text-decoration: none' ";
...
function drawInputControl(myarrangement,myharbors,defaultColspan,defaultColspanForLongType,myobjname,myact,iDW,iCol,iRow_now){
	...
	//当前字段如果checkFormat为3 并且非只读 产生日期框
	myCale = " ";
	if(DZ[myi][1][i][3]==0 ){
		if(DZ[myi][1][i][12]==3 ){//日期
...
//增加trimField方法  add by yxzhang 2009/03/15
