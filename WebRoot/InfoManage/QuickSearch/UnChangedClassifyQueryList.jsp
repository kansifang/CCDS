...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List00;Describe=注释区;]~*/%>
	<%
	/*
		Author:   WangDW 2012-3-19
		Tester:
		Content: 未调整分类信息快速查询
		Input Param:
					下列参数作为组件参数输入
					ComponentName	组件名称：未调整分类信息快速查询
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "未调整分类信息快速查询"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	if("1".equalsIgnoreCase(sCustomerType)){						
		sSql = " select CR.ObjectType,Cr.ObjectNo,CR.SerialNo,BC.CustomerID,BC.CustomerName, " +
					...
					" and CR.ClassifyLevel=CR.FINALLYRESULT "+
	...
	*/
	...
	//设置不可见项
	doTemp.setVisible("FinallyResult,FinallyBaseResult,ClassifyResultName,BaseClassifyResultName,ClassifyResult,BaseClassifyResult,ObjectType,SerialNo,CustomerID,BusinessType,FinallyResult,VouchType,OperateOrgID,OperateUserID,FinancePlatformFlag",false);
