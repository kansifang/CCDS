...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "个人类客户授信台账"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	//小数为2，整数为5
	doTemp.setCheckFormat("BusinessRate,NormalBalance,OverDueBalance,DullBalance,BadBalance,InterestBalance1,InterestBalance2","2");
	...
	doTemp.setFilter(Sqlca,"7","AgriLoanClassifyName","");
	doTemp.setFilter(Sqlca,"8","BusinessSum","");
	doTemp.setFilter(Sqlca,"9","Balance","");
	doTemp.setFilter(Sqlca,"10","PutOutdate","");
	doTemp.setFilter(Sqlca,"11","Maturity","");
	doTemp.setFilter(Sqlca,"12","ClassifyResult","");
	doTemp.setFilter(Sqlca,"13","BaseClassifyResult","");
	doTemp.setFilter(Sqlca,"14","VouchType","");
	doTemp.setFilter(Sqlca,"15","ManageUserName","");
	doTemp.setFilter(Sqlca,"16","ManageOrgName","");
	doTemp.setFilter(Sqlca,"17","MFOrgName","");
	doTemp.setFilter(Sqlca,"18","OperateOrgName","");
