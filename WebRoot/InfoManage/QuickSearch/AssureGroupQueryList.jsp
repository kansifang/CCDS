...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "联保小组快速查询"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%
	...
	String sHeaders[][] = { 							
									{"CustomerID","联保小组编号"},
									{"EnterpriseName","联保小组名称"},
									{"VillageName","所在区域"},
									{"EmployeeNumber","联保小组成员数"},
									{"SetupDate","联保小组协议签订时间"},
									{"BailRatio","联保小组保证金比例(%)"},
									{"InputOrgName","登记机构"},
									{"InputUserName","登记人"},
									{"InputDate","登记日期"},
		...
		sSql =	" select CustomerID,EnterpriseName,VillageName,EmployeeNumber,SetupDate,BailRatio,"+
...
<%	
	...
	//设置字段类型
    doTemp.setType("BailRatio","Number");
