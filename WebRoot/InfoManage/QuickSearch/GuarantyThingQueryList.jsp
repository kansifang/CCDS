...
<%
	...
	String sHeaders[][] =	{ 							
						...
						{"OwnerType","权属人类型"},
						{"EvalCurrencyName","抵质押物评估币种"},
						{"EvalNetValue","抵质押物评估价值"},
						{"GuarantyCurrencyName","抵质押物认定币种"},
						{"ConfirmValue","抵质押物认定价值"},
						{"InputOrgID","登记机构"},
						{"InputOrgIDName","登记机构"},
						{"GuarantyRightID","权证号"}
					}; 
	...
	" and gi.guarantyid=gr.guarantyid and gr.objectno=bc.serialno ";
	...
	doTemp.setType("EvalNetValue,ConfirmValue,businesssum,balance","Number");
	//小数为2，整数为5
