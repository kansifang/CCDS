...
//										{"SINo","社会保险号"},
										...
										{"StaffName","是否本行员工"},
										{"BizHouseFlag","是否商户"},
										{"BizHouseFlagName","是否商户"},
										{"GovServiceFlag","是否公职人员"},
										{"GovServiceFlagName","是否公职人员"},
										{"NationalityName","民族"},
										{"NativePlace","户籍地址"},
										{"IndRPRType","户籍类型"},                                        //new
										{"IndRPRTypeName","户籍类型"},                                       //new
										{"HousemasterFlagName","是否户主"},                                       //new
										{"PoliticalFaceName","政治面貌"},
										{"MarriageName","婚姻状况"},         
										{"HealthStatusName","健康状况"},                             //new
										{"IncomeSourceName","主要收入来源"},                            //newPopulationNum
										{"PopulationNum","家庭人口数"},                          //new
										{"IndRate","月还款与收入比(%)"},                          //new
										{"FamilyAdd","居住地址"},
										{"FamilyZIP","居住地址邮编"},
										{"FamilyTel","住宅电话"},
