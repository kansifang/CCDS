...
%>
	<%
		String PG_TITLE = "公司合同信息快速查询"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%
	/*~END~*/
%>
...
<%
	...
	String sHeaders[][] = { 							
					...
					{"OldBIndustryType","行业投向(老国标)"},
					{"OldBIndustryTypeName","行业投向(老国标)"},
					{"Direction","行业投向"},
					{"DirectionName","行业投向"},
					{"PayType","支付方式"},	
					{"isJGT","是否晋钢通业务"},										
...
%>
	<%
		...
		String sButtons[][] = {
			...
			{"true","","Button","承兑信息","承兑信息","viewaccept()",sResourcesPath}
		};
	%> 
<%
 	/*~END~*/
