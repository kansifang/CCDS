...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Main03;Describe=定义树图;]~*/%>
	...
	String sSqlTreeView = "from CODE_LIBRARY where CodeNo= 'QuickQueryList' and IsInUse = '1' and ("+ sCondition +")";
...
<script language=javascript> 
	...
	function TreeViewOnClick()
	{
		...
		{
			if(sCurItemDescribe2 == "APDQueryList"){
				OpenComp(sCurItemDescribe2,sCurItemDescribe1,"ComponentName="+sCurItemName+"&DealType="+sCurItemDescribe3,"right");
			}
			else{
				OpenComp(sCurItemDescribe2,sCurItemDescribe1,"ComponentName="+sCurItemName+"&CustomerType="+sCurItemDescribe3,"right");
