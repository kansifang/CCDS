...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "选择查询结果要显示的数据项"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>


<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List02;Describe=定义变量，获取参数并且产生数据;]~*/%>
...
<%
   //定义变量
	...
	//System.out.print(disableString);
...
function doDefault()
{
	...
	var j=0;
	for (var i = 0; i < availableNameList.length; i++)
	{
