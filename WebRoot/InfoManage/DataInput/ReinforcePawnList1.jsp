...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
		...
		sPawnType = sReturn[0];	
		OpenPage("/InfoManage/DataInput/ReinforcePawnInfo1.jsp?ObjectType=<%=sObjectType%>&ObjectNo=<%=sObjectNo%>&ContractNo=<%=sContractNo%>&PawnType="+sPawnType,"_self");
	}
	...
	function viewAndEdit()
	{
		...
		{
			OpenPage("/InfoManage/DataInput/ReinforcePawnInfo1.jsp?ObjectType=<%=sObjectType%>&ObjectNo=<%=sObjectNo%>&ContractNo=<%=sContractNo%>&GuarantyID="+sGuarantyID+"&PawnType="+sPawnType,"_self");
		}
	}
