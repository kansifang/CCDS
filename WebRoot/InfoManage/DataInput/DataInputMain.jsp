...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View03;Describe=定义树图;]~*/%>
	...
	//定义树图结构
	String sSqlTreeView = "";
	if(CurUser.hasRole("002") || CurUser.hasRole("025") || CurUser.hasRole("048") || CurUser.hasRole("076") || CurUser.hasRole("000"))
	{
		sSqlTreeView = "from CODE_LIBRARY where CodeNo= 'DataInputMain' and IsInUse='1' ";
	}else
	{
		sSqlTreeView = "from CODE_LIBRARY where CodeNo= 'DataInputMain' and (itemno like '01%' or itemno like '02%') and IsInUse='1' ";
	}
