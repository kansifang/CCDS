...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "投资－企业债权投资列表"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%
	...
	{
		sClauseWhere = " and ManageOrgID in (select BelongOrgId from ORG_BELONG where OrgId='"+CurOrg.OrgID+"')"; //本机构辖下 Modi by wuxiong 20050709 
	}
