...
<%
	...
	sSql =  " select GC.SerialNo,GC.CustomerID,GC.GuarantyType, "+
			...
			" and AR.ObjectNo = GC.SerialNo)  and ContractStatus = '020' ";
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
		...
		{
			OpenPage("/InfoManage/DataInput/ReinforceAssureInfo1.jsp?GuarantyType="+sGuarantyType,"right");
		}
	}
	...
	function viewAndEdit()
	{
		...
		}else 
		{
			...
			OpenPage("/InfoManage/DataInput/ReinforceAssureInfo1.jsp?SerialNo="+sSerialNo+"&GuarantyType="+sGuarantyType,"right");
		}
	}
		...
		}else
		{
			...
			}else 
			{
				if (sGuarantyType.substring(0,3) == "050") //抵押
					OpenPage("/InfoManage/DataInput/ReinforcePawnList1.jsp?ObjectType=<%=sObjectType%>&ObjectNo=<%=sObjectNo%>&ContractNo="+sSerialNo,"DetailFrame","");
				else //质押
					OpenPage("/InfoManage/DataInput/ReinforceImpawnList1.jsp?ObjectType=<%=sObjectType%>&ObjectNo=<%=sObjectNo%>&ContractNo="+sSerialNo,"DetailFrame","");
			}
		}
	}
