              ...
              <tr>
               <td width=200 height=205>
                ...
                <td width=200 >
                  <table border='1' cellspacing='0' cellpadding='0' width='100%' height="100%">
                    <tr>
                      <td align="center" nowrap bgcolor= #dcdcdc bordercolorlight='#99999' bordercolordark='#FFFFFF' height="18">总公司通知</td>
					</tr>
		            <tr>
	...
	var tabstrip = new Array();
  	<%String sSql = "",sSqlTab = "";
		...
		if(CurUser.UserID.equals("9999999")||CurUser.hasRole("062")||CurUser.hasRole("262")||CurUser.hasRole("462")){
			sSqlTab += " order by SortNo ";
		}else{
			sSqlTab += " and ItemNo <> '050'  Order by SortNo ";
		}				
