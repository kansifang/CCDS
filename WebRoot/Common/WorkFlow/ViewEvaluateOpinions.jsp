...
<%
	...
	sSql = 	" select FO.CustomerName, "+//客户名称
			...
			" FO.PhaseOpinion,FO.SystemResult,FO.CognResult,FO.SystemScore, "+//认定意见，系统评定得分，系统评定结果，人工结果
  ...
  <table width="100%" cellpadding="3" cellspacing="0" border="0" >
	...
	<td>
	  <table width=90%  cellpadding="4" cellspacing="0" border="1" bordercolorlight="#666666" bordercolordark="#FFFFFF" >
        ...
        <tr>   
        	<td width=50%><b>系统评定结果:</b><%=DataConvert.toMoney(rs.getString("SystemResult"))%></td>         
            <td width=50%><b>人工认定结果:</b><%=DataConvert.toString(rs.getString("CognResult"))%></td>
        </tr>
        <tr>
