...
<%
	...
	{
		sSql =  " select FO.PhaseOpinion,getItemName('PhaseChoice',FO.PhaseChoice) as PhaseChoice,FT.PhaseName,FT.UserName, "+
	...
	<td>
	  <table width=90%  cellpadding="4" cellspacing="0" border="1" bordercolorlight="#666666" bordercolordark="#FFFFFF" >
        ...
        <% if("客户经理调查".equals(rs.getString("PhaseName"))||
            	 ...
            	 <td width=50%><b>申请意见:</b><%=DataConvert.toString(rs.getString("PhaseChoice"))%>
        <%}else{%>
