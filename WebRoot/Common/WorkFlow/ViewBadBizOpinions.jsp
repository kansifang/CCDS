...
<%
	...
	{
		sSql =  " select getItemName('PhaseChoice1',FO.PhaseChoice) as FOPhaseChoice,"+
				" FO.PhaseOpinion,FT.PhaseName,FT.UserName,FT.OrgName,FT.BeginTime,FT.EndTime "+
	...
	<td>
	  ...
	  <tr>
        ...
        <tr>            
            ...
            <td width=50%><b>审查意见:</b><%=DataConvert.toString(rs.getString("FOPhaseChoice"))%></td>
        </tr>
