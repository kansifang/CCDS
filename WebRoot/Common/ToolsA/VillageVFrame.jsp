...
<%
	String sVillage = DataConvert.toRealString(iPostChange,(String)CurComp.getParameter("Village"));
%>
<%/*~END~*/%>
...
<script language=javascript>
	myleft.width=340;
	OpenPage("/Common/ToolsA/VillageSelect.jsp?Village=<%=sVillage%>","frameleft","");
