...
<%
	...
	String sObjectLevel =  DataConvert.toRealString(iPostChange,(String)CurComp.getParameter("ObjectLevel"));
	if(sObjectType==null) sObjectType="";
	if(sObjectLevel==null) sObjectLevel="";
%>
<%
	/*~END~*/
%>
...
<%
	...
	"UpdateUser,"+
	"UpdateTime "+
	"from OBJECT_LEVEL Where ObjectType='"+sObjectType+"' And ObjectLevel = '"+sObjectLevel+"' order by ObjectType,ObjectLevel";
...
%>
	...
	function newRecord()
	{
        	...
        	OpenComp("ObjTypeLevelInfo","/Common/Configurator/ObjectManage/ObjTypeLevelInfo.jsp","ObjectType="+sObjectType,"_self","");
	}
	</script>
<%
	/*~END~*/
