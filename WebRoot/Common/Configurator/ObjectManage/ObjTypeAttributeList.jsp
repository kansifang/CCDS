...
<%
	...
	sSql = "select "+
		   ...
		   "AttributeName,"+
		   "AttributeDescribe "+
		  "from OBJECT_ATTRIBUTE Where ObjectType='"+sObjectType+"' order by ObjectType,AttributeID";
...
%>
	...
	function viewAndEdit()
	{
        ...
        sAttributeID = getItemValue(0,getRow(),"AttributeID");
