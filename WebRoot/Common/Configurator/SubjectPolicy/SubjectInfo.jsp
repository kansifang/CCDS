...
<%	
	...
	sSql =  " select SubjectNo, SubjectName, Attribute2, Attribute3, Attribute1,"+
			" Attribute4, Attribute5, Attribute6,Attribute7, Attribute8, Attribute9, Attribute10"+
		 	" from SUBJECT_INFO "+
		  	" where SubjectNo = '"+sSubjectNo+"'";	    
	...
	//设置主键
	doTemp.setKey("SubjectNo",true);
    //设置必须项
 	doTemp.setRequired("SubjectNo,SubjectName",true);
 	//如果科目编号不为空，则不允许修改
 	if(!sSubjectNo.equals(""))
 		doTemp.setReadOnly("SubjectNo,SubjectName",true);
 	//设置下拉datawindows
	doTemp.setDDDWCode("Attribute3","IsInUse");	
