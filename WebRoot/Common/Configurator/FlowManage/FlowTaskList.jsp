...
%>
	<%
		...
		String sButtons[][] = {
			{CurUser.hasRole("000")?"true":"false","","Button","当前阶段信息","详情","viewAndEdit1()",sResourcesPath},
			{"true","","Button","业务详情","业务详情","viewAndEdit2()",sResourcesPath},
			{CurUser.hasRole("000")?"true":"false","","Button","删除","删除","deleteRecord()",sResourcesPath},
...
%>
	...
	function viewAndEdit()
	{
		...
		{
			popComp("FlowTaskInfo","/Common/Configurator/FlowManage/FlowTaskInfo.jsp","TaskNo="+sTaskNo);
		}
		reloadSelf();	
	}
	...
	function viewAndEdit1()
	{
		...
		{
			popComp("FlowObjectInfo","/Common/Configurator/FlowManage/FlowObjectInfo.jsp","ObjectType="+sObjectType+"&ObjectNo="+sObjectNo);
		}
		reloadSelf();
	}
