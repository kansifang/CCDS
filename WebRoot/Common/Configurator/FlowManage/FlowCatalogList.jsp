...
<%
	/*~获取参数~*/
	String sFlowType = DataConvert.toString(DataConvert.toRealString(iPostChange,(String)CurPage.getParameter("FlowType")));
	String sFlowNos = Sqlca.getString("select RelativeCode from Code_Library where CodeNo='FlowCatalogMain' and ItemNo='"+sFlowType+"' and IsInUse='1'");
%>
<%
...
<%
	...
	" from FLOW_CATALOG "+
	" where locate(FlowNo,'"+sFlowNos+"')>0";
...
%>
	...
	function viewInfo()
	{
        ...
        popComp("FlowTaskList","/Common/Configurator/FlowManage/FlowTaskList.jsp","FlowNo="+sFlowNo,"");
	}
