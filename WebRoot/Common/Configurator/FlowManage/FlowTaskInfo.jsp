...
<%
	...
	sSql = " select ObjectType,SerialNo,ObjectNo,RelativeSerialNo,"+
	  " FlowNo,FlowName,PhaseNo,PhaseName,PhaseType,"+
              " UserID,getUserName(UserID) as UserName,OrgID,getOrgName(OrgID) as OrgName,"+
              " BeginTime,EndTime,PhaseOpinion1,PhaseAction"+
              " from Flow_Task " +
              " where SerialNo = '"+sTaskNo+"'";
    //用sSql生成数据窗体对象
	...
	doTemp.setReadOnly("UserName,OrgName,BeginTime", true);
