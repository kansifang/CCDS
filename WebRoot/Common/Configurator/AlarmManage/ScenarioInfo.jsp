...
%>
	<%
		String PG_TITLE = "预警场景信息详情@PageTitle"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%
	/*~END~*/
%>
...
%>
	<%
		...
		String sButtons[][] = {
			...
			{"false","","Button","保存并返回","保存修改并返回","saveRecordAndBack()",sResourcesPath},
...
%>
    ...
    var sCurScenarioID=""; //记录当前所选择行的代码号
