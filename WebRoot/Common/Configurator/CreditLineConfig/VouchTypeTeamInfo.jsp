...
<%
	String sHeaders[][]={ 
				{"CLTeamID","担保方式分组编号"},
			    {"CLTeamName","担保方式分组名称"},
			    {"CLTeamContentName","担保方式分组内容"},
			    {"CLTeamLimit","担保方式分组限制条件"},
			    {"CLTeamRelaObj","担保方式分组关联对象"},
			    {"IsInUse","是否有效"},
			    {"InputUserName","登记人"},
			    {"InputOrgName","登记机构"},
			    {"InputTime","登记时间"},
	...
	//设置弹出式选择窗口
	doTemp.setUnit("CLTeamContentName","<input type=button class=inputDate   value=\"...\" name=button1 onClick=\"javascript:parent.selectVouchType();\"> ");
