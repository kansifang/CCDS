...
for(int ot=0;ot<sObjectTypes.length;ot++){
	...
	sSql = "select CatalogSql,CatalogWhere1,CatalogWhere2,CatalogWhere3 from OBJECTTYPE_CATALOG where ObjectType = '"+sObjectTypes[ot]+"'";
	...
	{%>alert("语法错误:<%=sCatalogSql%>");<%continue;
	}
