...
%>
	<script language="JavaScript">
		...
		function showServerFiles()
		{
			...
			sReturn = PopPage("/Common/Configurator/ObjectExim/popGetFileList.jsp?FilePath="+filePath,"","dialogWidth=0;dialogHeight=0;status:no;center:yes;help:no;minimize:yes;maximize:no;border:thin;statusbar:no");
			if( typeof(sReturn)== 'undefined' || sReturn.length == 0 || sReturn == "failed" )
			{
				alert("获取"+filePath+"目录下文件出错！");
				return;
			}
			var defaultFileList = sReturn.split("$");
