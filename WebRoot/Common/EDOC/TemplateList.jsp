...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function BCSample()
	{
		sManageUserID = " <%=CurUser.UserID%>" ;
		sParaString = "ManageUserID," +sManageUserID;
		sReturn = setObjectValue("SelectEDocContract",sParaString,"",0,0,"");
	...
	{
		sParaString = "";
		sReturn = setObjectValue("SelectGuarantyContract",sParaString,"",0,0,"");
		var sReturn = sReturn.split("@");
		sObjectNo = sReturn[0];
		//担保合同是和放贷合同
		sObjectType = "GuarantyContract";
		sEDocNo = "G001";
		if (typeof(sObjectNo)=="undefined" || sObjectNo.length==0)
		{
			alert(getHtmlMessage('1'));//请选择一条信息！
