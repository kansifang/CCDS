...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function changeRecord()
	{
		...
		}else 
		{
			...
			if(sEDocNo == "C1001")
			{
				var sBussinessType = '32010';
			}else if(sEDocNo == "C1002"||sEDocNo == "C1003"||sEDocNo == "C1007"||sEDocNo == "C1005")
			{
				 sBussinessType = '12';
			}else if(sEDocNo == "C2001")
			{
				 sBussinessType = '11020';
			}else if(sEDocNo == "C2002")
			{
				 sBussinessType = '11010';
			}else if(sEDocNo == "P1004"||sEDocNo == "P1005")
			{
				 sBussinessType = '11040';
			}else if(sEDocNo == "P1002")
			{
				 sBussinessType = '21030';
			}else if(sEDocNo == "P1006")
			{
				 sBussinessType = '11070';
			}else if(sEDocNo == "P1001")
			{
				 sBussinessType = '21010';
			}else if(sEDocNo == "P1007")
			{
				 sBussinessType = '21020010';
			}else if(sEDocNo == "P1008")
			{
				 sBussinessType = '11050020';
			}else if(sEDocNo == "P1009")
			{
				 sBussinessType = '11050010';
			}else if(sEDocNo == "P1012")
			{
				 sBussinessType = '21060010';
			}
			sReturnValue = PopPage("/Common/EDOC/EDocTerm.jsp?EDocNo="+sEDocNo+"&EDocType="+sEDocType+"&BussinessType="+sBussinessType,"","width=160,height=20,left=20,top=20,status=yes,center=yes");
