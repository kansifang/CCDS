	...
	<script language=javascript>
		...
		function commitAction()
		{
			...
			{					
				...
				{
					sReturnValue = PopPage("/Common/BusinessFlow/SubmitAction.jsp?SerialNo=<%=sSerialNo%>&PhaseOpinion1="+thisPhaseOpinion1+"&PhaseAction="+thisPhaseAction+"&rand="+randomNumber(),"","");
