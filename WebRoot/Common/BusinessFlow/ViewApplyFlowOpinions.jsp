...
<body leftmargin="0" topmargin="0" class="pagebackground">
  <table width="100%" cellpadding="3" cellspacing="0" border="0" >
	...
	<td>
	  <table width=90%  cellpadding="4" cellspacing="0" border="1" bordercolorlight="#666666" bordercolordark="#FFFFFF" >
        ...
        <tr>            
            ...
            <td width=50%><b>执行年利率(%):</b><%=rs.getDouble("BusinessRate")%></td>
        </tr>
        <tr>            
        ...
        %>
        <tr>            
			<td width=50%><b>承诺费金额(元):</b><%=DataConvert.toMoney(rs.getDouble("PromisesFeeSum"))%></td>
            <td width=50%><b>承诺费率(%):</b><%=rs.getDouble("PromisesFeeRatio")%></td>
        </tr>
        <%
        	}
        %>
        ...
        <tr>
            <td width=50%><b>收到时间:</b><%=DataConvert.toString(rs.getString("BeginTime"))%></td>
	...
	<td>
	  <table width=90%  cellpadding="4" cellspacing="0" border="1" bordercolorlight="#666666" bordercolordark="#FFFFFF" >
        <tr>            
			<td width=50%><b>阶段名称:</b><%=DataConvert.toString(sPhaseName)%></td>
            <td width=50%><b>处理人:</b><%=DataConvert.toString(sUserName)%></td>
        </tr>
        <tr>            
			<td width=50%><b>处理人所属机构:</b><%=DataConvert.toString(sOrgName)%></td>
            <td width=50%><b>客户名称:</b><%=DataConvert.toString(sCustomerName)%></td>
        </tr>
        <tr>            
			<td width=50%><b>业务币种:</b><%=DataConvert.toString(sBusinessCurrencyName)%></td>
            <td width=50%><b>申请金额(元):</b><%=dBusinessSum%></td>
        </tr>
        <tr>            
			<td width=50%><b>期限(月):</b><%=iTermMonth%></td>
            <td width=50%><b>零(天):</b><%=iTermDay%></td>
        </tr>
        <tr>            
			<td width=50%><b>基准年利率(%):</b><%=dBaseRate%></td>
            <td width=50%><b>利率浮动方式:</b><%=DataConvert.toString(sRateFloatTypeName)%></td>
        </tr>
        <tr>            
			<td width=50%><b>利率浮动值:</b><%=dRateFloat%></td>
            <td width=50%><b>执行年(月)利率(‰):</b><%=dBusinessRate%></td>
        </tr>
        <tr>            
			<td width=50%><b>保证金金额(元):</b><%=dBailSum%></td>
            <td width=50%><b>保证金比例(%):</b><%=dBailRatio%></td>
        </tr>
        <tr>            
			<td width=50%><b>手续费金额(元):</b><%=dPdgSum%></td>
            <td width=50%><b>手续费率(‰):</b><%=dPdgRatio%></td>
        </tr>
        <tr>
