...
<%
	String sHeaders[][] = {
 	...
 	String sSql = "select LogID,UserID,UserName,ChangeUserID,ChangeUserName,BeginTime,Remark,RunSql from LOG_AUDITINFO where AuditType='020' ";
	...
	//生成查询框
	doTemp.setColumnAttribute("UserID,UserName,ChangeUserID,ChangeUserName,BeginTime","IsFilter","1");
