...
<script language=javascript>
	...
	function newBusiness(){
		...
		if(buff.CompID.value!=""){
			sReturnValue = PopPage("/Common/help/InsertCompValue.jsp?CompID="+sCompID+"&ObjectType=ComponentDefinition&CommentItemID=<%=sCommentItemID%>&rand="+randomNumber(),"","dialogWidth=20;dialogHeight=25;center:yes;status:no;statusbar:no");
