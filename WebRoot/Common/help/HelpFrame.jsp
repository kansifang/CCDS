...
<frameset rows="*" cols="190,*" framespacing="0" frameborder="yes" border="1" >
  <frameset rows="47,30,*" cols="*" frameborder="no" border="1">
    <frame src="HelpSearch.jsp?CompClientID=<%=CurComp.ClientID%>" name="topFrame" scrolling="no" >
    <frame src="HelpFunctions.jsp?CompClientID=<%=CurComp.ClientID%>" name="functionFrame" scrolling="no">
    <frame src="HelpIndex.jsp?CompClientID=<%=CurComp.ClientID%>&CommentItemID=<%=sCommentItemID%>" name="leftFrame" scrolling="no">
  </frameset>
