...
public class AddRelation extends Bizlet {
	...
	public Object run(Transaction Sqlca) throws Exception{
		...
		sSql =  " insert into CUSTOMER_RELATIVE(CustomerID,RelativeID,RelationShip,CustomerName,"+
				...
				" InvestDate,StockcertNo,Duty,Telephone,Effect,Whethen5,Whethen6,Whethen7,Whethen8,"+
				" Whethen9,Whethen10,Describe,InputOrgID,InputUserID,InputDate,UpdateDate,Remark) "+
				...
				" InvestDate,StockcertNo,Duty,Telephone,Effect,Whethen5,Whethen6,"+
				" Whethen7,Whethen8,Whethen9,Whethen10,Describe,InputOrgID,InputUserID,"+
		...
		Sqlca.executeSQL(sSql);
		//建立集团成员关系
		Sqlca.executeSQL("update ENT_INFO set ECGroupFlag = '1' where CustomerID = '"+sRelativeID+"'");
