 ...
 *
 */
public class SendMF extends Bizlet {
	...
	public Object run(Transaction Sqlca) throws Exception{
		...
		if(sTradeType.equals("Trade001")){
			String sValue[];
			//核心客户号检查
			sReturn=MFTrade.runMFTrade(sObjectNo, sObjectType, "798001",Sqlca,sFilePath,"");
			sValue = sReturn.split("@");
			if(!sValue[0].equals("0000000")) return sReturn;
			
		}
		else{
			sReturn=MFTrade.runMFTrade(sObjectNo, sObjectType, sTradeType,Sqlca,sFilePath,"");
		}
