...
<%
	...
	System.out.println("LoanAccount:"+sLoanAccount+"--AccountMonth:"+sAccountMonth+"--Grade:"+sGrade+"--UpdFlag:"+sUpdFlag);
	...
	try
	{
        sSql =  " select sum(DiscountValue) from reserve_predictdata " + 
   		 ...
   		 if(rs.next()){
   		     ...
   		     String s1 = "select (nvl(Balance,0) + nvl(Interest,0))* nvl(ExchangeRate, 1) as RMBBalance from reserve_total where LoanAccount = '"+sLoanAccount+"' and AccountMonth = '" + sAccountMonth + "'" ;
   		     ASResultSet r1 = Sqlca.getASResultSet(s1);
   		     if(r1.next()){
   		        dRMBBalance = r1.getDouble("RMBBalance");
   		        System.out.println(dRMBBalance+"$$$$$$$");
   		     }
