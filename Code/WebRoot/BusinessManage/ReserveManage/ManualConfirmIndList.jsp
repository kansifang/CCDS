...
<%	
    ...
    sSql = " select RT.AccountMonth,RT.LoanAccount,RT.DuebillNo,RT.CustomerID,RT.CustomerName,RT.PutoutDate,RT.Maturity,RT.RMBBalance,"+
    	   " MFiveClassify,getItemName('MFiveClassify',RT.MFiveClassify) as MFiveClassifyName,AFiveClassify,getItemName('MFiveClassify',RT.AFiveClassify) as AFiveClassifyName,"+
    	   " AuditStatFlag,getItemName('AuditStatFlag',RT.AuditStatFlag) as AuditStatFlagName,ManageStatFlag,getItemName('ManageStatFlag',RT.ManageStatFlag) as ManageStatFlagName,Manageuserid,getUserName(RT.Manageuserid) as ManageuserName " +
    	   " from Reserve_Total RT " +
	...
	doTemp.setCheckFormat("LoanAccount","6");
