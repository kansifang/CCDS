...
<%
	...
	sSql ="select SerialNo,GetItemName('WorkType',WorkType)  as WorkType,WorkBrief,PlanFinishDate,PromptBeginDate,ActualFinishDate,WorkContent,"
			...
			+"from WORK_RECORD  "
			+"where  (ActualFinishDate is null or ActualFinishDate='') and InputUserID = '"+CurUser.UserID+"'"; 
		...
		for (d = 0; d < 7; d++) 
		{
			if (!isNaN(myMonth[w][d])) 
			{
				if(iYear==dCurDate.getFullYear() && iMonth==(dCurDate.getMonth()+1) && myMonth[w][d]==document.all.calSelectedDate.value)
				{
					...
					{
						sReturn += ("<td align='center' valign='top' width='" + iCellWidth + "' height='" + iCellHeight + "' id=calCell style='CURSOR:Hand;background-color:#c0c0c0;' onMouseOver=showTipOfToday(1,this,\'"+getTodayTip(iYear,iMonth,parseInt(myMonth[w][d],10))+"\') >");
						...
						sReturn += ("<td align='center' valign='top' width='" + iCellWidth + "' height='" + iCellHeight + "' id=calCell style='CURSOR:Hand;background-color:#c0c0c0;'  onMouseOver='showlayer(0,this)'>");
						sReturn += ("<font id=calDateText onMouseOver='fToggleColor(this)' style='CURSOR:Hand;FONT-FAMILY:Arial;FONT-SIZE:" + sDateTextSize + ";FONT-WEIGHT:" + sDateTextWeight + "' onMouseOut='fToggleColor(this)' onClick=newTask("+iYear+","+iMonth+","+myMonth[w][d]+") >");
						sReturn += (""+ myMonth[w][d] +"");
						sReturn += ("</font>");
					}
				...
				else
				{
					if(getTodayJobCount(iYear,iMonth,parseInt(myMonth[w][d],10))>0)
					{
						sReturn += ("<td align='center' valign='top' width='" + iCellWidth + "' height='" + iCellHeight + "' id=calCell style='CURSOR:Hand' onMouseOver=showTipOfToday(1,this,\'"+getTodayTip(iYear,iMonth,parseInt(myMonth[w][d],10))+"\')>");
						sReturn += ("<font id=calDateText onMouseOver='fToggleColor(this)' style='CURSOR:Hand;FONT-FAMILY:Arial;FONT-SIZE:" + sDateTextSize + ";FONT-WEIGHT:" + sDateTextWeight + "' onMouseOut='fToggleColor(this)'  onClick=newTask("+iYear+","+iMonth+","+myMonth[w][d]+")>");
						sReturn += ("<b>");
						sReturn += (""+ myMonth[w][d] +"");
						sReturn += ("</b>");
						...
						sReturn += ("<td align='center' valign='top' width='" + iCellWidth + "' height='" + iCellHeight + "' id=calCell style='CURSOR:Hand' onMouseOver='showlayer(0,this)'");
						sReturn += ("<font id=calDateText onMouseOver='fToggleColor(this)' style='CURSOR:Hand;FONT-FAMILY:Arial;FONT-SIZE:" + sDateTextSize + ";FONT-WEIGHT:" + sDateTextWeight + "' onMouseOut='fToggleColor(this)'  onClick=newTask("+iYear+","+iMonth+","+myMonth[w][d]+")>");
						sReturn += (""+ myMonth[w][d] +"");
						sReturn += ( "</font>");
					}
			...
			else 
			{
				...
				sReturn += ("<font id=calDateText onMouseOver='fToggleColor(this)' style='CURSOR:Hand;FONT-FAMILY:Arial;FONT-SIZE:" + sDateTextSize + ";FONT-WEIGHT:" + sDateTextWeight + "' onMouseOut='fToggleColor(this)' onclick=fSetSelectedDay(this)>&nbsp;</font>");
			}
			sReturn += ("</td>")
		}
		sReturn += ("</tr>");
