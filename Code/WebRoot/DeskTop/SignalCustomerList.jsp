...
<%
    ...
    if(CurUser.hasRole("480") || CurUser.hasRole("280"))
    {
	    sSql =	"select CustomerID,CustomerName,getItemName('CertType',CertType) as CertTypeName,CertID,"+
                        ...
                        " where CustomerID in (select distinct(CustomerID) from Customer_Belong where UserID='"+CurUser.UserID+"')"+
                        " and CustomerID in (select ObjectNo from risk_signal where InputUserID='"+CurUser.UserID+"')";
