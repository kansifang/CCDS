							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
								...
								<tr> 
									<td colspan=2> 
										...
										<iframe name="left" scrolling="auto" src="<%=sWebRootPath%>/Blank.jsp?TextToShow=<%=DataConvert.toString(CurPage.getParameter("PG_CONTNET_TEXT_LEFT"))%>" width=100% height=100% frameborder=0></iframe>
										</div>
									</td>
								</tr>
							</table>
