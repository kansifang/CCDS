...
%>
		...
		<td align="left">
			<input type="text" readonly size="10" name="InputDate" value="<%=sNowTerm%>" onclick="javascript:selectQueryTerm()" style="cursor:hand">
		</td>
<%
		}
...
%>
		...
		<td align="left">
		<input type="hidden" name = "OrgID" value = "<%=sOrgID.equals("")?CurOrg.SortNo:sOrgID%>">
		<input type="text" readonly size="18" name="OrgName" value="<%=sOrgName.equals("")?CurOrg.OrgName:sOrgName%>" onclick="javascript:selectOrgID();" style="cursor:hand">
		</td>
<%
		}
...
%>
		...
		<td align="left">
			<select name="Currency" class="right">
				...
				<OPTION value="C3,本外币折人民币">人民币折美元</OPTION>
				<OPTION value="C4,本外币折人民币">英镑折美元</OPTION>
				<OPTION value="C5,本外币折人民币">港币折美元</OPTION>
				<OPTION value="C6,本外币折人民币">日元折美元</OPTION>
				<OPTION value="C7,本外币折人民币">欧元折美元</OPTION>
...
<%
		...
		if (bShowQueryTerm) {
			...
			selected[3]="";
			selected[4]="";
			//System.out.println("sQueryTerm:'"+sQueryTerm+"':"+sQueryTerm.equals(""));
...
<script language=javascript src="eventfuns.js"></script>
