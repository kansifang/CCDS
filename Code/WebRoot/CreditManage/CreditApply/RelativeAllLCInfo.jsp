...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=定义按钮事件;]~*/%>
	...
	function goBack()
	{
		...
		else if("<%=sTemplet%>" == "TradeInfo")
		{
		    OpenPage("/CreditManage/CreditApply/RelativeTradeList.jsp","_self","");
		}
		else if("<%=sTemplet%>" == "SecuritiesInfo")
		{
		    OpenPage("/CreditManage/CreditApply/RelativeSecuritiesList.jsp","_self","");
		}
	}
