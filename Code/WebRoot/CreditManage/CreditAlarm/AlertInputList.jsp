...
<%	
	...
	if(sTreatmentStatus.equals("Undistributed")){
		...
		if(!doTemp.haveReceivedFilterCriteria()) doTemp.WhereClause +=" and InputUser='"+CurUser.UserID+"'";
	}else if(sTreatmentStatus.equals("Unfinished")){
		doTemp.WhereClause+=" and OrgID='"+CurUser.OrgID+"' and EndTime is null";
	}else if(sTreatmentStatus.equals("Finished")){
		doTemp.WhereClause+=" and (UserID='"+CurUser.UserID+"' or InputUser='"+CurUser.UserID+"')  and EndTime is not null";
