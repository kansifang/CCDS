...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	doTemp.setHTMLStyle("AlertTypeName"," style={width:300px;height:50px;cursor:hand} onClick=parent.setObjectInfo(\"Code\",\"CodeNo=AlertSignal^警示类型^ItemNo$like$\\'AL%\\'$and$length(ItemNo)=6@AlertType@0@AlertTypeName@1\") ");
