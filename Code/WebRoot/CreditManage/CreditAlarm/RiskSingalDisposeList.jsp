...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "预警处置列表"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%
	...
	String PG_CONTENT_TITLE = "预警处置列表";//--题头
	...
	sActionFlag = DataConvert.toRealString(iPostChange,(String)CurComp.getParameter("ActionFlag"));	//获得页面参数
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	//依次为：
		...
		//6.资源图片路径
	String sButtons[][] = {
		{"2".equals(sActionFlag)?"false":"true","","Button","新增处置报告","新增处置报告","newReport()",sResourcesPath},
		{"true","","Button","查看预警处置报告","查看预警处置报告","viewDisposeReport()",sResourcesPath},
		{"true","","Button","预警详情","查看预警详情","viewAndEdit()",sResourcesPath},
		{"2".equals(sActionFlag)?"false":"true","","Button","删除","查看预警详情","deleteRecord()",sResourcesPath},
		{"2".equals(sActionFlag)?"false":"true","","Button","完成处置","完成处置","doneDispose()",sResourcesPath},
	};
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	//---------------------定义按钮事件------------------------------------
	/*~[Describe=填写预警处置报告;InputParam=无;OutPutParam=无;]~*/
	function newReport()
	{
    ...
    /*~[Describe=完成处置;InputParam=无;OutPutParam=无;]~*/
