...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function TransRecord()
	{
		...
		sReturn = PopPage("/CreditManage/CreditLine/CreditLineTransAction.jsp?LineID="+sLineID+"&SerialNo=<%=sSerialNo%>","","dialogWidth=21;dialogHeight=11;status:no;center:yes;help:no;minimize:no;maximize:no;border:thin;statusbar:no"); 
		parent.close();
	}
