...
<%		
	...
	String[][] sHeaders = {		
		...
		sSql =  " select LineID,CustomerID,CustomerName,BusinessType, "+
				...
				" BailRatio,LineSum1,LineSum2,BCSerialNo "+
				" from CL_INFO "+
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function viewBusiness()
	{
		...
		popComp("SublineSubList","/CreditManage/CreditLine/SublineSubList.jsp","CreditAggreement="+sBCSerialNo+"&BusinessType="+sBusinessType,"","");
	}
