...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	{
	    //传入当前的条件即可
	    sParaString = "RelativeTableName"+","+"CONTRACT_RELATIVE RT"+","+"ObjectNo"+","+"<%=sObjectNo%>"+","+"ContractStatus"+","+"020"+","+"ContractType"+","+"020"+","+"CustomerID"+","+"<%=sCustomerID%>";
		...
		sSerialNo = sReturn[0];
		sReturn=RunMethod("BusinessManage","ImportGauarantyContract","<%=sUseObjectType%>,<%=sObjectNo%>,"+sSerialNo);
	...
	function deleteRecord()
	{
		...
		sChannel = getItemValue(0,getRow(),"Channel");
		...
		{
			sReturn=RunMethod("BusinessManage","DeleteGuarantyContract","<%=sUseObjectType%>,<%=sObjectNo%>,"+sSerialNo);
