    ...
    <tr> 
      ...
      <td nowarp bgcolor="#F0F1DE" > 
        <select name="NewGuarantyType">
			<%=HTMLControls.generateDropDownSelect(Sqlca,"select ItemNo,ItemName from CODE_LIBRARY where CodeNo = 'GuarantyType' and IsInUse = '1' order by SortNo ",1,2,sGuarantyType)%> 
        </select>
      </td>
    </tr>
    <tr>
