...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Main03;Describe=定义树图;]~*/%>
	...
	{
	   sSqlTreeView +=" and (1=2";
	   if(CurUser.hasRole("088")||CurUser.hasRole("288")||CurUser.hasRole("488"))//担保品管理员
	   {
		   sSqlTreeView += " or ItemNo like '010%' or ItemNo like '020%' ";
	   } 
	   ...
	   {
		   sSqlTreeView += " or ItemNo like '030%' or ItemNo like '010%' or ItemNo like '020%' ";
	   }
	   sSqlTreeView +=")";
	}
