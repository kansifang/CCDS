...
<%@page import="com.amarsoft.are.task.taskscheduler.xml.JobSchedulingDataProcessor.DateConverter"%>
...
<%
	...
	sSql = "select BusinessType from business_contract  where serialno = (select assureagreement from business_apply where serialno = '"+sObjectNo+"')";
	String sRBusinessType = Sqlca.getString(sSql);
	if(sRBusinessType == null) sRBusinessType = "";
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function importRecord()
	{
		...
		if("<%=sRBusinessType%>" == "3050"){
			sReturn = selectObjectValue("SelectImportGuarantyContract1",sParaString,"",0,0,"");
		}else if("<%=sRBusinessType%>" == "3060"){
			sReturn = selectObjectValue("SelectImportGuarantyContract2",sParaString,"",0,0,"");
		}else{
