...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	function initRow()
	{
       	...
       	if(sOrgLevel == "0")
    	{
    		setItemValue(0,0,"ResultUserID5","<%=CurUser.UserID%>");
			setItemValue(0,0,"ResultUserName5","<%=CurUser.UserName%>");			
    	}
		if(sOrgLevel == "3")
    	{
    		setItemValue(0,0,"ResultUserID3","<%=CurUser.UserID%>");
			setItemValue(0,0,"ResultUserName3","<%=CurUser.UserName%>");		
    	}
    	if(sOrgLevel == "6")
    	{
    		setItemValue(0,0,"ResultUserID2","<%=CurUser.UserID%>");
			setItemValue(0,0,"ResultUserName2","<%=CurUser.UserName%>");						
    	}        
  	}
