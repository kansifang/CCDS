...
<%
	...
	//定义变量
	String sTempletNo = "";
	String sSortNo = CurOrg.SortNo; //机构ID
...
<%
	...
	if(sClassifyType.equals("020"))//已认定分类
	{
		...
		{
		    if(sDBName.startsWith("INFORMIX"))
		    	doTemp.WhereClause += " and CLASSIFY_RECORD.FinishDate5 <> '' and CLASSIFY_RECORD.FinishDate5 is not null and CLASSIFY_RECORD.ResultUserID5='"+CurUser.UserID+"' ";
			else if(sDBName.startsWith("ORACLE"))
				doTemp.WhereClause += " and CLASSIFY_RECORD.FinishDate5 <> ' ' and CLASSIFY_RECORD.FinishDate5 is not null and CLASSIFY_RECORD.ResultUserID5='"+CurUser.UserID+"' ";
			else if(sDBName.startsWith("DB2"))
		    	doTemp.WhereClause += " and CLASSIFY_RECORD.FinishDate5 <> '' and CLASSIFY_RECORD.FinishDate5 is not null and CLASSIFY_RECORD.ResultUserID5='"+CurUser.UserID+"' ";
		...
		{
		    if(sDBName.startsWith("INFORMIX"))
		    	doTemp.WhereClause += " and CLASSIFY_RECORD.FinishDate3 <> '' and CLASSIFY_RECORD.FinishDate3 is not null and CLASSIFY_RECORD.ResultUserID3='"+CurUser.UserID+"' ";
		    else if(sDBName.startsWith("ORACLE"))	
		    	doTemp.WhereClause += " and CLASSIFY_RECORD.FinishDate3 <> ' ' and CLASSIFY_RECORD.FinishDate3 is not null and CLASSIFY_RECORD.ResultUserID3='"+CurUser.UserID+"' ";
		    else if(sDBName.startsWith("DB2"))
		    	doTemp.WhereClause += " and CLASSIFY_RECORD.FinishDate3 <> '' and CLASSIFY_RECORD.FinishDate3 is not null and CLASSIFY_RECORD.ResultUserID3='"+CurUser.UserID+"' ";
		...
		{
		    if(sDBName.startsWith("INFORMIX"))
		    	doTemp.WhereClause += " and CLASSIFY_RECORD.FinishDate2 <> '' and CLASSIFY_RECORD.FinishDate2 is not null and CLASSIFY_RECORD.ResultUserID2='"+CurUser.UserID+"' ";
			 else if(sDBName.startsWith("ORACLE"))	
			 	doTemp.WhereClause += " and CLASSIFY_RECORD.FinishDate2 <> ' ' and CLASSIFY_RECORD.FinishDate2 is not null and CLASSIFY_RECORD.ResultUserID2='"+CurUser.UserID+"' ";
			 else if(sDBName.startsWith("DB2"))
		    	doTemp.WhereClause += " and CLASSIFY_RECORD.FinishDate2 <> '' and CLASSIFY_RECORD.FinishDate2 is not null and CLASSIFY_RECORD.ResultUserID2='"+CurUser.UserID+"' ";
	...
	//doTemp.setCheckFormat("AccountMonth","3");
	//设置查询条件
