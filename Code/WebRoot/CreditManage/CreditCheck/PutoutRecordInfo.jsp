...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	String sSql = " select SerialNo,ItemNo,ObjectType,objectno,AccountNo,CustomerName,Currency,"+
				  " ItemDate,ItemSum,Balance,ItemType from INSPECT_DETAIL "+
	...
	doTemp.setType("ItemSum","Number");//设置列类型
	doTemp.setCheckFormat("Balance,ItemSum","2");//设置输入格式，带逗号的钱数d
	doTemp.setAlign("Balance,ItemSum","3");
	...
	doTemp.setRequired("AccountNo,Currency,ItemDate,ItemSum",true);
