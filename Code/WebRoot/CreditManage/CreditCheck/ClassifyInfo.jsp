...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	if(sClassifyType.equals("010"))
	{
		if(sObjectType.equals("BusinessContract"))
			sTempletNo = "ManagerClassifyInfo1";
	...
	if(sObjectType.equals("BusinessContract"))
	{
		sSql = " select min(PUTOUTDATE) from BUSINESS_DUEBILL where RelativeSerialNo2 = '"+sObjectNo+"' ";
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	function initRow()
	{
  		...
  		if(sClassifyType == "010")
  		{
  			...
  			setItemValue(0,0,"ClassifyUserName","<%=CurUser.UserName%>");
  			setItemValue(0,0,"ClassifyOrgID","<%=CurOrg.OrgID%>");
  			setItemValue(0,0,"ClassifyOrgName","<%=CurOrg.OrgName%>");  			
  		}  		
  	}
