...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=定义按钮事件;]~*/%>
	...
	function goBack()
	{
		OpenPage("/CreditManage/GuarantyManage/ContractImpawnList2.jsp?ObjectType=<%=sOldObjectType%>&ObjectNo=<%=sObjectNo%>&ContractNo=<%=sContractNo%>","_self","");
	}
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	function selectOrg()
	{
		setObjectValue("SelectAllOrg","","@GuarantyDescribe3@1",0,0,"");
	}
