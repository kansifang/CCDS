...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	doTemp.appendHTMLStyle("AboutRate"," myvalid=\"parseFloat(myobj.value,10)>=0 && parseFloat(myobj.value,10)<=100 \" mymsg=\"注册资本必须大于等于0小于等于100！\" ");
	doTemp.appendHTMLStyle("GuarantyAmount1"," myvalid=\"parseFloat(myobj.value,10)>=0 \" mymsg=\"保险费交缴期限必须大于等于0！\" ");
