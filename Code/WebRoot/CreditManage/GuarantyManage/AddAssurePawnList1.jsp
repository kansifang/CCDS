...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
		...
		sPawnType = sReturn[0];	
		OpenPage("/CreditManage/GuarantyManage/AddAssurePawnInfo1.jsp?ContractNo=<%=sContractNo%>&ObjectNo=<%=sObjectNo%>&ObjectType=<%=sObjectType%>&PawnType="+sPawnType,"_self");
	}
	...
	function viewAndEdit()
	{
		...
		{
			OpenPage("/CreditManage/GuarantyManage/AddAssurePawnInfo1.jsp?ContractNo=<%=sContractNo%>&ObjectNo=<%=sObjectNo%>&ObjectType=<%=sObjectType%>&GuarantyID="+sGuarantyID+"&PawnType="+sPawnType,"_self");
		}
	}
