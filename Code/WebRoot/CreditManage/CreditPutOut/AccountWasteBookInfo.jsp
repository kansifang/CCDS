...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	String sOccurDirection = Sqlca.getString("select OccurDirection from BUSINESS_WASTEBOOK where SerialNo='"+sSerialNo+"'");
	if(sOccurDirection == null) 
	{
		DataConvert.toRealString(iPostChange,(String)CurComp.getParameter("OccurDirection"));
		if(sOccurDirection==null) sOccurDirection="1"; //1.是回收
	}
	...
	String sBusinessType = Sqlca.getString("select BusinessType from BUSINESS_CONTRACT where SerialNo='"+sObjectNo+"'");
	String sOrigin = Sqlca.getString("select attribute4 from BUSINESS_TYPE where TypeNo='"+sBusinessType+"'");
