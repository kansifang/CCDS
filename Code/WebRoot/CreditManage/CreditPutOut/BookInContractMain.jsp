...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Main01;Describe=定义页面属性;]~*/%>
	...
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;贷后日常管理&nbsp;&nbsp;"; //默认的内容区标题
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Main03;Describe=定义树图;]~*/%>
	<%
	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"电子合同管理","right");
