...
<script language=javascript>
	function getHTMLScript(){
		...
		if(sText == "undefined" || sText == "") {
			...
			var sReturnValue = PopPage("/Common/HtmlEditor/InsertPageValue.jsp?CommentText="+sText+"&CommentItemName="+sCommentName+"&TableName=REG_COMMENT_ITEM&CommentItemID=<%=sCommentItemid%>&rand="+randomNumber(),"", "dialogWidth:280px; dialogHeight:200px; help: no; scroll: no; status: no");
