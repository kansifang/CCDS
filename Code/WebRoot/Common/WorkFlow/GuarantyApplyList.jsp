...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List00;Describe=注释区;]~*/%>
	...
	Tester:
	Content: 该页面主要处理业务相关的申请列表，如抵质押物出入库申请列表
	Input Param:
		ApplyType：申请类型
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List03;Describe=定义数据对象;]~*/%>
	...
	if(!sApplyType.equals("CreditCogApply")&&!sApplyType.equals("BadBizApply")&&
		...
		if(sApplyType.equals("ContractModApply")){
	...
	//else
		dwTemp.setEvent("AfterDelete","!WorkFlowEngine.DeleteGuarantyTask(#ObjectType,#ObjectNo,DeleteTask)");
	//生成HTMLDataWindow
