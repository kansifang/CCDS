		          ...
		          <td colspan="5" valign="top" ><hr></td>
						...
						<table align="center">							
							<tr>
								 ...
								 <td colspan=4>
									<select size=8  name="PhaseOpinion1"  class="select1">// add by cdeng 2009-02-17
	...
	<script language=javascript>		
		...
		function commitAction()
		{
			...
			{						
				...
				{
					sReturnValue = PopPage("/Common/WorkFlow/SubmitAction.jsp?SerialNo=<%=sSerialNo%>&PhaseOpinion1="+thisPhaseOpinion1+"&PhaseAction="+thisPhaseAction,"","");
