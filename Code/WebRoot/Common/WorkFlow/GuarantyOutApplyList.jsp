...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	//---------------------定义按钮事件------------------------------------
	/*~[Describe=新增出库申请;InputParam=无;OutPutParam=无;]~*/
	function newApplyOut()
	{
		//设置对象类型
		sObjectType = "GuarantyOutApply";		
		sParaString = "";
		sReturn = setObjectValue("SelectGuarantyOut","OrgID,"+"<%=CurUser.OrgID%>","",0,0,"");
		...
		//抵质押物出库申请号
		var sTableName = "Guaranty_Apply";//表名
		...
		RunMethod("WorkFlowEngine","InitializeFlow",sObjectType+","+sSerialNo+","+sApplyType+",GuarantyOutFlow,0010,"+sUserID+","+sOrgID);
		sCompID = "CreditTab";
		sCompURL = "/CreditManage/CreditApply/ObjectTab.jsp";
		sParamString = "ObjectType=GuarantyOutApply&ObjectNo="+sSerialNo;
