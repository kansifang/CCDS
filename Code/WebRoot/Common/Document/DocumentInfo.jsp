...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	//设置是否可见
	doTemp.setVisible("DocNo,OrgID,UserID,DocAttribute",false);
	//设置必输项
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		...
		{(CurUser.UserID.equals(sUserID)?"true":"false"),"","Button","上传/修改附件","上传/查看/修改选中文档相关的所有附件","viewAndEdit_attachment()",sResourcesPath},
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=定义按钮事件;]~*/%>
	...
	function goBack()
	{
		OpenPage("/Common/Document/DocumentList.jsp","_self","");
	}
