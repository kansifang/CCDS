...
<%	
	...
	doTemp.setHTMLStyle("ItemNo"," style={width:80px} ");
	...
	*/
	...
	//所有都为不显示
	doTemp.setVisible("Attribute1,Attribute2,Attribute3,Attribute4,Attribute5,Attribute6,Attribute7,Attribute8,InputUserName,InputOrgName,UpdateUserName,InputUser,InputOrg,UpdateUser,InputTime,UpdateTime",false);    	
