...
<%
	...
	String sSql = "select ContractSerialNo,BP.CustomerID,BP.CustomerName,getBusinessName(BusinessType) as BusinessTypeName,"+
				  ...
				  " getitemname('Currency',BailCurrency) as BailCurrency,BailRatio,BailAccount,GuarantyNo,OperateOrgID ,PdgSum,getOrgName(OperateOrgID) as OperateOrgName, "+
...
<%
	...
	if(rs2.next())
	{
		...
		sSql4=" select CONTRACTNO,getitemname('Currency',GuarantyCurrency) as GuarantyCurrency,GUARANTYINFO "+
		...
		{	
			...
			sTemp.append("   <tr>");
			sTemp.append("   <td width=20% align=left class=td1 >保证金账号</td>");
