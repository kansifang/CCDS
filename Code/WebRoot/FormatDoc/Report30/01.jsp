...
<%
	...
	if(rs2.next())
	{
		...
		sBusinessSum = rs2.getString("BusinessSum");
		if(sBusinessSum == null) sBusinessSum = "0";
		dBusinessSum = DataConvert.toDouble(sBusinessSum);
...
<%
    ...
    sTemp.append(" <td width=18% align=center class=td1 > 金额（元） </td>");
    ...
    sTemp.append(" <td width=15% align=center class=td1 >"+DataConvert.toMoney(sBusinessSum)+"&nbsp;</td>");
