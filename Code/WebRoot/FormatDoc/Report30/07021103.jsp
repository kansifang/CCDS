...
//*****************************************现金流量表*****************************
	...
	" where ObjectNo ='"+sGuarangtorID+"' And ModelNo like '%8' And ReportDate = (select max(Reportdate) from REPORT_RECORD Where ObjectNo ='"+sGuarangtorID+"' And ModelNo like '%8')  and ReportScope = GETFSREPORTSCOPE('"+sGuarangtorID+"',ReportDate)");
	if(rs2.next())
	{
...
<%
	...
	sTemp.append("	<form method='post' action='07021103.jsp' name='reportInfo'>");	
