...
<%
	...
	sTemp.append("	<form method='post' action='0602.jsp' name='reportInfo'>");	
	sTemp.append("<div id=reporttable>");	
	sTemp.append("<table class=table1 width='640' align=center border=1 cellspacing=0 cellpadding=2 bgcolor=white bordercolor=black bordercolordark=black >	");
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >6.1、资产负债表结构与对比</font></td>"); 	
	sTemp.append("   </tr>");
	sTemp.append("<tr>");
	...
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	sTemp.append("<td align=left class=td1 > 货币资本 </td>");
	...
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	sTemp.append("   <td width=18% colspan=12 align=center class=td1 > <br><strong>损益表结构和对比</strong> <br>&nbsp;</td>");
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	sTemp.append("<td rowspan=2 align=center class=td1 > 项目 </td>");
	...
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	sTemp.append("   <td width=18% colspan=12 align=center class=td1 > <br><strong>现金流量表</strong> <br>&nbsp;</td>");
	sTemp.append("</tr>");
	sTemp.append("<td rowspan=2 align=center class=td1 > 项目 </td>");
