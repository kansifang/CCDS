...
<%
	...
	String sSql = " select * from REPORT_DATA where reportno in (select reportno from REPORT_RECORD"
				  +" where reportdate = '"+sYearN+"' and objectno = '"+sCustomerID+"' and ReportName ='财务指标表' and ReportScope = GETFSREPORTSCOPE('"+sCustomerID+"','"+sYearN+"'))";
	//out.println(sSql);
...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >4.7、营运能力分析</font></td>"); 	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
