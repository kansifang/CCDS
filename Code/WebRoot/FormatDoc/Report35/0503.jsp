...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=18 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' > 5.3、借款人在他行未结清授信情况 </font></td>"); 	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
