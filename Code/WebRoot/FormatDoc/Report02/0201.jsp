...
<%
	...
	ASResultSet rs2 = Sqlca.getResultSet("select RegisterAdd,OfficeAdd,getitemname('OrgType',OrgType) as OrgTypeName,"
							...
							+"MostBusiness,getItemname('YesNo',ListingCorpOrNot) as ListingCorpOrNot "
...
<%
	...
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>	");
	sTemp.append("   <td class=td1 align=left colspan=13 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >2.1、概况（单位：万元）</font></td> ");	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
