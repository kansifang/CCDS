...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List00;Describe=注释区;]~*/%>
	...
	/*
		...
		Input Param:
			...
			ObjectNo：业务流水号
		Output param:
		History Log: fhuang 2006.10.19 增加保证金保证
	 */
	%>
<%/*~END~*/%>
...
<% 	
	...
	//数组化保证方式参数、履约保险保证参数、保函保证参数、保证金保证参数、抵押物参数、质押物参数
	...
	{	
		//公司客户首笔（单笔单批）授信业务调查报告,非首笔业务（单笔单批）,综合授信额度,综合授信额度项下业务,个人调查报告,账面不良贷款重点监控报告		
