...
<% 
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=center colspan=23 bgcolor=#aaaaaa ><font style=' font-size: 14pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >附录三、抵质押物信息</font></td>"); 	
	sTemp.append("   </tr>");	
