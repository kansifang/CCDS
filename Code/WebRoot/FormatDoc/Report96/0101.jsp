...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=19 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >"+"1、本人对借款人"+sCustomerName+"的下岗失业人员小额担保贷款借款申请及有关资料已经审核，情况如实反映如下："+"</font></td>"); 	
	sTemp.append("   </tr>");	
	sTemp.append(" <tr>");	
  	sTemp.append("<td align=left class=td1 "+myShowTips(sMethod)+" >&nbsp;&nbsp;&nbsp;&nbsp;1.1、借款申请人基本情况：（借款人从业经历、管理履历等）");
  	sTemp.append("   </td>");
    sTemp.append("   </tr>");
	sTemp.append("   <tr>");
