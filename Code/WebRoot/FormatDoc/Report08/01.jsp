...
<%
	...
	int iTermMonth = 0;
	double dThirdPartyZIP3 = 0.0;        //公积金贷款利率
...
<%
    ...
    sTemp.append(" <td width=15% align=center class=td1 > 金额（元） </td>");
    sTemp.append(" <td width=15% align=center class=td1 > 币种 </td>");
   	sTemp.append(" <td width=20% align=center class=td1 > 授信期限(月） </td>");    
