...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >1.2、借款人及共同还款人（含配偶）收入情况</font></td>"); 	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
  	sTemp.append("   <td width=15% height='34' align=center class=td1 >本人工资月收入合计(元)：</td>");
  	sTemp.append("   	<td width=15%  align=right class=td1 >");
	sTemp.append(sMonthIncome);
	sTemp.append("      &nbsp;</td>");
  	sTemp.append("   <td width=15% height='34' align=center class=td1 >其它月收入(元)：</td>");
  	sTemp.append("   	<td width=15%  align=right class=td1 >");
	sTemp.append(myOutPut("2",sMethod,"name='describe1' style='width:100%; height:25'",getUnitData("describe1",sData)));
	sTemp.append("      &nbsp;</td>");
  	sTemp.append("   <td width=15% height='34' align=center class=td1 >合计月收入(元)：</td>");
  	sTemp.append("   	<td width=15%  align=right class=td1 >");
	...
	sTemp.append("   <tr>");
  	sTemp.append("   <td width=15% height='34' align=center class=td1 >共同还款人工资月收入合计(元)：</td>");
  	sTemp.append("   	<td width=15%  align=right class=td1 >");
	...
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >1.3、经查询个人资信资料，申请人、共同还款人、共有人资信情况如下：</font></td>"); 	
	sTemp.append("   </tr>");	

	sTemp.append("   <tr>");
	sTemp.append(" 	 <td colspan=20 height='34' class=td1 >");
	sTemp.append(" 	 （1）");
	sTemp.append(myOutPutCheck("4",sMethod,"name='describe6'",getUnitData("describe6",sData),"无不良信用记录"));
	sTemp.append("&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp");
	sTemp.append(myOutPutCheck("4",sMethod,"name='describe7'",getUnitData("describe7",sData),"无其他借款"));
	sTemp.append("&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp");
	sTemp.append(myOutPutCheck("4",sMethod,"name='describe8'",getUnitData("describe8",sData),"在个人征信系统中无记录"));
	sTemp.append("   </td>");  	
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
	sTemp.append(" 	 <td colspan=20 height='34' class=td1 >");
	sTemp.append(" 	 （2）");
	sTemp.append(myOutPutCheck("4",sMethod,"name='describe9'",getUnitData("describe9",sData),"无其他借款"));
	sTemp.append("&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp");
  	sTemp.append("   合计：<u>");
  	sTemp.append(myOutPut("2",sMethod,"name='describe10' style='width:5%; height:25'",getUnitData("describe10",sData)));
	sTemp.append("</u>笔&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp");
  	sTemp.append("   合计月还款：<u>");
	sTemp.append(myOutPut("2",sMethod,"name='describe11' style='width:15%; height:25'",getUnitData("describe11",sData)));
	sTemp.append("</u>      元&nbsp;</td>");
	sTemp.append("   </tr>");
	...
	sTemp.append("&nbsp;<u>");  	
	sTemp.append(myOutPut("2",sMethod,"name='describe12' style='width:20%; height:25'",getUnitData("describe12",sData)));
	sTemp.append("</u>       %&nbsp;</td>");
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
	sTemp.append(" 	 <td colspan=20 height='34'class=td1 >");
	sTemp.append(" 	 （4）");
	sTemp.append(myOutPutCheck("4",sMethod,"name='describe13'",getUnitData("describe13",sData),"有借款逾期"));
	sTemp.append("   逾期金额合计：<u>");
	sTemp.append(myOutPut("2",sMethod,"name='describe14' style='width:15%; height:25'",getUnitData("describe14",sData)));
	sTemp.append("</u>      元&nbsp;</td>");
 	sTemp.append("   </tr>");
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >1.4、申请人现住房情况：</font></td>"); 	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
	sTemp.append(" 	 <td colspan=20 class=td1 >");
	sTemp.append(myOutPutCheck("3",sMethod,"name='describe15'",getUnitData("describe15",sData),"自有产权@租赁@其他"));
	sTemp.append("   </td>");  	
	sTemp.append("   </tr>");
		
	sTemp.append(" <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >1.5、个人资产情况：</font></td>"); 	
  	sTemp.append("   </td>");
    sTemp.append("   </tr>");
	sTemp.append("   <tr>");
  	sTemp.append("   <td colspan='6' align=left class=td1 >");
	sTemp.append(myOutPut("2",sMethod,"name='describe18' style='width:100%; height:150'",getUnitData("describe18",sData)));
	sTemp.append("   <br>");
	sTemp.append("&nbsp;</td>");
    sTemp.append("   </tr>");

	sTemp.append(" <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >1.6</font></td>"); 	
  	sTemp.append("   </td>");
    sTemp.append("   </tr>");
	sTemp.append("   <tr>");
