...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=center bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >（三）行业地位及市场竞争力</font></td>"); 	
	sTemp.append("   </tr>");
