...
<%
	...
	sTemp.append("<form method='post' action='1303.jsp' name='reportInfo'>");	
	sTemp.append("<div id=reporttable>	");
	sTemp.append("<table class=table1 width='640' align=center border=1 cellspacing=0 cellpadding=2 bgcolor=white bordercolor=black bordercolordark=black >");	
	sTemp.append("   <tr>	");
	sTemp.append("   <td class=td1 align=left colspan=13 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >13.3、综合以上分析，同意按照以下方式给予授信</font></td> ");	
	sTemp.append("   </tr>");
    ...
    sTemp.append(" 		<td  align=left class=td1 >"+sApplyType+"&nbsp;</td>");
    sTemp.append(" 	</tr>");
