...
<%
	...
	sTemp.append("   <tr>	");
	sTemp.append("   <td class=td1 align=left colspan=13 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >4.2、借款人现有授信</font></td> ");	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
    ...
    sTemp.append(" 		<td width=10% align=center class=td1 >批复金额</td>");
    sTemp.append(" 		<td width=10% align=center class=td1 >合同金额</td>");
    sTemp.append(" 		<td width=10% align=center class=td1 >合同余额</td>");
	...
	while(rs2.next()){
		...
		sBusinessSum = DataConvert.toMoney(rs2.getDouble(4));
		if(sBusinessSum == null) sBusinessSum="0";
		
		sBailRatio = DataConvert.toMoney(rs2.getDouble(5));
