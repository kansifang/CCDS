...
<%
	...
	ASResultSet rs2 = Sqlca.getResultSet("select RegisterAdd,OfficeAdd,getitemname('OrgType',OrgType) as OrgTypeName,"
							...
							+"getItemName('CreditLevel',CreditLevel) as CreditLevel,SetupDate,getItemName('YesNo',ECGroupFlag) as GroupFlag,"
...
<%
	...
	sTemp.append("   <tr>	");
	sTemp.append("   <td class=td1 align=left colspan=13 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >2、借款人基本信息</font></td> ");	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
    ...
    sTemp.append(" 		<td width=15% align=left class=td1 >"+sCreditLevel+"&nbsp;</td>");
