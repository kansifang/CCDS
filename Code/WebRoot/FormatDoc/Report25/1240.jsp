...
<%
	...
	String sGuarantyTypeName = "";	//质押物分类
	String sGuarantyID = "";		//质押物编号
	String sGuarantyName = "";		//质押物名称
	String sOwnerName = "";			//质押物的所有权人
	String sGuarantyDescribe2 = "";	//质押物详细描述
	String sGuarantyPrice = "";		//质押物原值
	double dGuarantyAmount1 = 0;	//数量
	String sEvalNetValue = "";		//正式评估价值
	String sGuarantyRegOrg = "";	//质押物登记机构
	...
	String[] sNo1 = null; 
	int iNo=1,i=0;
	sSql = "select TreeNo from FORMATDOC_DATA where ObjectNo = '"+sObjectNo+"' and (TreeNo like '120_' or TreeNo like '072_') and ObjectType = '"+sObjectType+"'";
	rs2 = Sqlca.getResultSet(sSql);
	while(rs2.next())
	{
	...
	int j=0; 
	sSql = "select TreeNo from FORMATDOC_DATA where ObjectNo = '"+sObjectNo+"' and TreeNo like '1240__' and ObjectType = '"+sObjectType+"'";
	rs2 = Sqlca.getResultSet(sSql);
	while(rs2.next())
	{
...
<%
	...
	sTemp.append("<form method='post' action='1240.jsp' name='reportInfo'>");	
	...
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
  	sTemp.append("   <td width=34% align=center class=td1 > 质押物分类</td>");
	sTemp.append("   <td width=18% align=center class=td1 >"+sGuarantyTypeName+"&nbsp;</td>");
	sTemp.append("   <td width=28% align=center class=td1 > 质押物编号 </td>");
	sTemp.append("   <td width=20% align=center class=td1 >"+sGuarantyID+"&nbsp;</td>");
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
  	sTemp.append("   <td width=28% align=center class=td1 > 质押物名称</td>");
	...
	sTemp.append("   <tr align=left>");
  	sTemp.append("   <td align=center colspan=1 class=td1 > 质押物详细描述 </td>");
	sTemp.append("   	<td colspan=3  align=left class=td1 >");
	sTemp.append(myOutPut("2",sMethod,"name='describe5' style='width:100%; height:25'",getUnitData("describe5",sData)));
	sTemp.append("      &nbsp;</td>");
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
  	sTemp.append("   <td width=34% align=center class=td1 > 质押物所有人</td>");
	...
	sTemp.append("   </tr>");
	sTemp.append("   <tr align=left>");
  	sTemp.append("   <td width=28% align=center class=td1 > 质押物登记机构</td>");
	sTemp.append("   <td colspan=3 align=left class=td1  >"+sGuarantyRegOrg+"&nbsp;</td>");
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
  	sTemp.append("   <td width=28% align=center class=td1 > 质押物数量</td>");
	sTemp.append("   <td width=22% align=center class=td1 >"+dGuarantyAmount1+"&nbsp;</td>");
	sTemp.append("   <td width=28% align=center class=td1 > 质押物价值（万元） </td>");
	...
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 11pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >质押物来源、出质是否合法</font></td>"); 	
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
	...
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 11pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >质押物的价格稳定性分析</font></td>"); 	
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
  	sTemp.append("   <td colspan='4' align=left class=td1 >");
	...
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=20 bgcolor=#aaaaaa ><font style=' font-size: 11pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >质押物变现能力分析</font></td>"); 	
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");
  	sTemp.append("   <td colspan='4' align=left class=td1 >");
