...
<%
	...
	sTemp.append("   </tr>");
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=10 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >4.1借款人集团客户在我行授信情况</font></td> ");	
	sTemp.append("   </tr>");	
	sTemp.append("  <tr>");
	...
	if(rs2.next()){
		...
		if(sSumBusinessSum == null) sSumBusinessSum = "0.00";
