...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=7  >3.抵押物价值及租金水平分析</td> ");
	sTemp.append("   </tr>"); 
	
	
	sTemp.append("   <tr>");
		sTemp.append("   <td colspan=1 rowspan=2 align=center class=td1 >抵押房产 </td>");
	    sTemp.append("   <td colspan=4 align=center class=td1 >抵押物价值</td>");
	    sTemp.append("   <td colspan=2 align=center class=td1 >抵押物租金</td>");
	 sTemp.append("   </tr>");
	 sTemp.append("   <tr>");
	    sTemp.append("   <td colspan=1  align=center class=td1 >3年以内的购置单价</td>");
	    sTemp.append("   <td colspan=1  align=center class=td1 >周边可参考同类</br>房屋单价</td>");
	    sTemp.append("   <td colspan=1  align=center class=td1 >评估单价</td>");
	    sTemp.append("   <td colspan=1  align=center class=td1 >抵押率</td>");
	    sTemp.append("   <td colspan=1  align=center class=td1 >抵押物租金</br>（元/日. m2）</td>");
	    sTemp.append("   <td colspan=1  align=center class=td1 >周边可参考同类</br>房屋租金（元/日. m2）</td>");
	 sTemp.append("   </tr>");
