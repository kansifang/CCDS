...
<%
	...
	if("3050".equals(sBusinessType))	
		sTemp.append("   <td class=td1 align=center colspan=10 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >农户联保小组授信业务调查报告</font></td> ");	
	else if("3060".equals(sBusinessType))
		sTemp.append("   <td class=td1 align=center colspan=10 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >信用共同体授信业务调查报告</font></td> ");
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
