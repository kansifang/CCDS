...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left colspan=10 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >1、业务概况</font></td> ");	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
    ...
    sTemp.append(" </tr>");
	sTemp.append("  <tr>");
  	sTemp.append(" <td width=25% align=center class=td1 > 授信业务品种</td>");
    sTemp.append(" <td width=25% align=center class=td1 > 金额（元） </td>");
    sTemp.append(" <td width=25% align=center class=td1 > 币种 </td>");
    sTemp.append(" <td width=25% align=center class=td1 > 月利率‰</td>");
   // sTemp.append(" <td width=20% align=center class=td1 > 五级分类 </td>");
    ...
    sTemp.append("  </tr>");
	sTemp.append("  <tr>");
  	sTemp.append(" <td colspan='5' align=left class=td1 > 本笔授信业务的担保方式和具体内容：<p>主要担保方式－"+sVouchType+"</p>"+sGuarantyType+"&nbsp;</td>");
    sTemp.append(" </tr>");
	sTemp.append("</table>");	
	sTemp.append("</div>");	
