...
<script language=javascript>
	...
	function my_ChangeUserAction()
	{
		...
		var sReturn = PopPage("/RecoveryManage/NPAManage/NPADistributeManage/ChangeUserAction.jsp?RecoveryOrgID="+sRecoveryOrgID+"&RecoveryUserID="+sRecoveryUserID+"&SerialNo=<%=sObjectNo%>&ObjectType=<%=sObjectType%>","","");
	}
	...
	{	
		...
		{	if("<%=sObjectType%>" == "BadBizAsset")
			{
				OpenPage("/RecoveryManage/NPAManage/NPADistributeManage/NPAPDAssetList.jsp","right");
			}else
			{
				OpenPage("/RecoveryManage/NPAManage/NPADistributeManage/NPADispenseList.jsp","right");
			}
			self.close();
		}else
		{
			OpenPage("/RecoveryManage/NPAManage/NPADistributeManage/NPAChangeUserList.jsp?ObjectNo=<%=sObjectNo%>&ObjectType=<%=sObjectType%>","right");
			self.close();
		}		
 	}
