...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "关联诉讼案件合同"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%
	...
	{
		sObjectNo =  DataConvert.toRealString(iPostChange,(String)CurComp.getParameter("LawCaseSerialNo"));
		if(sObjectNo == null) sObjectNo = "";
	}
...
<%
	...
	sSql =   " select BR.SerialNo as SerialNo,BR.ObjectType as ObjectType,BR.ObjectNo as ObjectNo,BC.CustomerID,BC.CustomerName as CustomerName,"+
		...
		" BC.OriginalPutOutDate as OriginalPutOutDate,BC.Maturity as Maturity,BC.FinishDate as FinishDate "+
	...
	doTemp.setType("BusinessSum,Balance,InterestBalance1,InterestBalance2","Number");
	//小数为2，整数为5
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function importRecord()
	{
		...
		if(typeof(sReturnValue) != "undefined" && sReturnValue != "" && sReturnValue != "_NONE_" && sReturnValue != "_CLEAR_" && sReturnValue != "_CANCEL_") 
		{
			...
			sReturn = RunMethod("BusinessManage","InsertRelative","<%=sObjectNo%>"+",LawCaseContract,"+sContractSerialNO+",BADBIZ_RELATIVE");
