...
<script language=javascript>
	...
	//---------------------定义按钮事件------------------------------------
	/*~[Describe=右击选择台帐;InputParam=无;OutPutParam=无;]~*/
	function onDBClick()
	{
	...
	function bAccount_Maintenance()
	{
		...
		if (typeof(sSerialNo)=="undefined" || sSerialNo.length==0)
		{
			...
			popComp("BadBizAccountInfo","/RecoveryManage/AccountManage/BadBizAccountInfo.jsp","ComponentName=不良贷款台帐详情&SerialNo="+sSerialNo+"&StateFlag=<%=sStateFlag%>&AccountType=010&AccountEditFlag=02","","");
			reloadSelf();
		}
	}
