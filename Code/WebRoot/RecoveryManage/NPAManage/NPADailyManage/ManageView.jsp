...
<%
	...
	//获得终结类型
	String sSql = " select FinishType from BUSINESS_CONTRACT where SerialNo = '"+sObjectNo+"' ";
	String sFinishType = Sqlca.getString(sSql);
	...
	{ 
		...
		if(sCurItemID!="root")
		{
			...
			{				
				...
				{	
					openChildComp(sCurItemDescribe2,sCurItemDescribe1,"ComponentName="+sCurItemName+"&ObjectType="+sCurItemDescribe4+"&ObjectNo=<%=sObjectNo%>&ViewID=<%=sViewID%>&Flag=010&NoteType=NPAWorkType&ClassifyType="+sCurItemDescribe3+"&CurItemID="+sCurItemID,OpenStyle);
					setTitle(sCurItemName);
				}else
				{
					openChildComp(sCurItemDescribe2,sCurItemDescribe1,"ComponentName="+sCurItemName+"&ObjectType=<%=sObjectType%>&ObjectNo=<%=sObjectNo%>&ViewID=<%=sViewID%>&Flag=010&NoteType=NPAWorkType&AccountType="+sCurItemDescribe3+"&CurItemID="+sCurItemID,OpenStyle);
					setTitle(sCurItemName);
				}
			}
		}
