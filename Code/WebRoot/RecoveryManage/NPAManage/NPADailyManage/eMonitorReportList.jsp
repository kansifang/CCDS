...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "不良资产日常管理重点监控报告列表"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%
	...
	String sSql =   " select SerialNo,ObjectNo,ReportDate,"+
					...
					" from MONITOR_REPORT "+
					" where ObjectNo='"+sObjectNo+"' and ReportType='020' ";
	//由SQL语句生成窗体对象。
...
//---------------------定义按钮事件------------------------------------
	...
	function newRecord()
	{
		...
		sCompID = "EMonitorReportCreationInfo";
		sCompURL = "/RecoveryManage/NPAManage/NPADailyManage/EMonitorReportCreationInfo.jsp";			
