...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=定义按钮事件;]~*/%>
	...
	function doSubmit()
	{
		...
		//新增资产风险分类信息
	    sReturn = PopPage("/CreditManage/CreditCheck/AddClassifyAction.jsp?AccountMonth="+sAccountMonth+"&ObjectType="+sObjectType+"&ObjectNo="+sObjectNo+"&Type=Single&ModelNo=<%=sModelNo%>","","");
