...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "抵入账面登记详情"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	String sTempletNo = "APDAssetAccountInfo";  
...
<script language=javascript>
	...
	function goBack()
	{
		OpenPage("/RecoveryManage/AccountManage/APDAssetList.jsp","_self","");
	}
