...
<%
	...
	//设置不可见性
	doTemp.setVisible("SerialNo,OldOrgName,NewOrgName,OldShift,NewShift",false);
	//设置选项行宽
...
<script language=javascript>
	...
	function viewAndEdit()
	{
		...
		}else
		{
			...
			sCompID = "ChangeUserInfo";
			sCompURL = "/RecoveryManage/DistributeManage/ChangeUserInfo.jsp";
