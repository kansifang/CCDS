...
<script language=javascript>
	...
	function new_Account()
	{
		...
		sObjectNo = "<%=sObjectNo%>";
		popComp("BadBizApplyAccountInfo","/RecoveryManage/AccountApplyManage/BadBizApplyAccountInfo.jsp","ComponentName=不良贷款台帐申请详情&SerialNo="+sSerialNo+"&AccountType=020&RefromBAFlag="+sRefromBAFlag+"&ObjectNo="+sObjectNo,"","");
		reloadSelf();
	}
	...
	function viewTab()
	{
		...
		if (typeof(sSerialNo)=="undefined" || sSerialNo.length==0)
		{
			...
			popComp("BadBizApplyAccountInfo","/RecoveryManage/AccountApplyManage/BadBizApplyAccountInfo.jsp","ComponentName=不良贷款台帐详情&SerialNo="+sSerialNo+"&AccountType=020&AccountEditFlag=01","","");
			reloadSelf();
		}
	}
</script>
