...
<%
	...
	*/
	...
	//生成查询框
	doTemp.setColumnAttribute("SerialNo,BelongOrgName,CustomerName,LoanAccountNo,CertType,CertID,FactUser,FinalBalance,AccountNeedManage,BasicNeedManage,IsFinish,RecoverOrgID,RecoverUserID","IsFilter","1");
