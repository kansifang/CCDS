...
<script language=javascript>
	...
	function my_ChangeUserAction()
	{
		...
		var sReturn = PopPage("/RecoveryManage/PDAManage/PDAManagerChange/ChangeUserAction.jsp?ManageOrgID="+sManageOrgID+"&ManageUserID="+sManageUserID+"&SerialNo=<%=sObjectNo%>","","");
	}
	...
	{	
		...
		if (sGoBackType == "1") 
			OpenPage("/RecoveryManage/PDAManage/PDAManagerChange/PDAAssetList.jsp","right")
		else
			OpenPage("/RecoveryManage/PDAManage/PDAManagerChange/PDAManagerChangeHistory.jsp","right")
 	}
