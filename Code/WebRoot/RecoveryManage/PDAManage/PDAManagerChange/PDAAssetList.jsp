...
<%	
	...
	String sHeaders[][] = { 							
		...
		sSql = "  select SerialNo,"+
					...
					" and AssetAttribute='01' and ManageUserID='"+CurUser.UserID+"' order by AssetName desc";
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function Change_Manager()
	{
		...
		}else
		{
			...
			OpenPage("/RecoveryManage/PDAManage/PDAManagerChange/PDAManagerChangeInfo.jsp?"+
	...
	function Change_History()
	{
		...
		{ 
			OpenComp("PDAManagerChangeHistory",
					"/RecoveryManage/PDAManage/PDAManagerChange/PDAManagerChangeHistory.jsp",
