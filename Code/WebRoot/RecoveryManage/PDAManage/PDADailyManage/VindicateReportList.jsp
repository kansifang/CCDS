...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "抵债资产日常监控管理维护列表"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%
	...
	String sSql =   " select SerialNo,ObjectNo,ReportDate,"+
					...
					" from ASSET_REPORT "+
					" where ReportType='010' and ObjectNo='"+sObjectNo+"' ";
	//由SQL语句生成窗体对象。
...
//---------------------定义按钮事件------------------------------------
	...
	function newRecord()
	{
		OpenPage("/RecoveryManage/PDAManage/PDADailyManage/VindicateReportInfo.jsp?ObjectNo=<%=sObjectNo%>&DealType=<%=sDealType%>","_self","");
	}
	...
	function viewAndEdit()
	{
		...
		{
			OpenPage("/RecoveryManage/PDAManage/PDADailyManage/VindicateReportInfo.jsp?FinishDate="+sFinishDate+"&SerialNo="+sSerialNo+"&ObjectNo=<%=sObjectNo%>&DealType=<%=sDealType%>","_self","");
		}
	}
