...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	//定义自动累计字段
	doTemp.appendHTMLStyle("ReclaimSum"," onChange=\"javascript:parent.getRMBReclaimSum()\" ");
    ...
    {     		
		...
		}else
		{
			...
			{  
				...
				var sReturn = PopPage("/RecoveryManage/PDAManage/PDADailyManage/PDAGetRMBExchangeRateDialog.jsp?ReclaimCurrency="+sReclaimCurrency,"","resizable=yes;dialogWidth=0;dialogHeight=0;center:no;status:no;statusbar:no");
