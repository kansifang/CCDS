...
<%
	...
	//根据树图取不同结果集	   
	if(sDealType.equals("010010"))//抵债资产未接收
	{
		sSql+=" and BA.ManageFlag='020' and  AI.AssetFlag='010' ";
	}else if(sDealType.equals("010020"))//抵债资产已接收
	{
		sSql+=" and AI.AssetFlag in('040','020') ";//已接收
	}else if(sDealType.equals("020010010"))//台账信息未补登
	{
		sSql+=" and AI.AssetFlag in('040') ";
				//" and (VindicateDate is  null or VindicateDate ='' or "+
				//" days(replace(VindicateDate,'/','-'))<=days(current date)-30)";
	}else if(sDealType.equals("020010020"))//台账信息已补登
	{
		sSql+="  and AI.AssetFlag in('020') ";
				//" and VindicateDate is not null and VindicateDate!='' "+
				//" and days(replace(VindicateDate,'/','-'))>days(current date)-30 ";
	}else if(sDealType.equals("020020010"))//盘点未清查
	{
	...
	}else if(sDealType.equals("020020020"))//盘点已清查
	{
		sSql+="  and AI.AssetFlag in('040','020') "+
	...
	if(sDealType.equals("010020")||sDealType.substring(0,3).equals("020"))//抵债资产已接收
	{
		doTemp.setVisible("RightCardKeeper,RightCardKeepPlace,PracticeKeeper,PracticeKeepPlace,KeepTypeName",true);
	}
...
<%
	...
	String sButtons[][] = {
		...
		{	
			...
			sButtons[getBtnIdxByName(sButtons,"接收登记")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"接收完成")][0]="true";
		}else if(sDealType.equals("010020"))//抵债资产已接收
		{	
			sButtons[getBtnIdxByName(sButtons,"以资抵债申请详情")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"审查审批详情")][0]="true";
		...
		{
			sButtons[getBtnIdxByName(sButtons,"台账信息补登")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"以资抵债申请详情")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"审查审批详情")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"接收详情")][0]="true";
		...
		{
			//sButtons[getBtnIdxByName(sButtons,"新增台账维护信息")][0]="true";
			//sButtons[getBtnIdxByName(sButtons,"台账维护信息详情")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"以资抵债申请详情")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"审查审批详情")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"接收详情")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"台账信息维护")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"导出EXCEL")][0]="true";
		}else if(sDealType.equals("020020010"))//盘点未清查
		{
			sButtons[getBtnIdxByName(sButtons,"进行盘点清查")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"盘点清查信息详情")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"以资抵债申请详情")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"审查审批详情")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"接收详情")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"完成盘点清查")][0]="true";
			sButtons[getBtnIdxByName(sButtons,"导出EXCEL")][0]="true";
		}else if(sDealType.equals("020020020"))//盘点已清查
		{
			sButtons[getBtnIdxByName(sButtons,"盘点清查信息详情")][0]="true";
