...
<script language="javascript">
	...
	OpenComp("DunManageList","/RecoveryManage/DunManage/DunManageList.jsp","ComponentName="+sComponentName+"&PropertyType="+sPropertyType+"&ObjectType="+sObjectType,"rightup","");
