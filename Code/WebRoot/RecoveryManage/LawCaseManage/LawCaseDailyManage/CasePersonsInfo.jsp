...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	doTemp.appendHTMLStyle("Age"," myvalid=\"parseFloat(myobj.value,10)>=0 && parseFloat(myobj.value,10)<150 \" mymsg=\"年龄必须大于等于0,小于等于150！\" ");
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	{
		sContactTel = getItemValue(0,getRow(),"ContactTel");//联系电话	
		...
		sPostalCode = getItemValue(0,getRow(),"PostalCode");//邮政编码
	...
	/*~[Describe=校验年龄;InputParam=无;OutPutParam=无;]~*/
	function checkAge()
	{
	...
	/*~[Describe=校验邮政编码;InputParam=无;OutPutParam=无;]~*/
