...
<%
	...
	sSql = 	" select AmbientName,PropertyOrg "+
			...
			" and Serialno = (select  max(Serialno) from ASSET_INFO where ObjectNo = '"+sObjectNo+"' and  ObjectType='"+sObjectType+"')";
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	//选择现机构及人员
	doTemp.setUnit("OperateUserName"," <input class=\"inputdate\" value=\"...\" type=button onClick=parent.selectUser(\""+CurOrg.OrgID+"\",\"OperateUserID\",\"OperateUserName\",\"AssetOrgID\",\"AssetOrgName\")>");
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	/*~[Describe=判断日期;InputParam=无;OutPutParam=无;]~*/
	function checkDate()
	{		
