...
<%	
	...
	//从案件相关人员信息表LAWCASE_PERSONS中案件编号对应的法院方人员信息
	sSql = 	" select ObjectType,ObjectNo,SerialNo,PersonName,OrgName,"+
			" DepartType,getItemName('DepartType',DepartType) as DepartTypeName,"+
			" TakePartPhase,getItemName('TakePartPhase',TakePartPhase) as TakePartPhaseName, "+	
			" TakePartRole,getItemName('TakePartRole',TakePartRole) as TakePartRoleName,ContactTel, "+		  
			...
			" where PersonType = '02' " +	//人员类别：01-案件当事人、02-法院方人员、03-代理人
	...
	//设置共用格式
	doTemp.setVisible("ObjectType,ObjectNo,SerialNo,DepartType,TakePartPhase,TakePartRole,InputUserID,InputOrgID",false);	
