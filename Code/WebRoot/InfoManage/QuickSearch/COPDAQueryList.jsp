...
<%
	String sHeaders[][] = {
 	...
 	String sSql = " select SerialNo," + 	
		   ...
		   " and substr(ClassifyResult,1,2)>'02' and (FinishDate is  null or FinishDate ='') and BadBizFinishType='010' " ;
	//利用Sql生成窗体对象
...
<%
	...
	String sButtons[][] = {
		...
		{"true","","Button","核销后回收信息登记","核销后回收信息登记","receive_Record()",sResourcesPath},
...
<script language=javascript>
	...
	/*~[Describe=核销后回收信息登记;InputParam=无;OutPutParam=SerialNo;]~*/ 
	function receive_Record()
	{
		//获得合同编号
		var sSerialNo = getItemValue(0,getRow(),"SerialNo");
		var sDealType = "030";
		var sRetractType = "010";
