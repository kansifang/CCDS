...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "融资平台合同台账"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	String sHeaders[][] = { 
							...
							{"VouchType","主要担保方式"},
							{"PURPOSE","用途"},
							{"ClassifyResult","当前风险分类（账面）"},
							{"BaseClassifyResult","当前风险分类（实际）"},
	...
	sSql =	"select BC.SERIALNO,BC.CUSTOMERNAME, getBusinessName(BC.BusinessType) as BusinessTypeName,"
			+"getItemName('OccurType',BC.OccurType) as OccurTypeName,BC.BusinessSum as BusinessSum1,BD.BUSINESSSUM as BUSINESSSUM2,BD.BALANCE,BC.RateFloat,"
			+"BC.PutOutDate,BC.Maturity,getItemName('VouchType',BC.VouchType) as VouchType,BC.PURPOSE,getItemName('ClassifyResult',BC.ClassifyResult) as ClassifyResult,"
	...
	doTemp.setVisible("PlatformLevel,DealClassify,LegalPersonNature,PlatformType,CashCoverDegree,FinanceCreditType",false);
	//小数为2，整数为5
	doTemp.setCheckFormat("BusinessSum1,BUSINESSSUM2,BALANCE,RateFloat","2");
