...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "个人类客户表内授信台账"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	//小数为2，整数为5
	doTemp.setCheckFormat("OverDueDays,ActualBusinessRate,RateFloat,BCBusinessSum,BusinessSum,Balance,Interestbalance1,Interestbalance2","2");
