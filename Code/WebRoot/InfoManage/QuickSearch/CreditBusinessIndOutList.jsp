...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "个人类客户表外授信台账"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	sSql =	"select "+
				"BD.SerialNo,"+
				"BC.CustomerID,BC.CustomerName,"+
				"getItemName('IndRPRType',II.IndRPRType) as IndRPRTypeName,"+
				"II.NativePlace,"+
				"II.CertID,"+
				"II.CreditLevel,"+
			...
			" from IND_INFO II ,BUSINESS_DUEBILL BD,BUSINESS_CONTRACT BC"+
			" where II.CustomerID=BC.CustomerID and BC.SerialNo=BD.RelativeSerialNo2 "+
	...
	doTemp.setKeyFilter("II.CustomerID");
	//设置表头
	...
	//设置对齐方式
	doTemp.setAlign("OverDueDays,BailRatio,TermMonth,BCBusinessSum,BusinessSum,Balance,Interestbalance1,Interestbalance2","3");
	...
	//小数为2，整数为5
	doTemp.setCheckFormat("OverDueDays,BailRatio,TermMonth,BCBusinessSum,BusinessSum,Balance,Interestbalance1,Interestbalance2","2");
	doTemp.setCheckFormat("OverDueDays,TermMonth","5");
	doTemp.setType("BailRatio,BCBusinessSum,BusinessSum,Balance,Interestbalance1,Interestbalance2","Number");
	...
	doTemp.setFilter(Sqlca,"6","AgriLoanFlag","");
	doTemp.setFilter(Sqlca,"7","BusinessSum","");
	doTemp.setFilter(Sqlca,"8","Balance","");
	doTemp.setFilter(Sqlca,"9","PutOutdate","");
	doTemp.setFilter(Sqlca,"10","Maturity","");
	doTemp.setFilter(Sqlca,"11","ClassifyResult","");
	doTemp.setFilter(Sqlca,"12","BaseClassifyResult","");
	doTemp.setFilter(Sqlca,"13","VouchType","");
	doTemp.setFilter(Sqlca,"14","ManageUserName","");
	doTemp.setFilter(Sqlca,"15","ManageOrgName","");
	doTemp.setFilter(Sqlca,"16","MFOrgName","");
	doTemp.setFilter(Sqlca,"17","OperateOrgName","");
