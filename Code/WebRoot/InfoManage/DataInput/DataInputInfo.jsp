...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	if(sCurItemDescribe3.equals("8020"))	//股权投资
	{
	...
	{
		doTemp.appendHTMLStyle("BaseRate"," myvalid=\"parseFloat(myobj.value,10)>=0 && parseFloat(myobj.value,10)<=100 \" mymsg=\"约定收益率为[0,100]\" ");
	}
	doTemp.appendHTMLStyle("RiskRate"," myvalid=\"parseFloat(myobj.value,1000)>=0 && parseFloat(myobj.value,1000)<=10000 \" mymsg=\"拆借日利率(万分之一)为[0,10000]\" ");
	doTemp.appendHTMLStyle("MFeeRatio"," myvalid=\"parseFloat(myobj.value,10)>=0 && parseFloat(myobj.value,10)<=100 \" mymsg=\"股权比例为[0,100]\" ");
