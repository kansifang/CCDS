...
ASResultSet rs;
rs = Sqlca.getASResultSet("select CustomerName from CUSTOMER_INFO where CustomerID = '" + sCustomerID + "'");
if(rs.next())
{
...
String tempstr;
rs = Sqlca.getASResultSet("select FinanceItemNo,Item2Value from FINANCE_DATA where CustomerID = '" + sCustomerID + "' and AccountMonth = '" + sAccountMonth + "' and FinanceItemNo in ('910','909','901','905','517','804','501','506','516','801','502','507','503','508','101','104','110','115')");
while(rs.next())
{
