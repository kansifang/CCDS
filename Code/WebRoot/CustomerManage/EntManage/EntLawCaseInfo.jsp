...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	//设置判决执行金额（元）范围
	doTemp.appendHTMLStyle("EventSum"," myvalid=\"parseFloat(myobj.value,10)>=0 \" mymsg=\"判决执行金额（元）必须大于等于0！\" ");
