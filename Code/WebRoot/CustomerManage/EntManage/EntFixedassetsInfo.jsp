...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	//设置入帐价值(元)范围
	doTemp.appendHTMLStyle("FormerValue"," myvalid=\"parseFloat(myobj.value,10)>=0 \" mymsg=\"入帐价值(元)必须大于等于0！\" ");
	//设置资产净值(元)范围
	doTemp.appendHTMLStyle("EvalValue"," myvalid=\"parseFloat(myobj.value,10)>=0 \" mymsg=\"资产净值(元)必须大于等于0！\" ");
	//设置比例的范围
	doTemp.appendHTMLStyle("Rate"," myvalid=\"parseFloat(myobj.value,10)>=0 && parseFloat(myobj.value,10)<=100 \" mymsg=\"综合成新率（%）的范围为[0,100]\" ");
