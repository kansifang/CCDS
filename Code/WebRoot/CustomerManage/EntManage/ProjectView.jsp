...
<%/*~BEGIN~可编辑区[Editable=true;CodeAreaID=View05;]~*/%>
	...
	function TreeViewOnClick()
	{
		...
		{
		OpenComp(sCurItemDescribe2,sCurItemDescribe1,"ComponentName="+sCurItemName+"&ProjectNo=<%=sProjectNo%>&ProjectInfoTemplet=<%=sProjectInfoTemplet%>&ObjectType=<%=sObjectType%>","right");
