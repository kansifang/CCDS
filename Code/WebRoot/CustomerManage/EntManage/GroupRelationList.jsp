...
<script language=javascript>
	...
	{
		sReturnValue = PopPage("/CustomerManage/EntManage/GroupMemberSearch.jsp?CustomerID=<%=sCustomerID%>","","dialogWidth=0;dialogHeight=0;minimize:yes");
	...
	function my_RelativeAdd()
	{
		...
		{		
			...
			sReturnValue = PopPage("/CustomerManage/EntManage/AddGroupMemberAction.jsp?CustomerID=<%=sCustomerID%>&RelativeID="+sRelativeID+"&RelativeType="+sRelativeType,"","dialogWidth=0;dialogHeight=0;minimize:yes");
