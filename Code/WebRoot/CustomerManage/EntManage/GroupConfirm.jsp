...
<%
	...
	sSql = 	" select EI.EnglishName,EI.EnterpriseName,getOrgName(CB.OrgID) as ManageOrg,"+
			...
			" where EI.CustomerID = CB.CustomerID and EI.CustomerID='"+sGroupNo+"'";
	rs = Sqlca.getASResultSet(sSql);
	if(rs.next())
	{
	...
	sSql =      " select CustomerName,"+
    	        ...
    	        " where CustomerID = '"+sGroupNo+"' and Whethen1='0' and Describe='"+sAttribute2+"' order by Whethen1 DESC";
	rs = Sqlca.getASResultSet(sSql);
	while(rs.next())
	{
		sCustomerName=rs.getString("CustomerName");
