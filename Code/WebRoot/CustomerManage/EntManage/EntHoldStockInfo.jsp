...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	//设置股票数量范围
	doTemp.appendHTMLStyle("StockAmount"," myvalid=\"parseFloat(myobj.value,10)>=0 \" mymsg=\"股票数量必须大于等于0！\" ");
	//设置股票市值(元)范围
	doTemp.appendHTMLStyle("MarketValue"," myvalid=\"parseFloat(myobj.value,10)>=0 \" mymsg=\"股票市值(元)必须大于等于0！\" ");
...
<script language=javascript>
	...
	{				
		...
		sCertificateNo = getItemValue(0,getRow(),"CertificateNo");//股票代码
