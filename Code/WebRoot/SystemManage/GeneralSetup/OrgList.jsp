...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	//依次为：
		...
		//6.资源图片路径
	String sButtons[][] = {
		{(CurUser.hasRole("098")?"true":"false"),"","Button","新增","新增一条记录","newRecord()",sResourcesPath},
		{((CurUser.hasRole("098")||CurUser.hasRole("097"))?"true":"false"),"","Button","详情","查看/修改详情","viewAndEdit()",sResourcesPath},
