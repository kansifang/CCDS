...
<%
	...
	doTemp.setUpdateable("NewCustomerName,NewCertType,NewCertID,NewLoanCardNo",false);
	//设置必输项和可见性
	if(sCustomerType.equals("03")) //个人
	{
		...
		doTemp.setRequired("NewCustomerName,NewCertType,NewCertID,NewLoanCardNo",true);
		
	//产生datawindows
	ASDataWindow dwTemp = new ASDataWindow(CurPage,doTemp,Sqlca);
	dwTemp.Style="2";      //设置为Grid风格
	dwTemp.ReadOnly = "0"; //设置是否只读 1:只读 0:可写
	dwTemp.setEvent("BeforeUpdate","!CustomerManage.InsertHistoryInfoLog(#CustomerID,"+CurUser.UserID+",ChangeCustomer)");	
