...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "股东管理信息列表"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	//sSql = " select CustomerName,Attribute3,Sum2,Sum1,getOrgName(UpdateOrg) as UpdateOrgName,getUserName(UpdateUser) as UpdateUser,UpdateDate "+
	//	   " from CUSTOMER_SPECIALLOG  where SerialNo ='"+sSerialNo+"' order by UpdateDate ";
	if(sSerialNo=="" )
	{
		sSql = " select CustomerName,Attribute3,Sum2,Sum1,getOrgName(UpdateOrg) as UpdateOrgName,getUserName(UpdateUser) as UpdateUser,UpdateDate "+
		   	   " from CUSTOMER_SPECIALLOG where InstertType = 'ChangeStockholderList' order by UpdateDate ";
