...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "融资平台信息"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%
	...
	//定义变量
    String sTempletNo = "FinancePlatformInfo";//模板号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info04;Describe=定义按钮;]~*/%>
	...
	//依次为:
		...
		//6.资源图片路径
	String sButtons[][] = {
		{"true","","Button","新增","新增融资平台信息","newRecord()",sResourcesPath},
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=定义按钮事件;]~*/%>
	...
	function newRecord()
	{
		OpenPage("/SystemManage/SynthesisManage/FinancePlatformInfo.jsp?EditRight=02","_self","");
	}	
	...
	function goBack()
	{
		OpenPage("/SystemManage/SynthesisManage/FinancePlatformList.jsp?","_self","");
	}
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	function pageReload()
	{
		//OpenPage("/SystemManage/SynthesisManage/FinancePlatformInfo.jsp?EditRight=<%=sEditRight%>", "_self","");
	...
	{	
	   ...
	   if(bIsInsert == true)
	   {
		   var isPlatformed=RunMethod("CustomerManage","GetIsPlatformed",sCertType+","+sCertID);
