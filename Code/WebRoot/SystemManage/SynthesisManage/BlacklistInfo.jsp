...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	String sHeaders[][] = {               
	 ...
	 sSql = " select SerialNo,SectionType,CertType,CertID,CustomerID,CustomerName,InListReason,BeginDate,EndDate,InListStatus,Attribute1, "+
	...
	//设置必输项
	doTemp.setRequired("InListStatus,Attribute1,InListReason,BeginDate,CustomerName",true);
	//设置只读列
    ...
    //黑名单类型
    doTemp.setDDDWCode("InListReason","BlacklistClass");
    //来源
    doTemp.setDDDWCode("Attribute1","Resouce");
    //证件类型
	...
	dwTemp.setEvent("BeforeUpdate","!CustomerManage.InsertHistoryInfoLog(#SerialNo,"+CurUser.UserID+",ChangeBlackList)");	
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=定义按钮事件;]~*/%>
	...
	function saveRecord(sPostEvents)
	{
		...
		beforeUpdate();
		//sReturnValue = RunMethod("CustomerManage","InsertHistoryInfoLog",sSerialNo+","+CurUser.UserID+","+ChangeBlackList);
