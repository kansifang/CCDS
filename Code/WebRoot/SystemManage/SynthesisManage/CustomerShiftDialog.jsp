	    	...
	    	<td>
				<form name="Condition">
					<table align="center">
						...
						<tr align="center">
							<td align="center"><input type=checkbox name ="chkbox7"  checked value="true" class=changeColor onClick="javascript:setChecked7(this.checked)"></td>
							<td align="left" id="TDName6" class=changeColor onClick="javascript:setColor(1)"> 预警信息 </td>	
						</tr>
						<tr align="center">      		
...
<script language=javascript>
	...
	//设置预警信息选择框的属性
	function setChecked7(check)
	{
		if(check)
			Condition.chkbox7.value = "true";
		else
			Condition.chkbox7.value = "false";
	}
	...
	function my_Confirm()
	{
       ...
       //else
       	...
       	//如果预警选中，则返回RiskSignal，否则返回None
       	if(Condition.chkbox7.value == "true")
       		sReturnValue = sReturnValue + "RiskSignal|";
       	else
       		sReturnValue = sReturnValue + "None|";
