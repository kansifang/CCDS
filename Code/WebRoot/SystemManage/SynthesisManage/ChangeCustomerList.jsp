...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		   ...
		   {"true","","Button","历史工作记录查询","历史工作变更信息","viewHistory()",sResourcesPath}
		};
	%> 
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	/*OpenPage("/SystemManage/SynthesisManage/ChangeCustomerHistoryList.jsp?CustomerID="+sCustomerID+"&CustomerType="+sCustomerType, "_self" ,""); */
	function viewHistory()
	{
		sCustomerID   = getItemValue(0,getRow(),"CustomerID");//--流水号
		...
		}else
		{
			...
			popComp("ChangeCustomerHistoryList","/SystemManage/SynthesisManage/ChangeCustomerHistoryList.jsp","CustomerID="+sCustomerID+"&CustomerType="+sCustomerType,"dialogWidth=50;dialogHeight=25;resizable=no;scrollbars=no;status:yes;maximize:no;help:no;");
		}
	}	
