...
<%	
	...
	sSql = " select SerialNo,ArgumentType,getItemName('IndustryType',ArgumentModel) as ArgumentModelDes, "+
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	{ 	
	    ...
	    OpenPage("/SystemManage/ParameterManage/IndustryInfo.jsp?ArgumentType="+sArgumentType,"_self","");
	}	                                                                                                                                                                                                                                                                                                                                                 
	...
	function viewAndEdit()
	{
		...
		{
			OpenPage("/SystemManage/ParameterManage/IndustryInfo.jsp?SerialNo="+sSerialNo+"&Flag="+sFlag+"&ArgumentModel="+sArgumentModel, "_self","");
		}
	}	
