...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "公职人员担保准入行业控制"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	sSql = " select SerialNo,ArgumentType,ArgumentModel,getItemName('IndustryType',ArgumentModel) as ArgumentModelDes,"+
	...
	//设置字段的不可见
	doTemp.setVisible("SerialNo,ArgumentType,InputUser,InputOrg,UpdateUser,UpdateOrg,ArgumentModel",false);
	//设置number列
	...
	//设置必输项
	doTemp.setRequired("ArgumentModelDes",true);
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=定义按钮事件;]~*/%>
	...
	function goBack()
	{
		OpenPage("/SystemManage/ParameterManage/IndustryList.jsp","_self","");
	}	
	</script>
<%/*~END~*/%>
