...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "预警信号授权配置"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	sSql = " select SerialNo,OrgFlag,getItemName('OrgFlag1',OrgFlag) as OrgFlagName,"+
			" RiskLevel,getItemName('SignalLevel',RiskLevel) as RiskLevelName,"+
	...
	//设置字段的不可见
	doTemp.setVisible("SerialNo,OrgFlag,RiskLevel,RoleID,InputOrgID,InputUserID",false);
	//设置number列
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function my_add()
	{ 	
	    OpenPage("/SystemManage/ParameterManage/RSAuthManageInfo.jsp","_self","");
	}	                                                                                                                                                                                                                                                                                                                                                 
	...
	function viewAndEdit()
	{
		...
		{
			OpenPage("/SystemManage/ParameterManage/RSAuthManageInfo.jsp?SerialNo="+sSerialNo, "_self","");
		}
	}	
